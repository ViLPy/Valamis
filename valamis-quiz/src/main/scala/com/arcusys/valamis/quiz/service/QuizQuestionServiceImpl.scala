...
import com.arcusys.valamis.quiz.model.{ QuizQuestion, QuizTreeElement }
import com.arcusys.valamis.quiz.storage.{ QuizQuestionStorage, QuizTreeStorage }

trait QuizQuestionServiceImpl extends QuizService {
