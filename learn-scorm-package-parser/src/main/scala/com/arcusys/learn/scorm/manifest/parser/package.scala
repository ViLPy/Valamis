...
package object parser {
  ...
  def parseOrganization(elem: Elem, resourceMap: Map[String, Resource], adlcpNs: String, adlseqNs: String, sharedSequencing:Seq[Sequencing]) = new OrganizationParser(elem, resourceMap, adlcpNs, adlseqNs, sharedSequencing).parse
  def parseActivity(elem: Elem, resourcesMap: Map[String, Resource], organizationId: String, parentId: Option[String], sharedSequencing:Seq[Sequencing]) = new ActivityParser(elem, resourcesMap, organizationId, parentId, sharedSequencing).parse
