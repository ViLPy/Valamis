...
package object parser {
  ...
  def parseOrganization(elem: Elem, resourceMap: Map[String, Resource], adlcpNs: String, adlseqNs: String, scormVersion:String, sharedSequencing:Seq[Sequencing])
    = new OrganizationParser(elem, resourceMap, adlcpNs, adlseqNs, scormVersion, sharedSequencing).parse
