...
public class LFPlayerScopeRuleModelImpl extends BaseModelImpl<LFPlayerScopeRule>
    ...
    public static final Object[][] TABLE_COLUMNS = {
            { "id_", Types.BIGINT },
            { "playerID", Types.VARCHAR },
            { "scope", Types.CLOB }
        };
    public static final String TABLE_SQL_CREATE = "create table Learn_LFPlayerScopeRule (id_ LONG not null primary key,playerID VARCHAR(3000) null,scope TEXT null)";
