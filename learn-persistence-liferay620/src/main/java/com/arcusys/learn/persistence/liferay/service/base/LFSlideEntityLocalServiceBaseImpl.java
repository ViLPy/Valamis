...
import com.arcusys.learn.persistence.liferay.service.LFSlideEntityLocalService;
...
/**
 * Provides the base implementation for the l f slide entity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFSlideEntityLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.arcusys.learn.persistence.liferay.service.impl.LFSlideEntityLocalServiceImpl
 * @see com.arcusys.learn.persistence.liferay.service.LFSlideEntityLocalServiceUtil
 * @generated
 */
public abstract class LFSlideEntityLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFSlideEntityLocalService,
        IdentifiableBean {
    ...
    private LFSlideEntityLocalServiceClpInvoker _clpInvoker = new LFSlideEntityLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFSlideEntityLocalServiceUtil} to access the l f slide entity local service.
     */
    ...
    @Override
    public LFSlideEntity addLFSlideEntity(LFSlideEntity lfSlideEntity)
        throws SystemException {
        lfSlideEntity.setNew(true);

        return lfSlideEntityPersistence.update(lfSlideEntity);
    }
     ...
     */
    @Override
    public LFSlideEntity createLFSlideEntity(long id) {
        return lfSlideEntityPersistence.create(id);
    }
    ...
    @Override
    public LFSlideEntity deleteLFSlideEntity(long id)
        throws PortalException, SystemException {
        return lfSlideEntityPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFSlideEntity deleteLFSlideEntity(LFSlideEntity lfSlideEntity)
        throws SystemException {
        return lfSlideEntityPersistence.remove(lfSlideEntity);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFSlideEntity.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSlideEntityPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSlideEntityPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFSlideEntity fetchLFSlideEntity(long id) throws SystemException {
        return lfSlideEntityPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFSlideEntity getLFSlideEntity(long id)
        throws PortalException, SystemException {
        return lfSlideEntityPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfSlideEntityPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFSlideEntity> getLFSlideEntities(int start, int end)
        throws SystemException {
        return lfSlideEntityPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFSlideEntitiesCount() throws SystemException {
        return lfSlideEntityPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFSlideEntity updateLFSlideEntity(LFSlideEntity lfSlideEntity)
        throws SystemException {
        return lfSlideEntityPersistence.update(lfSlideEntity);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFSlideEntity",
            lfSlideEntityLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.arcusys.learn.persistence.liferay.model.LFSlideEntity");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfSlideEntityPersistence.getDataSource();
