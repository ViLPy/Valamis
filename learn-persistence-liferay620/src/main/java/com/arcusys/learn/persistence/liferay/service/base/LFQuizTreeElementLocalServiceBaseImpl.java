 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFQuizTreeElementLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFQuizTreeElementLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFQuizTreeElementLocalService,
        IdentifiableBean {
    ...
    private LFQuizTreeElementLocalServiceClpInvoker _clpInvoker = new LFQuizTreeElementLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFQuizTreeElementLocalServiceUtil} to access the l f quiz tree element local service.
     */
    ...
    @Override
    public LFQuizTreeElement addLFQuizTreeElement(
        LFQuizTreeElement lfQuizTreeElement) throws SystemException {
        lfQuizTreeElement.setNew(true);

        return lfQuizTreeElementPersistence.update(lfQuizTreeElement);
    }
     ...
     */
    @Override
    public LFQuizTreeElement createLFQuizTreeElement(long id) {
        return lfQuizTreeElementPersistence.create(id);
    }
    ...
    @Override
    public LFQuizTreeElement deleteLFQuizTreeElement(long id)
        throws PortalException, SystemException {
        return lfQuizTreeElementPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFQuizTreeElement deleteLFQuizTreeElement(
        LFQuizTreeElement lfQuizTreeElement) throws SystemException {
        return lfQuizTreeElementPersistence.remove(lfQuizTreeElement);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFQuizTreeElement.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfQuizTreeElementPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfQuizTreeElementPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFQuizTreeElement fetchLFQuizTreeElement(long id)
        throws SystemException {
        return lfQuizTreeElementPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFQuizTreeElement getLFQuizTreeElement(long id)
        throws PortalException, SystemException {
        return lfQuizTreeElementPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfQuizTreeElementPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFQuizTreeElement> getLFQuizTreeElements(int start, int end)
        throws SystemException {
        return lfQuizTreeElementPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFQuizTreeElementsCount() throws SystemException {
        return lfQuizTreeElementPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFQuizTreeElement updateLFQuizTreeElement(
        LFQuizTreeElement lfQuizTreeElement) throws SystemException {
        return lfQuizTreeElementPersistence.update(lfQuizTreeElement);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFQuizTreeElement",
            lfQuizTreeElementLocalService);
    }
