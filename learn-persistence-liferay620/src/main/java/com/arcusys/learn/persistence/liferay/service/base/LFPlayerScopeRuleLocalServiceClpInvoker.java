...
public class LFPlayerScopeRuleLocalServiceClpInvoker {
    ...
    public LFPlayerScopeRuleLocalServiceClpInvoker() {
        ...
        _methodName222 = "createLFPlayerScopeRule";

        _methodParameterTypes222 = new String[] {  };

        _methodName223 = "findByPlayerID";

        _methodParameterTypes223 = new String[] { "java.lang.String" };

        _methodName224 = "findByPlayerID";

        _methodParameterTypes224 = new String[] { "java.lang.String", "int", "int" };

        _methodName225 = "removeByPlayerID";
        ...
        _methodName227 = "getLFPlayerScopeRule";
