...
import com.arcusys.learn.persistence.liferay.service.LFAchievementActivityLocalService;
...
/**
 * Provides the base implementation for the l f achievement activity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFAchievementActivityLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFAchievementActivityLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFAchievementActivityLocalService,
        IdentifiableBean {
    ...
    private LFAchievementActivityLocalServiceClpInvoker _clpInvoker = new LFAchievementActivityLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFAchievementActivityLocalServiceUtil} to access the l f achievement activity local service.
     */
    ...
    @Override
    public LFAchievementActivity addLFAchievementActivity(
        LFAchievementActivity lfAchievementActivity) throws SystemException {
        lfAchievementActivity.setNew(true);

        return lfAchievementActivityPersistence.update(lfAchievementActivity);
    }
     ...
     */
    @Override
    public LFAchievementActivity createLFAchievementActivity(long id) {
        return lfAchievementActivityPersistence.create(id);
    }
    ...
    @Override
    public LFAchievementActivity deleteLFAchievementActivity(long id)
        throws PortalException, SystemException {
        return lfAchievementActivityPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFAchievementActivity deleteLFAchievementActivity(
        LFAchievementActivity lfAchievementActivity) throws SystemException {
        return lfAchievementActivityPersistence.remove(lfAchievementActivity);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFAchievementActivity.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfAchievementActivityPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfAchievementActivityPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFAchievementActivity fetchLFAchievementActivity(long id)
        throws SystemException {
        return lfAchievementActivityPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFAchievementActivity getLFAchievementActivity(long id)
        throws PortalException, SystemException {
        return lfAchievementActivityPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfAchievementActivityPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFAchievementActivity> getLFAchievementActivities(int start,
        int end) throws SystemException {
        return lfAchievementActivityPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFAchievementActivitiesCount() throws SystemException {
        return lfAchievementActivityPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFAchievementActivity updateLFAchievementActivity(
        LFAchievementActivity lfAchievementActivity) throws SystemException {
        return lfAchievementActivityPersistence.update(lfAchievementActivity);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFAchievementActivity",
            lfAchievementActivityLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfAchievementActivityPersistence.getDataSource();
