...
public class LFRoleModelImpl extends BaseModelImpl<LFRole>
    ...
    public static final String ORDER_BY_JPQL = " ORDER BY lfRole.id ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Learn_LFRole.id_ ASC";
    ...
    private static Class<?>[] _escapedModelInterfaces = new Class[] { LFRole.class };
    private long _id;
    ...
    public LFRole toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (LFRole) ProxyUtil.newProxyInstance(_classLoader,
