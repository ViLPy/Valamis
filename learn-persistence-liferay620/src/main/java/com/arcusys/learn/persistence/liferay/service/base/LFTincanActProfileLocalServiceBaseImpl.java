...
import com.arcusys.learn.persistence.liferay.service.LFTincanActProfileLocalService;
...
/**
 * Provides the base implementation for the l f tincan act profile local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFTincanActProfileLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFTincanActProfileLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFTincanActProfileLocalService,
        IdentifiableBean {
    ...
    private LFTincanActProfileLocalServiceClpInvoker _clpInvoker = new LFTincanActProfileLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFTincanActProfileLocalServiceUtil} to access the l f tincan act profile local service.
     */
    ...
    @Override
    public LFTincanActProfile addLFTincanActProfile(
        LFTincanActProfile lfTincanActProfile) throws SystemException {
        lfTincanActProfile.setNew(true);

        return lfTincanActProfilePersistence.update(lfTincanActProfile);
    }
     ...
     */
    @Override
    public LFTincanActProfile createLFTincanActProfile(long id) {
        return lfTincanActProfilePersistence.create(id);
    }
    ...
    @Override
    public LFTincanActProfile deleteLFTincanActProfile(long id)
        throws PortalException, SystemException {
        return lfTincanActProfilePersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFTincanActProfile deleteLFTincanActProfile(
        LFTincanActProfile lfTincanActProfile) throws SystemException {
        return lfTincanActProfilePersistence.remove(lfTincanActProfile);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFTincanActProfile.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfTincanActProfilePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfTincanActProfilePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFTincanActProfile fetchLFTincanActProfile(long id)
        throws SystemException {
        return lfTincanActProfilePersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFTincanActProfile getLFTincanActProfile(long id)
        throws PortalException, SystemException {
        return lfTincanActProfilePersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfTincanActProfilePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFTincanActProfile> getLFTincanActProfiles(int start, int end)
        throws SystemException {
        return lfTincanActProfilePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFTincanActProfilesCount() throws SystemException {
        return lfTincanActProfilePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFTincanActProfile updateLFTincanActProfile(
        LFTincanActProfile lfTincanActProfile) throws SystemException {
        return lfTincanActProfilePersistence.update(lfTincanActProfile);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFTincanActProfile",
            lfTincanActProfileLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfTincanActProfilePersistence.getDataSource();
