...
public class LFFileStorageLocalServiceClpInvoker {
    ...
    public LFFileStorageLocalServiceClpInvoker() {
        ...
        _methodName322 = "createLFFileStorage";

        _methodParameterTypes322 = new String[] {  };

        _methodName323 = "findByFilename";

        _methodParameterTypes323 = new String[] { "java.lang.String" };

        _methodName324 = "findByFilename";

        _methodParameterTypes324 = new String[] { "java.lang.String", "int", "int" };

        _methodName325 = "removeByFilename";

        _methodParameterTypes325 = new String[] { "java.lang.String" };

        _methodName326 = "findByDirectory";

        _methodParameterTypes326 = new String[] { "java.lang.String" };

        _methodName327 = "removeByDirectory";
        ...
        _methodName329 = "getLFFileStorage";
