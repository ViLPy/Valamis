...
import com.arcusys.learn.persistence.liferay.service.LFRequiredActivityLocalService;
...
/**
 * Provides the base implementation for the l f required activity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFRequiredActivityLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.arcusys.learn.persistence.liferay.service.impl.LFRequiredActivityLocalServiceImpl
 * @see com.arcusys.learn.persistence.liferay.service.LFRequiredActivityLocalServiceUtil
 * @generated
 */
public abstract class LFRequiredActivityLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFRequiredActivityLocalService,
        IdentifiableBean {
    ...
    private LFRequiredActivityLocalServiceClpInvoker _clpInvoker = new LFRequiredActivityLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFRequiredActivityLocalServiceUtil} to access the l f required activity local service.
     */
    ...
    @Override
    public LFRequiredActivity addLFRequiredActivity(
        LFRequiredActivity lfRequiredActivity) throws SystemException {
        lfRequiredActivity.setNew(true);

        return lfRequiredActivityPersistence.update(lfRequiredActivity);
    }
     ...
     */
    @Override
    public LFRequiredActivity createLFRequiredActivity(long id) {
        return lfRequiredActivityPersistence.create(id);
    }
    ...
    @Override
    public LFRequiredActivity deleteLFRequiredActivity(long id)
        throws PortalException, SystemException {
        return lfRequiredActivityPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFRequiredActivity deleteLFRequiredActivity(
        LFRequiredActivity lfRequiredActivity) throws SystemException {
        return lfRequiredActivityPersistence.remove(lfRequiredActivity);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFRequiredActivity.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfRequiredActivityPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfRequiredActivityPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFRequiredActivity fetchLFRequiredActivity(long id)
        throws SystemException {
        return lfRequiredActivityPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFRequiredActivity getLFRequiredActivity(long id)
        throws PortalException, SystemException {
        return lfRequiredActivityPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfRequiredActivityPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFRequiredActivity> getLFRequiredActivities(int start, int end)
        throws SystemException {
        return lfRequiredActivityPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFRequiredActivitiesCount() throws SystemException {
        return lfRequiredActivityPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFRequiredActivity updateLFRequiredActivity(
        LFRequiredActivity lfRequiredActivity) throws SystemException {
        return lfRequiredActivityPersistence.update(lfRequiredActivity);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFRequiredActivity",
            lfRequiredActivityLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfRequiredActivityPersistence.getDataSource();
