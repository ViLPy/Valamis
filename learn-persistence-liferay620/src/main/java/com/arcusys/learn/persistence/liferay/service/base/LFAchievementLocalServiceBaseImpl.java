...
import com.arcusys.learn.persistence.liferay.service.LFAchievementLocalService;
...
/**
 * Provides the base implementation for the l f achievement local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFAchievementLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFAchievementLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFAchievementLocalService,
        IdentifiableBean {
    ...
    private LFAchievementLocalServiceClpInvoker _clpInvoker = new LFAchievementLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFAchievementLocalServiceUtil} to access the l f achievement local service.
     */
    ...
    @Override
    public LFAchievement addLFAchievement(LFAchievement lfAchievement)
        throws SystemException {
        lfAchievement.setNew(true);

        return lfAchievementPersistence.update(lfAchievement);
    }
     ...
     */
    @Override
    public LFAchievement createLFAchievement(long id) {
        return lfAchievementPersistence.create(id);
    }
    ...
    @Override
    public LFAchievement deleteLFAchievement(long id)
        throws PortalException, SystemException {
        return lfAchievementPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFAchievement deleteLFAchievement(LFAchievement lfAchievement)
        throws SystemException {
        return lfAchievementPersistence.remove(lfAchievement);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFAchievement.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfAchievementPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfAchievementPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFAchievement fetchLFAchievement(long id) throws SystemException {
        return lfAchievementPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFAchievement getLFAchievement(long id)
        throws PortalException, SystemException {
        return lfAchievementPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfAchievementPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFAchievement> getLFAchievements(int start, int end)
        throws SystemException {
        return lfAchievementPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFAchievementsCount() throws SystemException {
        return lfAchievementPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFAchievement updateLFAchievement(LFAchievement lfAchievement)
        throws SystemException {
        return lfAchievementPersistence.update(lfAchievement);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFAchievement",
            lfAchievementLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfAchievementPersistence.getDataSource();
