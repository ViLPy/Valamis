...
public class LFSocialPackageModelImpl extends BaseModelImpl<LFSocialPackage>
    ...
    public static final String ORDER_BY_JPQL = " ORDER BY lfSocialPackage.id ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Learn_LFSocialPackage.id_ ASC";
    ...
    private LFSocialPackage _escapedModel;
    ...
    public LFSocialPackage toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (LFSocialPackage) ProxyUtil.newProxyInstance(_classLoader,
