...
import com.arcusys.learn.persistence.liferay.service.LFCertificateCourseLocalService;
...
/**
 * Provides the base implementation for the l f certificate course local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFCertificateCourseLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFCertificateCourseLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFCertificateCourseLocalService,
        IdentifiableBean {
    ...
    private LFCertificateCourseLocalServiceClpInvoker _clpInvoker = new LFCertificateCourseLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFCertificateCourseLocalServiceUtil} to access the l f certificate course local service.
     */
    ...
    @Override
    public LFCertificateCourse addLFCertificateCourse(
        LFCertificateCourse lfCertificateCourse) throws SystemException {
        lfCertificateCourse.setNew(true);

        return lfCertificateCoursePersistence.update(lfCertificateCourse);
    }
     ...
     */
    @Override
    public LFCertificateCourse createLFCertificateCourse(
        LFCertificateCoursePK lfCertificateCoursePK) {
        return lfCertificateCoursePersistence.create(lfCertificateCoursePK);
    }
    ...
    @Override
    public LFCertificateCourse deleteLFCertificateCourse(
        LFCertificateCoursePK lfCertificateCoursePK)
        throws PortalException, SystemException {
        return lfCertificateCoursePersistence.remove(lfCertificateCoursePK);
    }
    ...
    public LFCertificateCourse deleteLFCertificateCourse(
        LFCertificateCourse lfCertificateCourse) throws SystemException {
        return lfCertificateCoursePersistence.remove(lfCertificateCourse);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFCertificateCourse.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfCertificateCoursePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfCertificateCoursePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFCertificateCourse fetchLFCertificateCourse(
        LFCertificateCoursePK lfCertificateCoursePK) throws SystemException {
        return lfCertificateCoursePersistence.fetchByPrimaryKey(lfCertificateCoursePK);
    }
     ...
     */
    @Override
    public LFCertificateCourse getLFCertificateCourse(
        LFCertificateCoursePK lfCertificateCoursePK)
        throws PortalException, SystemException {
        return lfCertificateCoursePersistence.findByPrimaryKey(lfCertificateCoursePK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfCertificateCoursePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFCertificateCourse> getLFCertificateCourses(int start, int end)
        throws SystemException {
        return lfCertificateCoursePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFCertificateCoursesCount() throws SystemException {
        return lfCertificateCoursePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFCertificateCourse updateLFCertificateCourse(
        LFCertificateCourse lfCertificateCourse) throws SystemException {
        return lfCertificateCoursePersistence.update(lfCertificateCourse);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFCertificateCourse",
            lfCertificateCourseLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfCertificateCoursePersistence.getDataSource();
