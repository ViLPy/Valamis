...
import com.arcusys.learn.persistence.liferay.service.LFTCClntApiStorageLocalService;
...
/**
 * Provides the base implementation for the l f t c clnt api storage local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFTCClntApiStorageLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFTCClntApiStorageLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFTCClntApiStorageLocalService,
        IdentifiableBean {
    ...
    private LFTCClntApiStorageLocalServiceClpInvoker _clpInvoker = new LFTCClntApiStorageLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFTCClntApiStorageLocalServiceUtil} to access the l f t c clnt api storage local service.
     */
    ...
    @Override
    public LFTCClntApiStorage addLFTCClntApiStorage(
        LFTCClntApiStorage lftcClntApiStorage) throws SystemException {
        lftcClntApiStorage.setNew(true);

        return lftcClntApiStoragePersistence.update(lftcClntApiStorage);
    }
     ...
     */
    @Override
    public LFTCClntApiStorage createLFTCClntApiStorage(long id) {
        return lftcClntApiStoragePersistence.create(id);
    }
    ...
    @Override
    public LFTCClntApiStorage deleteLFTCClntApiStorage(long id)
        throws PortalException, SystemException {
        return lftcClntApiStoragePersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFTCClntApiStorage deleteLFTCClntApiStorage(
        LFTCClntApiStorage lftcClntApiStorage) throws SystemException {
        return lftcClntApiStoragePersistence.remove(lftcClntApiStorage);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFTCClntApiStorage.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lftcClntApiStoragePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lftcClntApiStoragePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFTCClntApiStorage fetchLFTCClntApiStorage(long id)
        throws SystemException {
        return lftcClntApiStoragePersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFTCClntApiStorage getLFTCClntApiStorage(long id)
        throws PortalException, SystemException {
        return lftcClntApiStoragePersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lftcClntApiStoragePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFTCClntApiStorage> getLFTCClntApiStorages(int start, int end)
        throws SystemException {
        return lftcClntApiStoragePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFTCClntApiStoragesCount() throws SystemException {
        return lftcClntApiStoragePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFTCClntApiStorage updateLFTCClntApiStorage(
        LFTCClntApiStorage lftcClntApiStorage) throws SystemException {
        return lftcClntApiStoragePersistence.update(lftcClntApiStorage);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFTCClntApiStorage",
            lftcClntApiStorageLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lftcClntApiStoragePersistence.getDataSource();
