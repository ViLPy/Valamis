...
/**
 * The persistence utility for the l f tincan ctx activities service. This utility wraps {@link LFTincanCtxActivitiesPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class LFTincanCtxActivitiesUtil {
    private static LFTincanCtxActivitiesPersistence _persistence;
     ...
     */
    public static void clearCache(LFTincanCtxActivities lfTincanCtxActivities) {
        getPersistence().clearCache(lfTincanCtxActivities);
    }
     ...
     */
    public static List<LFTincanCtxActivities> findWithDynamicQuery(
     ...
     */
    public static LFTincanCtxActivities update(
        LFTincanCtxActivities lfTincanCtxActivities) throws SystemException {
        return getPersistence().update(lfTincanCtxActivities);
    }
    ...
    public static LFTincanCtxActivities update(
        ...
        return getPersistence().update(lfTincanCtxActivities, serviceContext);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(lfTincanCtxActivities);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(lfTincanCtxActivitieses);
    }
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFTincanCtxActivities create(
        long id) {
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFTincanCtxActivities remove(
        long id)
    ...
    public static com.arcusys.learn.persistence.liferay.model.LFTincanCtxActivities updateImpl(
        com.arcusys.learn.persistence.liferay.model.LFTincanCtxActivities lfTincanCtxActivities)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().updateImpl(lfTincanCtxActivities);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.arcusys.learn.persistence.liferay.model.LFTincanCtxActivities findByPrimaryKey(
        long id)
        throws com.arcusys.learn.persistence.liferay.NoSuchLFTincanCtxActivitiesException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.arcusys.learn.persistence.liferay.model.LFTincanCtxActivities fetchByPrimaryKey(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.arcusys.learn.persistence.liferay.model.LFTincanCtxActivities> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static LFTincanCtxActivitiesPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (LFTincanCtxActivitiesPersistence) PortletBeanLocatorUtil.locate(com.arcusys.learn.persistence.liferay.service.ClpSerializer.getServletContextName(),
                    LFTincanCtxActivitiesPersistence.class.getName());

            ReferenceRegistry.registerReference(LFTincanCtxActivitiesUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(LFTincanCtxActivitiesPersistence persistence) {
    }
}
