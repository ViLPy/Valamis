...
/**
 * Provides the base implementation for the l f seq permissions local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFSeqPermissionsLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFSeqPermissionsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFSeqPermissionsLocalService,
        IdentifiableBean {
    ...
    private LFSeqPermissionsLocalServiceClpInvoker _clpInvoker = new LFSeqPermissionsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFSeqPermissionsLocalServiceUtil} to access the l f seq permissions local service.
     */
    ...
    @Override
    public LFSeqPermissions addLFSeqPermissions(
        LFSeqPermissions lfSeqPermissions) throws SystemException {
        lfSeqPermissions.setNew(true);

        return lfSeqPermissionsPersistence.update(lfSeqPermissions);
    }
     ...
     */
    @Override
    public LFSeqPermissions createLFSeqPermissions(long id) {
        return lfSeqPermissionsPersistence.create(id);
    }
    ...
    @Override
    public LFSeqPermissions deleteLFSeqPermissions(long id)
        throws PortalException, SystemException {
        return lfSeqPermissionsPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFSeqPermissions deleteLFSeqPermissions(
        LFSeqPermissions lfSeqPermissions) throws SystemException {
        return lfSeqPermissionsPersistence.remove(lfSeqPermissions);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFSeqPermissions.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfSeqPermissionsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSeqPermissionsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFSeqPermissions fetchLFSeqPermissions(long id)
        throws SystemException {
        return lfSeqPermissionsPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFSeqPermissions getLFSeqPermissions(long id)
        throws PortalException, SystemException {
        return lfSeqPermissionsPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfSeqPermissionsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFSeqPermissions> getLFSeqPermissionses(int start, int end)
        throws SystemException {
        return lfSeqPermissionsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFSeqPermissionsesCount() throws SystemException {
        return lfSeqPermissionsPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFSeqPermissions updateLFSeqPermissions(
        LFSeqPermissions lfSeqPermissions) throws SystemException {
        return lfSeqPermissionsPersistence.update(lfSeqPermissions);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFSeqPermissions",
            lfSeqPermissionsLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfSeqPermissionsPersistence.getDataSource();
