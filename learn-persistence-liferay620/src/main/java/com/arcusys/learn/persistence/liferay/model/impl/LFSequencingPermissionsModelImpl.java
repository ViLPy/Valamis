...
public class LFSequencingPermissionsModelImpl extends BaseModelImpl<LFSequencingPermissions>
    ...
    public static final String ORDER_BY_JPQL = " ORDER BY lfSequencingPermissions.id ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Learn_LFSequencingPermissions.id_ ASC";
    ...
    private LFSequencingPermissions _escapedModel;
    ...
    public LFSequencingPermissions toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (LFSequencingPermissions) ProxyUtil.newProxyInstance(_classLoader,
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LFSequencingPermissions)) {
            return false;
        }

        LFSequencingPermissions lfSequencingPermissions = (LFSequencingPermissions) obj;
