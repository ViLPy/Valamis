...
public class LFObjectiveStateLocalServiceClpInvoker {
    ...
    public LFObjectiveStateLocalServiceClpInvoker() {
        ...
        _methodName322 = "createLFObjectiveState";

        _methodParameterTypes322 = new String[] {  };

        _methodName323 = "findByMapKeyAndActivityStateID";

        _methodParameterTypes323 = new String[] {
                "java.lang.String", "java.lang.Integer"
            };

        _methodName324 = "findByActivityStateID";
        ...
        _methodName326 = "getLFObjectiveState";
