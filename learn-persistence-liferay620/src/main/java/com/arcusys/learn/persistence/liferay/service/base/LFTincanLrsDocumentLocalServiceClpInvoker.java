...
public class LFTincanLrsDocumentLocalServiceClpInvoker {
    ...
    public LFTincanLrsDocumentLocalServiceClpInvoker() {
        ...
        _methodName322 = "createLFTincanLrsDocument";

        _methodParameterTypes322 = new String[] {  };

        _methodName323 = "createLFTincanLrsDocument";
        ...
        _methodName324 = "deleteLFTincanLrsDocument";

        _methodParameterTypes324 = new String[] { "java.lang.String" };

        _methodName325 = "findByDocumentId";
