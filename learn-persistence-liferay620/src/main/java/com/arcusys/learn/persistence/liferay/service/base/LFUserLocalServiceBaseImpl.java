...
/**
 * Provides the base implementation for the l f user local service.
 *
 * <p>
...
public abstract class LFUserLocalServiceBaseImpl extends BaseLocalServiceImpl
    ...
    public LFUser addLFUser(LFUser lfUser) throws SystemException {
        ...
        return lfUserPersistence.update(lfUser);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return lfUserPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }
