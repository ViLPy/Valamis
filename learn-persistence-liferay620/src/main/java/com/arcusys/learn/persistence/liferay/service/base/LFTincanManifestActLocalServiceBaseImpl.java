...
import com.arcusys.learn.persistence.liferay.service.LFTincanManifestActLocalService;
...
/**
 * Provides the base implementation for the l f tincan manifest act local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFTincanManifestActLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.arcusys.learn.persistence.liferay.service.impl.LFTincanManifestActLocalServiceImpl
 * @see com.arcusys.learn.persistence.liferay.service.LFTincanManifestActLocalServiceUtil
 * @generated
 */
public abstract class LFTincanManifestActLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFTincanManifestActLocalService,
        IdentifiableBean {
    ...
    private LFTincanManifestActLocalServiceClpInvoker _clpInvoker = new LFTincanManifestActLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFTincanManifestActLocalServiceUtil} to access the l f tincan manifest act local service.
     */
    ...
    @Override
    public LFTincanManifestAct addLFTincanManifestAct(
        LFTincanManifestAct lfTincanManifestAct) throws SystemException {
        lfTincanManifestAct.setNew(true);

        return lfTincanManifestActPersistence.update(lfTincanManifestAct);
    }
     ...
     */
    @Override
    public LFTincanManifestAct createLFTincanManifestAct(long id) {
        return lfTincanManifestActPersistence.create(id);
    }
    ...
    @Override
    public LFTincanManifestAct deleteLFTincanManifestAct(long id)
        throws PortalException, SystemException {
        return lfTincanManifestActPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFTincanManifestAct deleteLFTincanManifestAct(
        LFTincanManifestAct lfTincanManifestAct) throws SystemException {
        return lfTincanManifestActPersistence.remove(lfTincanManifestAct);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFTincanManifestAct.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfTincanManifestActPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfTincanManifestActPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFTincanManifestAct fetchLFTincanManifestAct(long id)
        throws SystemException {
        return lfTincanManifestActPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFTincanManifestAct getLFTincanManifestAct(long id)
        throws PortalException, SystemException {
        return lfTincanManifestActPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfTincanManifestActPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFTincanManifestAct> getLFTincanManifestActs(int start, int end)
        throws SystemException {
        return lfTincanManifestActPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFTincanManifestActsCount() throws SystemException {
        return lfTincanManifestActPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFTincanManifestAct updateLFTincanManifestAct(
        LFTincanManifestAct lfTincanManifestAct) throws SystemException {
        return lfTincanManifestActPersistence.update(lfTincanManifestAct);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFTincanManifestAct",
            lfTincanManifestActLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfTincanManifestActPersistence.getDataSource();
