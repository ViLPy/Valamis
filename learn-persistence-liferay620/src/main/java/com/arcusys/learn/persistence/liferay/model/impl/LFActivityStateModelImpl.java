...
public class LFActivityStateModelImpl extends BaseModelImpl<LFActivityState>
    ...
    private LFActivityState _escapedModel;
    ...
    public LFActivityState toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (LFActivityState) ProxyUtil.newProxyInstance(_classLoader,
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LFActivityState)) {
            return false;
        }

        LFActivityState lfActivityState = (LFActivityState) obj;
