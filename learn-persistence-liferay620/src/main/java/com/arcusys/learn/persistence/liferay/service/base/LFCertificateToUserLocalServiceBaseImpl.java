...
import com.arcusys.learn.persistence.liferay.service.LFCertificateToUserLocalService;
...
/**
 * Provides the base implementation for the l f certificate to user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFCertificateToUserLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFCertificateToUserLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFCertificateToUserLocalService,
        IdentifiableBean {
    ...
    @BeanReference(type = com.arcusys.learn.persistence.liferay.service.LFCertificateToUserLocalService.class)
    protected com.arcusys.learn.persistence.liferay.service.LFCertificateToUserLocalService lfCertificateToUserLocalService;
    @BeanReference(type = LFCertificateToUserPersistence.class)
    protected LFCertificateToUserPersistence lfCertificateToUserPersistence;
    ...
    private LFCertificateToUserLocalServiceClpInvoker _clpInvoker = new LFCertificateToUserLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFCertificateToUserLocalServiceUtil} to access the l f certificate to user local service.
     */
    ...
    @Override
    public LFCertificateToUser addLFCertificateToUser(
        LFCertificateToUser lfCertificateToUser) throws SystemException {
        lfCertificateToUser.setNew(true);

        return lfCertificateToUserPersistence.update(lfCertificateToUser);
    }
     ...
     */
    @Override
    public LFCertificateToUser createLFCertificateToUser(
        LFCertificateToUserPK lfCertificateToUserPK) {
        return lfCertificateToUserPersistence.create(lfCertificateToUserPK);
    }
    ...
    @Override
    public LFCertificateToUser deleteLFCertificateToUser(
        LFCertificateToUserPK lfCertificateToUserPK)
        throws PortalException, SystemException {
        return lfCertificateToUserPersistence.remove(lfCertificateToUserPK);
    }
    ...
    public LFCertificateToUser deleteLFCertificateToUser(
        LFCertificateToUser lfCertificateToUser) throws SystemException {
        return lfCertificateToUserPersistence.remove(lfCertificateToUser);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFCertificateToUser.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfCertificateToUserPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfCertificateToUserPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFCertificateToUser fetchLFCertificateToUser(
        LFCertificateToUserPK lfCertificateToUserPK) throws SystemException {
        return lfCertificateToUserPersistence.fetchByPrimaryKey(lfCertificateToUserPK);
    }
     ...
     */
    @Override
    public LFCertificateToUser getLFCertificateToUser(
        LFCertificateToUserPK lfCertificateToUserPK)
        throws PortalException, SystemException {
        return lfCertificateToUserPersistence.findByPrimaryKey(lfCertificateToUserPK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfCertificateToUserPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFCertificateToUser> getLFCertificateToUsers(int start, int end)
        throws SystemException {
        return lfCertificateToUserPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFCertificateToUsersCount() throws SystemException {
        return lfCertificateToUserPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFCertificateToUser updateLFCertificateToUser(
        LFCertificateToUser lfCertificateToUser) throws SystemException {
        return lfCertificateToUserPersistence.update(lfCertificateToUser);
    }
    ...
    /**
     * Returns the l f certificate to user local service.
     *
     * @return the l f certificate to user local service
     */
    public com.arcusys.learn.persistence.liferay.service.LFCertificateToUserLocalService getLFCertificateToUserLocalService() {
        return lfCertificateToUserLocalService;
    }

    /**
     * Sets the l f certificate to user local service.
     *
     * @param lfCertificateToUserLocalService the l f certificate to user local service
     */
    public void setLFCertificateToUserLocalService(
        com.arcusys.learn.persistence.liferay.service.LFCertificateToUserLocalService lfCertificateToUserLocalService) {
        this.lfCertificateToUserLocalService = lfCertificateToUserLocalService;
    }

    /**
     * Returns the l f certificate to user persistence.
     *
     * @return the l f certificate to user persistence
     */
    public LFCertificateToUserPersistence getLFCertificateToUserPersistence() {
        return lfCertificateToUserPersistence;
    }

    /**
     * Sets the l f certificate to user persistence.
     *
     * @param lfCertificateToUserPersistence the l f certificate to user persistence
     */
    public void setLFCertificateToUserPersistence(
        LFCertificateToUserPersistence lfCertificateToUserPersistence) {
        this.lfCertificateToUserPersistence = lfCertificateToUserPersistence;
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFCertificateToUser",
            lfCertificateToUserLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfCertificateToUserPersistence.getDataSource();
