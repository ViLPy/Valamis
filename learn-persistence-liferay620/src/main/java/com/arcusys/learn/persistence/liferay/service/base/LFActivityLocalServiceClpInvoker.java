...
public class LFActivityLocalServiceClpInvoker {
    ...
    public LFActivityLocalServiceClpInvoker() {
        ...
        _methodName302 = "createLFActivity";

        _methodParameterTypes302 = new String[] {  };

        _methodName303 = "findByPackageAndID";
        ...
        _methodName305 = "findByPackageIDAndOrganizationID";

        _methodParameterTypes305 = new String[] {
                "java.lang.Integer", "java.lang.String"
            };

        _methodName306 = "findByPackageIDAndParentID";
