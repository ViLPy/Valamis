...
public class LFActivityLocalServiceClpInvoker {
    ...
    public LFActivityLocalServiceClpInvoker() {
        ...
        _methodName286 = "createLFActivity";

        _methodParameterTypes286 = new String[] {  };

        _methodName287 = "findByPackageAndID";
        ...
        _methodName289 = "findByPackageIDAndOrganizationID";

        _methodParameterTypes289 = new String[] {
                "java.lang.Integer", "java.lang.String"
            };

        _methodName290 = "findByPackageIDAndParentID";
