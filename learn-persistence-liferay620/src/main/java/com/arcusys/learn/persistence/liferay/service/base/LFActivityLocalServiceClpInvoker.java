...
public class LFActivityLocalServiceClpInvoker {
    ...
    public LFActivityLocalServiceClpInvoker() {
        ...
        _methodName222 = "createLFActivity";

        _methodParameterTypes222 = new String[] {  };

        _methodName223 = "findByPackageAndID";
        ...
        _methodName225 = "findByPackageIDAndOrganizationID";

        _methodParameterTypes225 = new String[] {
                "java.lang.Integer", "java.lang.String"
            };

        _methodName226 = "findByPackageIDAndParentID";
