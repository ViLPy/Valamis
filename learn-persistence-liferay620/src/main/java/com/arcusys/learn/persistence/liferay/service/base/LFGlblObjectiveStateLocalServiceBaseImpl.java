...
/**
 * Provides the base implementation for the l f glbl objective state local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFGlblObjectiveStateLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFGlblObjectiveStateLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFGlblObjectiveStateLocalService,
        IdentifiableBean {
    ...
    private LFGlblObjectiveStateLocalServiceClpInvoker _clpInvoker = new LFGlblObjectiveStateLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFGlblObjectiveStateLocalServiceUtil} to access the l f glbl objective state local service.
     */
    ...
    @Override
    public LFGlblObjectiveState addLFGlblObjectiveState(
        LFGlblObjectiveState lfGlblObjectiveState) throws SystemException {
        lfGlblObjectiveState.setNew(true);

        return lfGlblObjectiveStatePersistence.update(lfGlblObjectiveState);
    }
     ...
     */
    @Override
    public LFGlblObjectiveState createLFGlblObjectiveState(long id) {
        return lfGlblObjectiveStatePersistence.create(id);
    }
    ...
    @Override
    public LFGlblObjectiveState deleteLFGlblObjectiveState(long id)
        throws PortalException, SystemException {
        return lfGlblObjectiveStatePersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFGlblObjectiveState deleteLFGlblObjectiveState(
        LFGlblObjectiveState lfGlblObjectiveState) throws SystemException {
        return lfGlblObjectiveStatePersistence.remove(lfGlblObjectiveState);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFGlblObjectiveState.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfGlblObjectiveStatePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfGlblObjectiveStatePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFGlblObjectiveState fetchLFGlblObjectiveState(long id)
        throws SystemException {
        return lfGlblObjectiveStatePersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFGlblObjectiveState getLFGlblObjectiveState(long id)
        throws PortalException, SystemException {
        return lfGlblObjectiveStatePersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfGlblObjectiveStatePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFGlblObjectiveState> getLFGlblObjectiveStates(int start,
        int end) throws SystemException {
        return lfGlblObjectiveStatePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFGlblObjectiveStatesCount() throws SystemException {
        return lfGlblObjectiveStatePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFGlblObjectiveState updateLFGlblObjectiveState(
        LFGlblObjectiveState lfGlblObjectiveState) throws SystemException {
        return lfGlblObjectiveStatePersistence.update(lfGlblObjectiveState);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFGlblObjectiveState",
            lfGlblObjectiveStateLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfGlblObjectiveStatePersistence.getDataSource();
