...
public class LFActivityStateTreeLocalServiceClpInvoker {
    ...
    public LFActivityStateTreeLocalServiceClpInvoker() {
        ...
        _methodName1 = "createLFActivityStateTree";

        _methodParameterTypes1 = new String[] { "long" };

        _methodName2 = "deleteLFActivityStateTree";

        _methodParameterTypes2 = new String[] { "long" };

        _methodName3 = "deleteLFActivityStateTree";
        ...
        _methodName302 = "createLFActivityStateTree";

        _methodParameterTypes302 = new String[] {  };

        _methodName303 = "findByAttemptID";
        ...
        _methodName305 = "getLFActivityStateTree";
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return LFActivityStateTreeLocalServiceUtil.addLFActivityStateTree((com.arcusys.learn.persistence.liferay.model.LFActivityStateTree) arguments[0]);
        }

        if (_methodName1.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes1, parameterTypes)) {
            return LFActivityStateTreeLocalServiceUtil.createLFActivityStateTree(((Long) arguments[0]).longValue());
        }

        if (_methodName2.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes2, parameterTypes)) {
            return LFActivityStateTreeLocalServiceUtil.deleteLFActivityStateTree(((Long) arguments[0]).longValue());
        }

        if (_methodName3.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes3, parameterTypes)) {
            return LFActivityStateTreeLocalServiceUtil.deleteLFActivityStateTree((com.arcusys.learn.persistence.liferay.model.LFActivityStateTree) arguments[0]);
        }

        if (_methodName4.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes4, parameterTypes)) {
            return LFActivityStateTreeLocalServiceUtil.dynamicQuery();
        }

        if (_methodName5.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes5, parameterTypes)) {
            return LFActivityStateTreeLocalServiceUtil.dynamicQuery((com.liferay.portal.kernel.dao.orm.DynamicQuery) arguments[0]);
        }
