...
import com.arcusys.learn.persistence.liferay.service.LFCertificateActivityLocalService;
...
/**
 * Provides the base implementation for the l f certificate activity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFCertificateActivityLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFCertificateActivityLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFCertificateActivityLocalService,
        IdentifiableBean {
    ...
    private LFCertificateActivityLocalServiceClpInvoker _clpInvoker = new LFCertificateActivityLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFCertificateActivityLocalServiceUtil} to access the l f certificate activity local service.
     */
    ...
    @Override
    public LFCertificateActivity addLFCertificateActivity(
        LFCertificateActivity lfCertificateActivity) throws SystemException {
        lfCertificateActivity.setNew(true);

        return lfCertificateActivityPersistence.update(lfCertificateActivity);
    }
     ...
     */
    @Override
    public LFCertificateActivity createLFCertificateActivity(
        LFCertificateActivityPK lfCertificateActivityPK) {
        return lfCertificateActivityPersistence.create(lfCertificateActivityPK);
    }
    ...
    @Override
    public LFCertificateActivity deleteLFCertificateActivity(
        LFCertificateActivityPK lfCertificateActivityPK)
        throws PortalException, SystemException {
        return lfCertificateActivityPersistence.remove(lfCertificateActivityPK);
    }
    ...
    public LFCertificateActivity deleteLFCertificateActivity(
        LFCertificateActivity lfCertificateActivity) throws SystemException {
        return lfCertificateActivityPersistence.remove(lfCertificateActivity);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFCertificateActivity.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfCertificateActivityPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfCertificateActivityPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFCertificateActivity fetchLFCertificateActivity(
        LFCertificateActivityPK lfCertificateActivityPK)
        throws SystemException {
        return lfCertificateActivityPersistence.fetchByPrimaryKey(lfCertificateActivityPK);
    }
     ...
     */
    @Override
    public LFCertificateActivity getLFCertificateActivity(
        LFCertificateActivityPK lfCertificateActivityPK)
        throws PortalException, SystemException {
        return lfCertificateActivityPersistence.findByPrimaryKey(lfCertificateActivityPK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfCertificateActivityPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFCertificateActivity> getLFCertificateActivities(int start,
        int end) throws SystemException {
        return lfCertificateActivityPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFCertificateActivitiesCount() throws SystemException {
        return lfCertificateActivityPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFCertificateActivity updateLFCertificateActivity(
        LFCertificateActivity lfCertificateActivity) throws SystemException {
        return lfCertificateActivityPersistence.update(lfCertificateActivity);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFCertificateActivity",
            lfCertificateActivityLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfCertificateActivityPersistence.getDataSource();
