...
/**
 * Provides the local service utility for LFPackageScopeRule. This utility wraps
 * {@link com.arcusys.learn.persistence.liferay.service.impl.LFPackageScopeRuleLocalServiceImpl} and is the
...
public class LFPackageScopeRuleLocalServiceUtil {
    ...
    */
    ...
    public static void removeByPackageID(java.lang.Integer packageID)
        throws com.arcusys.learn.persistence.liferay.NoSuchLFPackageScopeRuleException,
            com.liferay.portal.kernel.exception.SystemException {
        getService().removeByPackageID(packageID);
    }
