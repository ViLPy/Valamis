...
public class LFPackageCommentModelImpl extends BaseModelImpl<LFPackageComment>
    ...
    public static final String ORDER_BY_JPQL = " ORDER BY lfPackageComment.id ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Learn_LFPackageComment.id_ ASC";
    ...
    private LFPackageComment _escapedModel;
    ...
    public LFPackageComment toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (LFPackageComment) ProxyUtil.newProxyInstance(_classLoader,
