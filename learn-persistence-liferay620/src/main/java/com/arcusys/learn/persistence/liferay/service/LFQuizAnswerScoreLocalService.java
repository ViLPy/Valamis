...
/**
 * Provides the local service interface for LFQuizAnswerScore. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LFQuizAnswerScoreLocalServiceUtil
...
public interface LFQuizAnswerScoreLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link LFQuizAnswerScoreLocalServiceUtil} to access the l f quiz answer score local service. Add custom service methods to {@link com.arcusys.learn.persistence.liferay.service.impl.LFQuizAnswerScoreLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
