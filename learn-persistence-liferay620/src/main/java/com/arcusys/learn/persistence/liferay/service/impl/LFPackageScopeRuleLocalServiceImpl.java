...
public class LFPackageScopeRuleLocalServiceImpl
    ...
    public java.util.List<LFPackageScopeRule> findByPackageID(Integer packageID) throws
    ...
    public void removeByPackageID(Integer packageID) throws
            com.arcusys.learn.persistence.liferay.NoSuchLFPackageScopeRuleException,
            com.liferay.portal.kernel.exception.SystemException{
         lfPackageScopeRulePersistence.removeByPackageID(packageID);
    }
