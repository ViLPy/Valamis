...
public class LFTincanLrsSubStatementModelImpl extends BaseModelImpl<LFTincanLrsSubStatement>
    ...
    public static final String ORDER_BY_JPQL = " ORDER BY lfTincanLrsSubStatement.id ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Learn_LFTincanLrsSubStatement.id_ ASC";
    ...
    private LFTincanLrsSubStatement _escapedModel;
    ...
    public LFTincanLrsSubStatement toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (LFTincanLrsSubStatement) ProxyUtil.newProxyInstance(_classLoader,
