...
/**
 * Provides the base implementation for the l f quiz quest cat local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFQuizQuestCatLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFQuizQuestCatLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFQuizQuestCatLocalService,
        IdentifiableBean {
    ...
    private LFQuizQuestCatLocalServiceClpInvoker _clpInvoker = new LFQuizQuestCatLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFQuizQuestCatLocalServiceUtil} to access the l f quiz quest cat local service.
     */
    ...
    @Override
    public LFQuizQuestCat addLFQuizQuestCat(LFQuizQuestCat lfQuizQuestCat)
        throws SystemException {
        lfQuizQuestCat.setNew(true);

        return lfQuizQuestCatPersistence.update(lfQuizQuestCat);
    }
     ...
     */
    @Override
    public LFQuizQuestCat createLFQuizQuestCat(long id) {
        return lfQuizQuestCatPersistence.create(id);
    }
    ...
    @Override
    public LFQuizQuestCat deleteLFQuizQuestCat(long id)
        throws PortalException, SystemException {
        return lfQuizQuestCatPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFQuizQuestCat deleteLFQuizQuestCat(LFQuizQuestCat lfQuizQuestCat)
        throws SystemException {
        return lfQuizQuestCatPersistence.remove(lfQuizQuestCat);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFQuizQuestCat.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfQuizQuestCatPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfQuizQuestCatPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFQuizQuestCat fetchLFQuizQuestCat(long id)
        throws SystemException {
        return lfQuizQuestCatPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFQuizQuestCat getLFQuizQuestCat(long id)
        throws PortalException, SystemException {
        return lfQuizQuestCatPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfQuizQuestCatPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFQuizQuestCat> getLFQuizQuestCats(int start, int end)
        throws SystemException {
        return lfQuizQuestCatPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFQuizQuestCatsCount() throws SystemException {
        return lfQuizQuestCatPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFQuizQuestCat updateLFQuizQuestCat(LFQuizQuestCat lfQuizQuestCat)
        throws SystemException {
        return lfQuizQuestCatPersistence.update(lfQuizQuestCat);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFQuizQuestCat",
            lfQuizQuestCatLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.arcusys.learn.persistence.liferay.model.LFQuizQuestCat");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfQuizQuestCatPersistence.getDataSource();
