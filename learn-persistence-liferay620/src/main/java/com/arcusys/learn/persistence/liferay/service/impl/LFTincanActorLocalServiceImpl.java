...
public class LFTincanActorLocalServiceImpl
    ...
    public List<LFTincanActor> findAgent(String objectType, String mbox, String mbox_sha1sum, String openid, String account) throws SystemException {
        return lfTincanActorPersistence.findByAgent(objectType, mbox, mbox_sha1sum, openid, account);
    }
}
