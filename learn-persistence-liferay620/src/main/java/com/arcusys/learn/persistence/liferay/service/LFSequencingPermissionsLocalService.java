...
/**
 * Provides the local service interface for LFSequencingPermissions. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LFSequencingPermissionsLocalServiceUtil
...
public interface LFSequencingPermissionsLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link LFSequencingPermissionsLocalServiceUtil} to access the l f sequencing permissions local service. Add custom service methods to {@link com.arcusys.learn.persistence.liferay.service.impl.LFSequencingPermissionsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
