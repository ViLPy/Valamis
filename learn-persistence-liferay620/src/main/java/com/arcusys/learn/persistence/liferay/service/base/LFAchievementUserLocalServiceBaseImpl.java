...
import com.arcusys.learn.persistence.liferay.service.LFAchievementUserLocalService;
...
/**
 * Provides the base implementation for the l f achievement user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFAchievementUserLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.arcusys.learn.persistence.liferay.service.impl.LFAchievementUserLocalServiceImpl
 * @see com.arcusys.learn.persistence.liferay.service.LFAchievementUserLocalServiceUtil
 * @generated
 */
public abstract class LFAchievementUserLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFAchievementUserLocalService,
        IdentifiableBean {
    ...
    private LFAchievementUserLocalServiceClpInvoker _clpInvoker = new LFAchievementUserLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFAchievementUserLocalServiceUtil} to access the l f achievement user local service.
     */
    ...
    @Override
    public LFAchievementUser addLFAchievementUser(
        LFAchievementUser lfAchievementUser) throws SystemException {
        lfAchievementUser.setNew(true);

        return lfAchievementUserPersistence.update(lfAchievementUser);
    }
     ...
     */
    @Override
    public LFAchievementUser createLFAchievementUser(long id) {
        return lfAchievementUserPersistence.create(id);
    }
    ...
    @Override
    public LFAchievementUser deleteLFAchievementUser(long id)
        throws PortalException, SystemException {
        return lfAchievementUserPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFAchievementUser deleteLFAchievementUser(
        LFAchievementUser lfAchievementUser) throws SystemException {
        return lfAchievementUserPersistence.remove(lfAchievementUser);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFAchievementUser.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfAchievementUserPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfAchievementUserPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFAchievementUser fetchLFAchievementUser(long id)
        throws SystemException {
        return lfAchievementUserPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFAchievementUser getLFAchievementUser(long id)
        throws PortalException, SystemException {
        return lfAchievementUserPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfAchievementUserPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFAchievementUser> getLFAchievementUsers(int start, int end)
        throws SystemException {
        return lfAchievementUserPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFAchievementUsersCount() throws SystemException {
        return lfAchievementUserPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFAchievementUser updateLFAchievementUser(
        LFAchievementUser lfAchievementUser) throws SystemException {
        return lfAchievementUserPersistence.update(lfAchievementUser);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFAchievementUser",
            lfAchievementUserLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfAchievementUserPersistence.getDataSource();
