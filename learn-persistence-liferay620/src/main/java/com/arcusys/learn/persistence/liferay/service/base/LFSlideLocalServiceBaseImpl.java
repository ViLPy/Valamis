...
import com.arcusys.learn.persistence.liferay.service.LFSlideLocalService;
...
/**
 * Provides the base implementation for the l f slide local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFSlideLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFSlideLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements LFSlideLocalService, IdentifiableBean {
    ...
    private LFSlideLocalServiceClpInvoker _clpInvoker = new LFSlideLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFSlideLocalServiceUtil} to access the l f slide local service.
     */
    ...
    @Override
    public LFSlide addLFSlide(LFSlide lfSlide) throws SystemException {
        lfSlide.setNew(true);

        return lfSlidePersistence.update(lfSlide);
    }
     ...
     */
    @Override
    public LFSlide createLFSlide(long id) {
        return lfSlidePersistence.create(id);
    }
    ...
    @Override
    public LFSlide deleteLFSlide(long id)
        throws PortalException, SystemException {
        return lfSlidePersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFSlide deleteLFSlide(LFSlide lfSlide) throws SystemException {
        return lfSlidePersistence.remove(lfSlide);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFSlide.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfSlidePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return lfSlidePersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return lfSlidePersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSlidePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return lfSlidePersistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public LFSlide fetchLFSlide(long id) throws SystemException {
        return lfSlidePersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFSlide getLFSlide(long id) throws PortalException, SystemException {
        return lfSlidePersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfSlidePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFSlide> getLFSlides(int start, int end)
        throws SystemException {
        return lfSlidePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFSlidesCount() throws SystemException {
        return lfSlidePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFSlide updateLFSlide(LFSlide lfSlide) throws SystemException {
        return lfSlidePersistence.update(lfSlide);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFSlide",
            lfSlideLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfSlidePersistence.getDataSource();
