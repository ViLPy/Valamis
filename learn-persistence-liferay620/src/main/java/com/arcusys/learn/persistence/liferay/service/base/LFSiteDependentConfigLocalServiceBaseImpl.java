...
import com.arcusys.learn.persistence.liferay.service.LFSiteDependentConfigLocalService;
...
/**
 * Provides the base implementation for the l f site dependent config local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFSiteDependentConfigLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFSiteDependentConfigLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFSiteDependentConfigLocalService,
        IdentifiableBean {
    ...
    private LFSiteDependentConfigLocalServiceClpInvoker _clpInvoker = new LFSiteDependentConfigLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFSiteDependentConfigLocalServiceUtil} to access the l f site dependent config local service.
     */
    ...
    @Override
    public LFSiteDependentConfig addLFSiteDependentConfig(
        LFSiteDependentConfig lfSiteDependentConfig) throws SystemException {
        lfSiteDependentConfig.setNew(true);

        return lfSiteDependentConfigPersistence.update(lfSiteDependentConfig);
    }
     ...
     */
    @Override
    public LFSiteDependentConfig createLFSiteDependentConfig(long id) {
        return lfSiteDependentConfigPersistence.create(id);
    }
    ...
    @Override
    public LFSiteDependentConfig deleteLFSiteDependentConfig(long id)
        throws PortalException, SystemException {
        return lfSiteDependentConfigPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFSiteDependentConfig deleteLFSiteDependentConfig(
        LFSiteDependentConfig lfSiteDependentConfig) throws SystemException {
        return lfSiteDependentConfigPersistence.remove(lfSiteDependentConfig);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFSiteDependentConfig.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfSiteDependentConfigPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSiteDependentConfigPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFSiteDependentConfig fetchLFSiteDependentConfig(long id)
        throws SystemException {
        return lfSiteDependentConfigPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFSiteDependentConfig getLFSiteDependentConfig(long id)
        throws PortalException, SystemException {
        return lfSiteDependentConfigPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfSiteDependentConfigPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFSiteDependentConfig> getLFSiteDependentConfigs(int start,
        int end) throws SystemException {
        return lfSiteDependentConfigPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFSiteDependentConfigsCount() throws SystemException {
        return lfSiteDependentConfigPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFSiteDependentConfig updateLFSiteDependentConfig(
        LFSiteDependentConfig lfSiteDependentConfig) throws SystemException {
        return lfSiteDependentConfigPersistence.update(lfSiteDependentConfig);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFSiteDependentConfig",
            lfSiteDependentConfigLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfSiteDependentConfigPersistence.getDataSource();
