...
public class LFSequencingSoap implements Serializable {
    ...
    public static LFSequencingSoap toSoapModel(LFSequencing model) {
        ...
        soapModel.setCAttemptObjectiveProgressChild(model.getCAttemptObjectiveProgressChild());
        soapModel.setCAttemptAttemptProgressChild(model.getCAttemptAttemptProgressChild());
