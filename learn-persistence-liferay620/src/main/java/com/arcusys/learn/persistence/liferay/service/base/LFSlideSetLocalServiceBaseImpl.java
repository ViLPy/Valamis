...
import com.arcusys.learn.persistence.liferay.service.LFSlideSetLocalService;
...
/**
 * Provides the base implementation for the l f slide set local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFSlideSetLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.arcusys.learn.persistence.liferay.service.impl.LFSlideSetLocalServiceImpl
 * @see com.arcusys.learn.persistence.liferay.service.LFSlideSetLocalServiceUtil
 * @generated
 */
public abstract class LFSlideSetLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFSlideSetLocalService,
        IdentifiableBean {
    ...
    private LFSlideSetLocalServiceClpInvoker _clpInvoker = new LFSlideSetLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFSlideSetLocalServiceUtil} to access the l f slide set local service.
     */
    ...
    @Override
    public LFSlideSet addLFSlideSet(LFSlideSet lfSlideSet)
        throws SystemException {
        lfSlideSet.setNew(true);

        return lfSlideSetPersistence.update(lfSlideSet);
    }
     ...
     */
    @Override
    public LFSlideSet createLFSlideSet(long id) {
        return lfSlideSetPersistence.create(id);
    }
    ...
    @Override
    public LFSlideSet deleteLFSlideSet(long id)
        throws PortalException, SystemException {
        return lfSlideSetPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFSlideSet deleteLFSlideSet(LFSlideSet lfSlideSet)
        throws SystemException {
        return lfSlideSetPersistence.remove(lfSlideSet);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFSlideSet.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSlideSetPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return lfSlideSetPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSlideSetPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFSlideSet fetchLFSlideSet(long id) throws SystemException {
        return lfSlideSetPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFSlideSet getLFSlideSet(long id)
        throws PortalException, SystemException {
        return lfSlideSetPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfSlideSetPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFSlideSet> getLFSlideSets(int start, int end)
        throws SystemException {
        return lfSlideSetPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFSlideSetsCount() throws SystemException {
        return lfSlideSetPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFSlideSet updateLFSlideSet(LFSlideSet lfSlideSet)
        throws SystemException {
        return lfSlideSetPersistence.update(lfSlideSet);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFSlideSet",
            lfSlideSetLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfSlideSetPersistence.getDataSource();
