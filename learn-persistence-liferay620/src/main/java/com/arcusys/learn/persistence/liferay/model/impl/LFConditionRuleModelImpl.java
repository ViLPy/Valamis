...
public class LFConditionRuleModelImpl extends BaseModelImpl<LFConditionRule>
    ...
    public static final String TABLE_SQL_CREATE = "create table Learn_LFConditionRule (id_ LONG not null primary key,sequencingID INTEGER null,combination TEXT null,ruleType VARCHAR(3000) null,action TEXT null)";
    public static final String TABLE_SQL_DROP = "drop table Learn_LFConditionRule";
    public static final String ORDER_BY_JPQL = " ORDER BY lfConditionRule.id ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Learn_LFConditionRule.id_ ASC";
    ...
    private LFConditionRule _escapedModel;
    ...
    public LFConditionRule toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (LFConditionRule) ProxyUtil.newProxyInstance(_classLoader,
