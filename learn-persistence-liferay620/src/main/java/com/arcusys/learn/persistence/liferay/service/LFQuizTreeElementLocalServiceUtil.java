...
/**
 * Provides the local service utility for LFQuizTreeElement. This utility wraps
 * {@link com.arcusys.learn.persistence.liferay.service.impl.LFQuizTreeElementLocalServiceImpl} and is the
 ...
 * @see com.arcusys.learn.persistence.liferay.service.impl.LFQuizTreeElementLocalServiceImpl
 * @generated
 */
public class LFQuizTreeElementLocalServiceUtil {
    private static LFQuizTreeElementLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.arcusys.learn.persistence.liferay.service.impl.LFQuizTreeElementLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFQuizTreeElement addLFQuizTreeElement(
        com.arcusys.learn.persistence.liferay.model.LFQuizTreeElement lfQuizTreeElement)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().addLFQuizTreeElement(lfQuizTreeElement);
    }
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFQuizTreeElement createLFQuizTreeElement(
        long id) {
        return getService().createLFQuizTreeElement(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.arcusys.learn.persistence.liferay.model.LFQuizTreeElement deleteLFQuizTreeElement(
        long id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteLFQuizTreeElement(id);
    }
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFQuizTreeElement deleteLFQuizTreeElement(
        com.arcusys.learn.persistence.liferay.model.LFQuizTreeElement lfQuizTreeElement)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteLFQuizTreeElement(lfQuizTreeElement);
    }
    ...
    */
    ...
    public static com.arcusys.learn.persistence.liferay.model.LFQuizTreeElement fetchLFQuizTreeElement(
        long id) throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchLFQuizTreeElement(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.arcusys.learn.persistence.liferay.model.LFQuizTreeElement getLFQuizTreeElement(
        long id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getLFQuizTreeElement(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.arcusys.learn.persistence.liferay.model.LFQuizTreeElement> getLFQuizTreeElements(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getLFQuizTreeElements(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getLFQuizTreeElementsCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getLFQuizTreeElementsCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.arcusys.learn.persistence.liferay.model.LFQuizTreeElement updateLFQuizTreeElement(
        com.arcusys.learn.persistence.liferay.model.LFQuizTreeElement lfQuizTreeElement)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateLFQuizTreeElement(lfQuizTreeElement);
    }
    ...
    */
    ...
    public static com.arcusys.learn.persistence.liferay.model.LFQuizTreeElement createLFQuizTreeElement()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().createLFQuizTreeElement();
    }
    ...
    public static LFQuizTreeElementLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    LFQuizTreeElementLocalService.class.getName());

            if (invokableLocalService instanceof LFQuizTreeElementLocalService) {
                _service = (LFQuizTreeElementLocalService) invokableLocalService;
            } else {
                _service = new LFQuizTreeElementLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(LFQuizTreeElementLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(LFQuizTreeElementLocalService service) {
    }
}
