...
public class LFPackageScopeRuleModelImpl extends BaseModelImpl<LFPackageScopeRule>
    ...
    public static final Object[][] TABLE_COLUMNS = {
            ...
            { "scope", Types.VARCHAR },
            { "scopeID", Types.VARCHAR },
            { "visibility", Types.BOOLEAN },
            { "isDefault", Types.BOOLEAN }
        };
    public static final String TABLE_SQL_CREATE = "create table Learn_LFPackageScopeRule (id_ LONG not null primary key,packageID INTEGER null,scope VARCHAR(3000) null,scopeID VARCHAR(3000) null,visibility BOOLEAN null,isDefault BOOLEAN null)";
    public static final String TABLE_SQL_DROP = "drop table Learn_LFPackageScopeRule";
    public static final String ORDER_BY_JPQL = " ORDER BY lfPackageScopeRule.id ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Learn_LFPackageScopeRule.id_ ASC";
    ...
    private LFPackageScopeRule _escapedModel;
    ...
    public LFPackageScopeRule toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (LFPackageScopeRule) ProxyUtil.newProxyInstance(_classLoader,
