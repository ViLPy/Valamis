...
/**
 * Provides the local service interface for LFGlobalObjectiveState. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LFGlobalObjectiveStateLocalServiceUtil
...
public interface LFGlobalObjectiveStateLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link LFGlobalObjectiveStateLocalServiceUtil} to access the l f global objective state local service. Add custom service methods to {@link com.arcusys.learn.persistence.liferay.service.impl.LFGlobalObjectiveStateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
