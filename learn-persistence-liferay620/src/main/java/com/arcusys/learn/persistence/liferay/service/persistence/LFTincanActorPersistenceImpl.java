...
public class LFTincanActorPersistenceImpl extends BasePersistenceImpl<LFTincanActor>
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_AGENT = new FinderPath(LFTincanActorModelImpl.ENTITY_CACHE_ENABLED,
            ...
            LFTincanActorModelImpl.ACCOUNT_COLUMN_BITMASK);
    ...
    private static final String _FINDER_COLUMN_AGENT_OPENID_1 = "lfTincanActor.openid IS NULL AND ";
    private static final String _FINDER_COLUMN_AGENT_OPENID_NULL = "lfTincanActor.openid IS NULL";
    private static final String _FINDER_COLUMN_AGENT_OPENID_2 = "lfTincanActor.openid = ? AND ";
    private static final String _FINDER_COLUMN_AGENT_OPENID_NULL_2 = "lfTincanActor.openid IS NULL  AND ";
    private static final String _FINDER_COLUMN_AGENT_OPENID_3 = "(lfTincanActor.openid IS NULL OR lfTincanActor.openid = '') AND ";
    private static final String _FINDER_COLUMN_AGENT_ACCOUNT_1 = "lfTincanActor.account IS NULL";
    private static final String _FINDER_COLUMN_AGENT_ACCOUNT_NULL = "lfTincanActor.account IS NULL";
    private static final String _FINDER_COLUMN_AGENT_ACCOUNT_2 = "lfTincanActor.account = ?";
    private static final String _FINDER_COLUMN_AGENT_ACCOUNT_NULL_2 = "lfTincanActor.account IS NULL ";
    private static final String _FINDER_COLUMN_AGENT_ACCOUNT_3 = "(lfTincanActor.account IS NULL OR lfTincanActor.account = '')";
    ...
    public List<LFTincanActor> findByAgent(String objectType, String mbox,
        ...
        throws SystemException {
        return findByAgent(objectType, mbox, mbox_sha1sum, openid, account,
            QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
    }
    ...
    public List<LFTincanActor> findByAgent(String objectType, String mbox,
        ...
        if ((list != null) && !list.isEmpty()) {
            for (LFTincanActor lfTincanActor : list) {
                if (!Validator.equals(objectType, lfTincanActor.getObjectType()) ||
                        ...
                        !Validator.equals(account, lfTincanActor.getAccount())) {
                    list = null;
        ...
        if (list == null) {
            ...
            if (account == null) {
                query.append(_FINDER_COLUMN_AGENT_ACCOUNT_1);
            } else if (account.equals(StringPool.BLANK)) {
                query.append(_FINDER_COLUMN_AGENT_ACCOUNT_3);
            } else {
                bindAccount = true;

                if (account.equals(StringPool.BLANK)) {
                    query.append(_FINDER_COLUMN_AGENT_ACCOUNT_3);
                } else {
                    query.append(_FINDER_COLUMN_AGENT_ACCOUNT_2);
                }
            }
     ...
     */
    @Override
    public LFTincanActor fetchByAgent_First(String objectType, String mbox,
        String mbox_sha1sum, String openid, String account,
        OrderByComparator orderByComparator) throws SystemException {
        List<LFTincanActor> list = findByAgent(objectType, mbox, mbox_sha1sum,
                openid, account, 0, 1, orderByComparator);
     ...
     */
    @Override
    public LFTincanActor fetchByAgent_Last(String objectType, String mbox,
        String mbox_sha1sum, String openid, String account,
        OrderByComparator orderByComparator) throws SystemException {
        int count = countByAgent(objectType, mbox, mbox_sha1sum, openid, account);
        ...
        List<LFTincanActor> list = findByAgent(objectType, mbox, mbox_sha1sum,
                openid, account, count - 1, count, orderByComparator);
    ...
    protected LFTincanActor getByAgent_PrevAndNext(Session session,
        LFTincanActor lfTincanActor, String objectType, String mbox,
        String mbox_sha1sum, String openid, String account,
        OrderByComparator orderByComparator, boolean previous) {
        StringBundler query = null;
     ...
     */
    @Override
    public void removeByAgent(String objectType, String mbox,
        String mbox_sha1sum, String openid, String account)
        throws SystemException {
        for (LFTincanActor lfTincanActor : findByAgent(objectType, mbox,
                mbox_sha1sum, openid, account, QueryUtil.ALL_POS,
