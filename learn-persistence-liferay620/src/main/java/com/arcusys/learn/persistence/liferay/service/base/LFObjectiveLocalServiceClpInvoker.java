...
public class LFObjectiveLocalServiceClpInvoker {
    ...
    public LFObjectiveLocalServiceClpInvoker() {
        ...
        _methodName322 = "createLFObjective";

        _methodParameterTypes322 = new String[] {  };

        _methodName323 = "findBySequencingIDAndIsPrimary";

        _methodParameterTypes323 = new String[] { "java.lang.Integer", "boolean" };

        _methodName324 = "findBySequencingIDAndIsPrimaryAndIdentifier";
