...
public class LFObjectiveLocalServiceClpInvoker {
    ...
    public LFObjectiveLocalServiceClpInvoker() {
        ...
        _methodName222 = "createLFObjective";

        _methodParameterTypes222 = new String[] {  };

        _methodName223 = "findBySequencingIDAndIsPrimary";

        _methodParameterTypes223 = new String[] { "java.lang.Integer", "boolean" };

        _methodName224 = "findBySequencingIDAndIsPrimaryAndIdentifier";
