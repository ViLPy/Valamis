...
public class LFQuestionCategoryPersistenceImpl extends BasePersistenceImpl<LFQuestionCategory>
    ...
    private static final String _FINDER_COLUMN_COURSEIDANDPARENTID_COURSEID_5 = "(" +
        removeConjunction(_FINDER_COLUMN_COURSEIDANDPARENTID_COURSEID_2) + ")";
    ...
    private static final String _FINDER_COLUMN_COURSEIDANDPARENTID_PARENTID_5 = "(" +
        removeConjunction(_FINDER_COLUMN_COURSEIDANDPARENTID_PARENTID_2) + ")";
    ...
    public LFQuestionCategoryPersistenceImpl() {
        setModelClass(LFQuestionCategory.class);
    }
    ...
    public List<LFQuestionCategory> findByCourseId(Integer courseId, int start,
        ...
        if (list == null) {
            ...
            if (orderByComparator != null) {
             ...
             if (pagination) {
                query.append(LFQuestionCategoryModelImpl.ORDER_BY_JPQL);
            }
            ...
            try {
                ...
                if (!pagination) {
                    ...
                    list = new UnmodifiableList<LFQuestionCategory>(list);
                } else {
                    list = (List<LFQuestionCategory>) QueryUtil.list(q,
    ...
    public List<LFQuestionCategory> findByCourseId(Integer[] courseIds,
        ...
        List<LFQuestionCategory> list = (List<LFQuestionCategory>) FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_COURSEID,
                finderArgs, this);
    ...
    public List<LFQuestionCategory> findByCourseIdAndParentId(
        ...
        OrderByComparator orderByComparator) throws SystemException {
        if ((courseIds != null) && (courseIds.length == 1) &&
                (parentIds != null) && (parentIds.length == 1)) {
            return findByCourseIdAndParentId(courseIds[0], parentIds[0], start,
        ...
        List<LFQuestionCategory> list = (List<LFQuestionCategory>) FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_COURSEIDANDPARENTID,
                finderArgs, this);
        ...
        if (list == null) {
            ...
            try {
                ...
                FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_COURSEIDANDPARENTID,
                    finderArgs, list);
            } catch (Exception e) {
                FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_COURSEIDANDPARENTID,
                    finderArgs);
    ...
    public void removeByCourseIdAndParentId(Integer courseId, Integer parentId)
        ...
        for (LFQuestionCategory lfQuestionCategory : findByCourseIdAndParentId(
                courseId, parentId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
            remove(lfQuestionCategory);
        }
    }
    ...
    public int countByCourseIdAndParentId(Integer courseId, Integer parentId)
        throws SystemException {
        FinderPath finderPath = FINDER_PATH_COUNT_BY_COURSEIDANDPARENTID;
    ...
    public int countByCourseIdAndParentId(Integer[] courseIds,
        ...
        if (count == null) {
            ...
            try {
                ...
                FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_COURSEIDANDPARENTID,
                    finderArgs);
    ...
    protected LFQuestionCategory removeImpl(
        ...
        try {
            ...
            if (!session.contains(lfQuestionCategory)) {
                lfQuestionCategory = (LFQuestionCategory) session.get(LFQuestionCategoryImpl.class,
                        lfQuestionCategory.getPrimaryKeyObj());
            }

            if (lfQuestionCategory != null) {
                session.delete(lfQuestionCategory);
            }
        } catch (Exception e) {
            throw processException(e);
        } finally {
    ...
    public LFQuestionCategory findByPrimaryKey(Serializable primaryKey)
        throws NoSuchLFQuestionCategoryException, SystemException {
        LFQuestionCategory lfQuestionCategory = fetchByPrimaryKey(primaryKey);
    ...
    public List<LFQuestionCategory> findAll(int start, int end,
        ...
        if (list == null) {
            ...
            if (orderByComparator != null) {
                ...
                if (pagination) {
                    sql = sql.concat(LFQuestionCategoryModelImpl.ORDER_BY_JPQL);
                }
            }
