 ...
 * @generated
 */
public class LFTincanURILocalServiceClpInvoker {
    ...
    public LFTincanURILocalServiceClpInvoker() {
        ...
        _methodName1 = "createLFTincanURI";

        _methodParameterTypes1 = new String[] { "java.lang.String" };

        _methodName2 = "deleteLFTincanURI";

        _methodParameterTypes2 = new String[] { "java.lang.String" };

        _methodName3 = "deleteLFTincanURI";
        ...
        _methodName10 = "fetchLFTincanURI";

        _methodParameterTypes10 = new String[] { "java.lang.String" };

        _methodName11 = "getLFTincanURI";
        ...
        _methodName13 = "getLFTincanURIs";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getLFTincanURIsCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateLFTincanURI";
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return LFTincanURILocalServiceUtil.addLFTincanURI((com.arcusys.learn.persistence.liferay.model.LFTincanURI) arguments[0]);
        }

        if (_methodName1.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes1, parameterTypes)) {
            return LFTincanURILocalServiceUtil.createLFTincanURI((java.lang.String) arguments[0]);
        }

        if (_methodName2.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes2, parameterTypes)) {
            return LFTincanURILocalServiceUtil.deleteLFTincanURI((java.lang.String) arguments[0]);
        }

        if (_methodName3.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes3, parameterTypes)) {
            return LFTincanURILocalServiceUtil.deleteLFTincanURI((com.arcusys.learn.persistence.liferay.model.LFTincanURI) arguments[0]);
        }

        if (_methodName4.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes4, parameterTypes)) {
            return LFTincanURILocalServiceUtil.dynamicQuery();
        }

        if (_methodName5.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes5, parameterTypes)) {
            return LFTincanURILocalServiceUtil.dynamicQuery((com.liferay.portal.kernel.dao.orm.DynamicQuery) arguments[0]);
        }
        ...
        if (_methodName8.equals(name) &&
            ...
            return LFTincanURILocalServiceUtil.dynamicQueryCount((com.liferay.portal.kernel.dao.orm.DynamicQuery) arguments[0]);
        }
        ...
        if (_methodName10.equals(name) &&
            ...
            return LFTincanURILocalServiceUtil.fetchLFTincanURI((java.lang.String) arguments[0]);
        }

        if (_methodName11.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes11, parameterTypes)) {
            return LFTincanURILocalServiceUtil.getLFTincanURI((java.lang.String) arguments[0]);
        }

        if (_methodName12.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes12, parameterTypes)) {
            return LFTincanURILocalServiceUtil.getPersistedModel((java.io.Serializable) arguments[0]);
        }

        if (_methodName13.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes13, parameterTypes)) {
            return LFTincanURILocalServiceUtil.getLFTincanURIs(((Integer) arguments[0]).intValue(),
                ((Integer) arguments[1]).intValue());
        }

        if (_methodName14.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes14, parameterTypes)) {
            return LFTincanURILocalServiceUtil.getLFTincanURIsCount();
        }
