...
public class LFQuizTreeElementPersistenceImpl extends BasePersistenceImpl<LFQuizTreeElement>
    ...
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_QUIZANDPARENTID =
        new FinderPath(LFQuizTreeElementModelImpl.ENTITY_CACHE_ENABLED,
            LFQuizTreeElementModelImpl.FINDER_CACHE_ENABLED,
            LFQuizTreeElementImpl.class,
            FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByQuizAndParentID",
            new String[] {
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_QUIZANDPARENTID =
        new FinderPath(LFQuizTreeElementModelImpl.ENTITY_CACHE_ENABLED,
            LFQuizTreeElementModelImpl.FINDER_CACHE_ENABLED,
            LFQuizTreeElementImpl.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByQuizAndParentID",
            new String[] { Integer.class.getName(), String.class.getName() },
            LFQuizTreeElementModelImpl.QUIZID_COLUMN_BITMASK |
            LFQuizTreeElementModelImpl.PARENTID_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_QUIZANDPARENTID = new FinderPath(LFQuizTreeElementModelImpl.ENTITY_CACHE_ENABLED,
            LFQuizTreeElementModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
            "countByQuizAndParentID",
            new String[] { Integer.class.getName(), String.class.getName() });
    private static final String _FINDER_COLUMN_QUIZANDPARENTID_QUIZID_NULL = "lfQuizTreeElement.quizID IS NULL";
    private static final String _FINDER_COLUMN_QUIZANDPARENTID_QUIZID_2 = "lfQuizTreeElement.quizID = ? AND ";
    private static final String _FINDER_COLUMN_QUIZANDPARENTID_QUIZID_NULL_2 = "lfQuizTreeElement.quizID IS NULL  AND ";
    private static final String _FINDER_COLUMN_QUIZANDPARENTID_PARENTID_1 = "lfQuizTreeElement.parentID IS NULL";
    private static final String _FINDER_COLUMN_QUIZANDPARENTID_PARENTID_NULL = "lfQuizTreeElement.parentID IS NULL";
    private static final String _FINDER_COLUMN_QUIZANDPARENTID_PARENTID_2 = "lfQuizTreeElement.parentID = ?";
    private static final String _FINDER_COLUMN_QUIZANDPARENTID_PARENTID_NULL_2 = "lfQuizTreeElement.parentID IS NULL ";
    private static final String _FINDER_COLUMN_QUIZANDPARENTID_PARENTID_3 = "(lfQuizTreeElement.parentID IS NULL OR lfQuizTreeElement.parentID = '')";
     ...
     */
    @Override
    public List<LFQuizTreeElement> findByQuizAndParentID(Integer quizID,
        String parentID) throws SystemException {
        return findByQuizAndParentID(quizID, parentID, QueryUtil.ALL_POS,
    ...
    public List<LFQuizTreeElement> findByQuizAndParentID(Integer quizID,
        ...
        return findByQuizAndParentID(quizID, parentID, start, end, null);
    }
    ...
    public List<LFQuizTreeElement> findByQuizAndParentID(Integer quizID,
        ...
        if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
                (orderByComparator == null)) {
            pagination = false;
            finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_QUIZANDPARENTID;
            finderArgs = new Object[] { quizID, parentID };
        } else {
            finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_QUIZANDPARENTID;
        ...
        if (list == null) {
            ...
            if (quizID == null) {
                query.append(_FINDER_COLUMN_QUIZANDPARENTID_QUIZID_NULL_2);
            } else {
                query.append(_FINDER_COLUMN_QUIZANDPARENTID_QUIZID_2);
            }

            boolean bindParentID = false;

            if (parentID == null) {
                query.append(_FINDER_COLUMN_QUIZANDPARENTID_PARENTID_1);
            } else if (parentID.equals(StringPool.BLANK)) {
                query.append(_FINDER_COLUMN_QUIZANDPARENTID_PARENTID_3);
            } else {
                bindParentID = true;
                ...
                if (parentID.equals(StringPool.BLANK)) {
                    ...
                    query.append(_FINDER_COLUMN_QUIZANDPARENTID_PARENTID_2);
                }
            }
     ...
     */
    @Override
    public LFQuizTreeElement findByQuizAndParentID_First(Integer quizID,
        String parentID, OrderByComparator orderByComparator)
        throws NoSuchLFQuizTreeElementException, SystemException {
        LFQuizTreeElement lfQuizTreeElement = fetchByQuizAndParentID_First(quizID,
     ...
     */
    @Override
    public LFQuizTreeElement fetchByQuizAndParentID_First(Integer quizID,
        String parentID, OrderByComparator orderByComparator)
        throws SystemException {
        List<LFQuizTreeElement> list = findByQuizAndParentID(quizID, parentID,
     ...
     */
    @Override
    public LFQuizTreeElement findByQuizAndParentID_Last(Integer quizID,
        String parentID, OrderByComparator orderByComparator)
        throws NoSuchLFQuizTreeElementException, SystemException {
        LFQuizTreeElement lfQuizTreeElement = fetchByQuizAndParentID_Last(quizID,
                parentID, orderByComparator);
     ...
     */
    @Override
    public LFQuizTreeElement fetchByQuizAndParentID_Last(Integer quizID,
        String parentID, OrderByComparator orderByComparator)
        throws SystemException {
        int count = countByQuizAndParentID(quizID, parentID);
     ...
     */
    @Override
    public LFQuizTreeElement[] findByQuizAndParentID_PrevAndNext(long id,
        Integer quizID, String parentID, OrderByComparator orderByComparator)
        throws NoSuchLFQuizTreeElementException, SystemException {
        LFQuizTreeElement lfQuizTreeElement = findByPrimaryKey(id);
        ...
        try {
            ...
            array[0] = getByQuizAndParentID_PrevAndNext(session,
                    lfQuizTreeElement, quizID, parentID, orderByComparator, true);

            array[1] = lfQuizTreeElement;

            array[2] = getByQuizAndParentID_PrevAndNext(session,
                    lfQuizTreeElement, quizID, parentID, orderByComparator,
                    false);
    ...
    protected LFQuizTreeElement getByQuizAndParentID_PrevAndNext(
        Session session, LFQuizTreeElement lfQuizTreeElement, Integer quizID,
     ...
     */
    @Override
    public void removeByQuizAndParentID(Integer quizID, String parentID)
        throws SystemException {
        for (LFQuizTreeElement lfQuizTreeElement : findByQuizAndParentID(
     ...
     */
    @Override
    public int countByQuizAndParentID(Integer quizID, String parentID)
        throws SystemException {
        FinderPath finderPath = FINDER_PATH_COUNT_BY_QUIZANDPARENTID;
    ...
    public LFQuizTreeElement updateImpl(
        ...
        if (isNew || !LFQuizTreeElementModelImpl.COLUMN_BITMASK_ENABLED) {
            ...
            if ((lfQuizTreeElementModelImpl.getColumnBitmask() &
                    FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_QUIZANDPARENTID.getColumnBitmask()) != 0) {
                Object[] args = new Object[] {
                        lfQuizTreeElementModelImpl.getOriginalQuizID(),
                        lfQuizTreeElementModelImpl.getOriginalParentID()
                    };

                FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_QUIZANDPARENTID,
                    args);
                FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_QUIZANDPARENTID,
                    args);

                args = new Object[] {
                        lfQuizTreeElementModelImpl.getQuizID(),
                        lfQuizTreeElementModelImpl.getParentID()
                    };
