...
import com.arcusys.learn.persistence.liferay.service.LFLRSToActivitySettingLocalService;
...
/**
 * Provides the base implementation for the l f l r s to activity setting local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFLRSToActivitySettingLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.arcusys.learn.persistence.liferay.service.impl.LFLRSToActivitySettingLocalServiceImpl
 * @see com.arcusys.learn.persistence.liferay.service.LFLRSToActivitySettingLocalServiceUtil
 * @generated
 */
public abstract class LFLRSToActivitySettingLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFLRSToActivitySettingLocalService,
        IdentifiableBean {
    ...
    private LFLRSToActivitySettingLocalServiceClpInvoker _clpInvoker = new LFLRSToActivitySettingLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFLRSToActivitySettingLocalServiceUtil} to access the l f l r s to activity setting local service.
     */
    ...
    @Override
    public LFLRSToActivitySetting addLFLRSToActivitySetting(
        LFLRSToActivitySetting lflrsToActivitySetting)
        throws SystemException {
        lflrsToActivitySetting.setNew(true);

        return lflrsToActivitySettingPersistence.update(lflrsToActivitySetting);
    }
     ...
     */
    @Override
    public LFLRSToActivitySetting createLFLRSToActivitySetting(long id) {
        return lflrsToActivitySettingPersistence.create(id);
    }
    ...
    @Override
    public LFLRSToActivitySetting deleteLFLRSToActivitySetting(long id)
        throws PortalException, SystemException {
        return lflrsToActivitySettingPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFLRSToActivitySetting deleteLFLRSToActivitySetting(
        LFLRSToActivitySetting lflrsToActivitySetting)
        throws SystemException {
        return lflrsToActivitySettingPersistence.remove(lflrsToActivitySetting);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFLRSToActivitySetting.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lflrsToActivitySettingPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lflrsToActivitySettingPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFLRSToActivitySetting fetchLFLRSToActivitySetting(long id)
        throws SystemException {
        return lflrsToActivitySettingPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public LFLRSToActivitySetting getLFLRSToActivitySetting(long id)
        throws PortalException, SystemException {
        return lflrsToActivitySettingPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lflrsToActivitySettingPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFLRSToActivitySetting> getLFLRSToActivitySettings(int start,
        int end) throws SystemException {
        return lflrsToActivitySettingPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFLRSToActivitySettingsCount() throws SystemException {
        return lflrsToActivitySettingPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFLRSToActivitySetting updateLFLRSToActivitySetting(
        LFLRSToActivitySetting lflrsToActivitySetting)
        throws SystemException {
        return lflrsToActivitySettingPersistence.update(lflrsToActivitySetting);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFLRSToActivitySetting",
            lflrsToActivitySettingLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lflrsToActivitySettingPersistence.getDataSource();
