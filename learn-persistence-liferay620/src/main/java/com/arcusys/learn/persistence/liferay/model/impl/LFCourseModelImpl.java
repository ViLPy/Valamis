...
public class LFCourseModelImpl extends BaseModelImpl<LFCourse>
    ...
    public static final String TABLE_SQL_CREATE = "create table Learn_LFCourse (id_ LONG not null primary key,courseID INTEGER null,userID INTEGER null,grade VARCHAR(3000) null,comment_ TEXT null,date_ DATE null)";
    public static final String TABLE_SQL_DROP = "drop table Learn_LFCourse";
    public static final String ORDER_BY_JPQL = " ORDER BY lfCourse.id ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Learn_LFCourse.id_ ASC";
    ...
    private LFCourse _escapedModel;
    ...
    public LFCourse toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (LFCourse) ProxyUtil.newProxyInstance(_classLoader,
