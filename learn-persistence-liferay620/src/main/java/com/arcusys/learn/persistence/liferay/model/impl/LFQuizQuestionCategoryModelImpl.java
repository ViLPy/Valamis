...
public class LFQuizQuestionCategoryModelImpl extends BaseModelImpl<LFQuizQuestionCategory>
    ...
    public static final String ORDER_BY_JPQL = " ORDER BY lfQuizQuestionCategory.id ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Learn_LFQuizQuestionCategory.id_ ASC";
    ...
    private LFQuizQuestionCategory _escapedModel;
