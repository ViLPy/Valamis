...
import com.arcusys.learn.persistence.liferay.service.LFPackageGradeStorageLocalService;
...
/**
 * Provides the base implementation for the l f package grade storage local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFPackageGradeStorageLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFPackageGradeStorageLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFPackageGradeStorageLocalService,
        IdentifiableBean {
    ...
    private LFPackageGradeStorageLocalServiceClpInvoker _clpInvoker = new LFPackageGradeStorageLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFPackageGradeStorageLocalServiceUtil} to access the l f package grade storage local service.
     */
    ...
    @Override
    public LFPackageGradeStorage addLFPackageGradeStorage(
        LFPackageGradeStorage lfPackageGradeStorage) throws SystemException {
        lfPackageGradeStorage.setNew(true);

        return lfPackageGradeStoragePersistence.update(lfPackageGradeStorage);
    }
     ...
     */
    @Override
    public LFPackageGradeStorage createLFPackageGradeStorage(
        LFPackageGradeStoragePK lfPackageGradeStoragePK) {
        return lfPackageGradeStoragePersistence.create(lfPackageGradeStoragePK);
    }
    ...
    @Override
    public LFPackageGradeStorage deleteLFPackageGradeStorage(
        LFPackageGradeStoragePK lfPackageGradeStoragePK)
        throws PortalException, SystemException {
        return lfPackageGradeStoragePersistence.remove(lfPackageGradeStoragePK);
    }
    ...
    public LFPackageGradeStorage deleteLFPackageGradeStorage(
        LFPackageGradeStorage lfPackageGradeStorage) throws SystemException {
        return lfPackageGradeStoragePersistence.remove(lfPackageGradeStorage);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFPackageGradeStorage.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfPackageGradeStoragePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfPackageGradeStoragePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFPackageGradeStorage fetchLFPackageGradeStorage(
        LFPackageGradeStoragePK lfPackageGradeStoragePK)
        throws SystemException {
        return lfPackageGradeStoragePersistence.fetchByPrimaryKey(lfPackageGradeStoragePK);
    }
     ...
     */
    @Override
    public LFPackageGradeStorage getLFPackageGradeStorage(
        LFPackageGradeStoragePK lfPackageGradeStoragePK)
        throws PortalException, SystemException {
        return lfPackageGradeStoragePersistence.findByPrimaryKey(lfPackageGradeStoragePK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfPackageGradeStoragePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFPackageGradeStorage> getLFPackageGradeStorages(int start,
        int end) throws SystemException {
        return lfPackageGradeStoragePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFPackageGradeStoragesCount() throws SystemException {
        return lfPackageGradeStoragePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFPackageGradeStorage updateLFPackageGradeStorage(
        LFPackageGradeStorage lfPackageGradeStorage) throws SystemException {
        return lfPackageGradeStoragePersistence.update(lfPackageGradeStorage);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFPackageGradeStorage",
            lfPackageGradeStorageLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfPackageGradeStoragePersistence.getDataSource();
