...
import com.arcusys.learn.persistence.liferay.service.LFQuizAnswerScoreLocalService;
...
/**
 * Provides the base implementation for the l f quiz answer score local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFQuizAnswerScoreLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFQuizAnswerScoreLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFQuizAnswerScoreLocalService,
        IdentifiableBean {
    ...
    private LFQuizAnswerScoreLocalServiceClpInvoker _clpInvoker = new LFQuizAnswerScoreLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFQuizAnswerScoreLocalServiceUtil} to access the l f quiz answer score local service.
     */
    ...
    @Override
    public LFQuizAnswerScore addLFQuizAnswerScore(
        LFQuizAnswerScore lfQuizAnswerScore) throws SystemException {
        lfQuizAnswerScore.setNew(true);

        return lfQuizAnswerScorePersistence.update(lfQuizAnswerScore);
    }
     ...
     */
    @Override
    public LFQuizAnswerScore createLFQuizAnswerScore(long answerId) {
        return lfQuizAnswerScorePersistence.create(answerId);
    }
    ...
    @Override
    public LFQuizAnswerScore deleteLFQuizAnswerScore(long answerId)
        throws PortalException, SystemException {
        return lfQuizAnswerScorePersistence.remove(answerId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFQuizAnswerScore deleteLFQuizAnswerScore(
        LFQuizAnswerScore lfQuizAnswerScore) throws SystemException {
        return lfQuizAnswerScorePersistence.remove(lfQuizAnswerScore);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFQuizAnswerScore.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfQuizAnswerScorePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfQuizAnswerScorePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFQuizAnswerScore fetchLFQuizAnswerScore(long answerId)
        throws SystemException {
        return lfQuizAnswerScorePersistence.fetchByPrimaryKey(answerId);
    }
     ...
     */
    @Override
    public LFQuizAnswerScore getLFQuizAnswerScore(long answerId)
        throws PortalException, SystemException {
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfQuizAnswerScorePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFQuizAnswerScore> getLFQuizAnswerScores(int start, int end)
        throws SystemException {
        return lfQuizAnswerScorePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFQuizAnswerScoresCount() throws SystemException {
        return lfQuizAnswerScorePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFQuizAnswerScore updateLFQuizAnswerScore(
        LFQuizAnswerScore lfQuizAnswerScore) throws SystemException {
        return lfQuizAnswerScorePersistence.update(lfQuizAnswerScore);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFQuizAnswerScore",
            lfQuizAnswerScoreLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfQuizAnswerScorePersistence.getDataSource();
