...
public class LFAnswerLocalServiceClpInvoker {
    ...
    public LFAnswerLocalServiceClpInvoker() {
        ...
        _methodName10 = "fetchLFAnswer";

        _methodParameterTypes10 = new String[] { "long" };

        _methodName11 = "getLFAnswer";
        ...
        _methodName13 = "getLFAnswers";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getLFAnswersCount";
        ...
        _methodName322 = "createLFAnswer";

        _methodParameterTypes322 = new String[] {  };

        _methodName323 = "findByQuestionId";

        _methodParameterTypes323 = new String[] { "java.lang.Integer" };

        _methodName324 = "removeByQuestionId";
