...
import com.arcusys.learn.persistence.liferay.service.LFTincanURILocalService;
...
/**
 * Provides the base implementation for the l f tincan u r i local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFTincanURILocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFTincanURILocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFTincanURILocalService,
        IdentifiableBean {
    ...
    private LFTincanURILocalServiceClpInvoker _clpInvoker = new LFTincanURILocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFTincanURILocalServiceUtil} to access the l f tincan u r i local service.
     */
    ...
    @Override
    public LFTincanURI addLFTincanURI(LFTincanURI lfTincanURI)
        throws SystemException {
        lfTincanURI.setNew(true);

        return lfTincanURIPersistence.update(lfTincanURI);
    }
     ...
     */
    @Override
    public LFTincanURI createLFTincanURI(String uri) {
        return lfTincanURIPersistence.create(uri);
    }
    ...
    @Override
    public LFTincanURI deleteLFTincanURI(String uri)
        throws PortalException, SystemException {
        return lfTincanURIPersistence.remove(uri);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LFTincanURI deleteLFTincanURI(LFTincanURI lfTincanURI)
        throws SystemException {
        return lfTincanURIPersistence.remove(lfTincanURI);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LFTincanURI.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfTincanURIPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return lfTincanURIPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfTincanURIPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LFTincanURI fetchLFTincanURI(String uri) throws SystemException {
        return lfTincanURIPersistence.fetchByPrimaryKey(uri);
    }
     ...
     */
    @Override
    public LFTincanURI getLFTincanURI(String uri)
        throws PortalException, SystemException {
        return lfTincanURIPersistence.findByPrimaryKey(uri);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfTincanURIPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LFTincanURI> getLFTincanURIs(int start, int end)
        throws SystemException {
        return lfTincanURIPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLFTincanURIsCount() throws SystemException {
        return lfTincanURIPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LFTincanURI updateLFTincanURI(LFTincanURI lfTincanURI)
        throws SystemException {
        return lfTincanURIPersistence.update(lfTincanURI);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFTincanURI",
            lfTincanURILocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfTincanURIPersistence.getDataSource();
