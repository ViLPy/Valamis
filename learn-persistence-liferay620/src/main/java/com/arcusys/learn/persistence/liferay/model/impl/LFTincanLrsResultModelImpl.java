...
public class LFTincanLrsResultModelImpl extends BaseModelImpl<LFTincanLrsResult>
    ...
    public LFTincanLrsResult toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (LFTincanLrsResult) ProxyUtil.newProxyInstance(_classLoader,
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LFTincanLrsResult)) {
            return false;
        }

        LFTincanLrsResult lfTincanLrsResult = (LFTincanLrsResult) obj;
