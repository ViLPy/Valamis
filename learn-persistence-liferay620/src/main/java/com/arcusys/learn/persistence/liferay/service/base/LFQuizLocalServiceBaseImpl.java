...
/**
 * Provides the base implementation for the l f quiz local service.
 *
 * <p>
...
public abstract class LFQuizLocalServiceBaseImpl extends BaseLocalServiceImpl
    ...
    public LFQuiz addLFQuiz(LFQuiz lfQuiz) throws SystemException {
        ...
        return lfQuizPersistence.update(lfQuiz);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return lfQuizPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }
