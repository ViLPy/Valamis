...
private static final String _FINDER_COLUMN_${finder.name?upper_case}_${finderCol.name?upper_case}_NULL = "${entity.alias}.${finderCol.name} IS NULL";
...
private static final String _FINDER_COLUMN_${finder.name?upper_case}_${finderCol.name?upper_case}_NULL_2${finderFieldSuffix} = "${entity.alias}.${finderCol.name} IS NULL ${finderColConjunction}";
...
<#if finder.hasArrayableOperator()>
    ...
    private static final String _FINDER_COLUMN_${finder.name?upper_case}_${finderCol.name?upper_case}_5_NULL = "(" + _removeConjunction(_FINDER_COLUMN_${finder.name?upper_case}_${finderCol.name?upper_case}_NULL_2) + ")";
