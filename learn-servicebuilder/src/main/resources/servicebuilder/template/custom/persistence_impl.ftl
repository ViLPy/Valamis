...
public class ${entity.name}PersistenceImpl extends BasePersistenceImpl<${entity.name}> implements ${entity.name}Persistence {
	...
	<#list entity.getFinderList() as finder>
		...
		<#list finderColsList as finderCol>
            ...
            private static final String _FINDER_COLUMN_${finder.name?upper_case}_${finderCol.name?upper_case}_NULL_2 = "${entity.alias}.${finderCol.name} IS NULL ${finderColConjunction}";
