...
object SequencingEntityContainer extends MockEntityContainer[LFSequencingLocalService, LFSequencing] {
  ...
  def mockEntityProperties(mockEntity: LFSequencing) {
    ...
    mockBooleanProperty(mockEntity.setOnlyCurrentAttemptAttemptProgressForChildren(_), _.getOnlyCurrentAttemptAttemptProgressForChildren)
    mockBooleanProperty(mockEntity.setOnlyCurrentAttemptObjectiveProgressForChildren(_), _.getOnlyCurrentAttemptObjectiveProgressForChildren)
