...
/**
 * The base implementation of the l f course local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFCourseLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFCourseLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements LFCourseLocalService, IdentifiableBean {
    ...
    private LFCourseLocalServiceClpInvoker _clpInvoker = new LFCourseLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFCourseLocalServiceUtil} to access the l f course local service.
     */
    ...
    public LFCourse addLFCourse(LFCourse lfCourse) throws SystemException {
        lfCourse.setNew(true);

        return lfCoursePersistence.update(lfCourse, false);
    }
     ...
     */
    public LFCourse createLFCourse(long id) {
        return lfCoursePersistence.create(id);
    }
    ...
    public LFCourse deleteLFCourse(long id)
        throws PortalException, SystemException {
        return lfCoursePersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFCourse deleteLFCourse(LFCourse lfCourse) throws SystemException {
        return lfCoursePersistence.remove(lfCourse);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFCourse.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfCoursePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return lfCoursePersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return lfCoursePersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfCoursePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFCourse fetchLFCourse(long id) throws SystemException {
        return lfCoursePersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFCourse getLFCourse(long id)
        throws PortalException, SystemException {
        return lfCoursePersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfCoursePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFCourse> getLFCourses(int start, int end)
        throws SystemException {
        return lfCoursePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFCoursesCount() throws SystemException {
        return lfCoursePersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFCourse updateLFCourse(LFCourse lfCourse) throws SystemException {
        return updateLFCourse(lfCourse, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFCourse updateLFCourse(LFCourse lfCourse, boolean merge)
        throws SystemException {
        lfCourse.setNew(false);

        return lfCoursePersistence.update(lfCourse, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFCourse",
            lfCourseLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfCoursePersistence.getDataSource();
