...
/**
 * The base implementation of the l f question local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFQuestionLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFQuestionLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFQuestionLocalService,
        IdentifiableBean {
    ...
    private LFQuestionLocalServiceClpInvoker _clpInvoker = new LFQuestionLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFQuestionLocalServiceUtil} to access the l f question local service.
     */
    ...
    public LFQuestion addLFQuestion(LFQuestion lfQuestion)
        throws SystemException {
        lfQuestion.setNew(true);

        return lfQuestionPersistence.update(lfQuestion, false);
    }
     ...
     */
    public LFQuestion createLFQuestion(long id) {
        return lfQuestionPersistence.create(id);
    }
    ...
    public LFQuestion deleteLFQuestion(long id)
        throws PortalException, SystemException {
        return lfQuestionPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFQuestion deleteLFQuestion(LFQuestion lfQuestion)
        throws SystemException {
        return lfQuestionPersistence.remove(lfQuestion);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFQuestion.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfQuestionPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return lfQuestionPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfQuestionPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFQuestion fetchLFQuestion(long id) throws SystemException {
        return lfQuestionPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFQuestion getLFQuestion(long id)
        throws PortalException, SystemException {
        return lfQuestionPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfQuestionPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFQuestion> getLFQuestions(int start, int end)
        throws SystemException {
        return lfQuestionPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFQuestionsCount() throws SystemException {
        return lfQuestionPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFQuestion updateLFQuestion(LFQuestion lfQuestion)
        throws SystemException {
        return updateLFQuestion(lfQuestion, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFQuestion updateLFQuestion(LFQuestion lfQuestion, boolean merge)
        throws SystemException {
        lfQuestion.setNew(false);

        return lfQuestionPersistence.update(lfQuestion, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFQuestion",
            lfQuestionLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfQuestionPersistence.getDataSource();
