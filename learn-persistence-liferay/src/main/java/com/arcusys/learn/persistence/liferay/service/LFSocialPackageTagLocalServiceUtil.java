...
/**
 * The utility for the l f social package tag local service. This utility wraps {@link com.arcusys.learn.persistence.liferay.service.impl.LFSocialPackageTagLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class LFSocialPackageTagLocalServiceUtil {
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFSocialPackageTag updateLFSocialPackageTag(
        ...
        boolean merge)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateLFSocialPackageTag(lfSocialPackageTag, merge);
    }
