...
public class LFFileStorageModelImpl extends BaseModelImpl<LFFileStorage>
    ...
    */
    ...
    public static final String TABLE_SQL_CREATE = "create table Learn_LFFileStorage (id_ LONG not null primary key,filename TEXT null,content TEXT null)";
    ...
    private LFFileStorage _escapedModelProxy;
    ...
    public LFFileStorage toEscapedModel() {
        if (_escapedModelProxy == null) {
            _escapedModelProxy = (LFFileStorage) ProxyUtil.newProxyInstance(_classLoader,
    ...
    public boolean equals(Object obj) {
        ...
        LFFileStorage lfFileStorage = null;

        try {
            lfFileStorage = (LFFileStorage) obj;
