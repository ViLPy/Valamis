...
public class LFObjectiveLocalServiceClpInvoker {
    ...
    public LFObjectiveLocalServiceClpInvoker() {
        ...
        _methodName170 = "createLFObjective";

        _methodParameterTypes170 = new String[] {  };

        _methodName171 = "findBySequencingIDAndIsPrimary";

        _methodParameterTypes171 = new String[] { "java.lang.Integer", "boolean" };

        _methodName172 = "findBySequencingIDAndIsPrimaryAndIdentifier";
