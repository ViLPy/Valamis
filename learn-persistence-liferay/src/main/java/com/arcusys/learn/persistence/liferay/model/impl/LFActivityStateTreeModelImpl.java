...
public class LFActivityStateTreeModelImpl extends BaseModelImpl<LFActivityStateTree>
    ...
    public static final String ORDER_BY_JPQL = " ORDER BY lfActivityStateTree.id ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Learn_LFActivityStateTree.id_ ASC";
    ...
    private LFActivityStateTree _escapedModel;
    ...
    public LFActivityStateTree toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (LFActivityStateTree) ProxyUtil.newProxyInstance(_classLoader,
