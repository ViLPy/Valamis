...
/**
 * The base implementation of the l f package scope rule local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFPackageScopeRuleLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFPackageScopeRuleLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFPackageScopeRuleLocalService,
        IdentifiableBean {
    ...
    private LFPackageScopeRuleLocalServiceClpInvoker _clpInvoker = new LFPackageScopeRuleLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFPackageScopeRuleLocalServiceUtil} to access the l f package scope rule local service.
     */
    ...
    public LFPackageScopeRule addLFPackageScopeRule(
        LFPackageScopeRule lfPackageScopeRule) throws SystemException {
        lfPackageScopeRule.setNew(true);

        return lfPackageScopeRulePersistence.update(lfPackageScopeRule, false);
    }
     ...
     */
    public LFPackageScopeRule createLFPackageScopeRule(long id) {
        return lfPackageScopeRulePersistence.create(id);
    }
    ...
    public LFPackageScopeRule deleteLFPackageScopeRule(long id)
        throws PortalException, SystemException {
        return lfPackageScopeRulePersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFPackageScopeRule deleteLFPackageScopeRule(
        LFPackageScopeRule lfPackageScopeRule) throws SystemException {
        return lfPackageScopeRulePersistence.remove(lfPackageScopeRule);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFPackageScopeRule.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfPackageScopeRulePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfPackageScopeRulePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFPackageScopeRule fetchLFPackageScopeRule(long id)
        throws SystemException {
        return lfPackageScopeRulePersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFPackageScopeRule getLFPackageScopeRule(long id)
        throws PortalException, SystemException {
        return lfPackageScopeRulePersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfPackageScopeRulePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFPackageScopeRule> getLFPackageScopeRules(int start, int end)
        throws SystemException {
        return lfPackageScopeRulePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFPackageScopeRulesCount() throws SystemException {
        return lfPackageScopeRulePersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFPackageScopeRule updateLFPackageScopeRule(
        LFPackageScopeRule lfPackageScopeRule) throws SystemException {
        return updateLFPackageScopeRule(lfPackageScopeRule, true);
    }
    ...
    public LFPackageScopeRule updateLFPackageScopeRule(
        ...
        return lfPackageScopeRulePersistence.update(lfPackageScopeRule, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFPackageScopeRule",
            lfPackageScopeRuleLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfPackageScopeRulePersistence.getDataSource();
