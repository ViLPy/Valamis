...
/**
 * The base implementation of the l f objective map local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFObjectiveMapLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFObjectiveMapLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFObjectiveMapLocalService,
        IdentifiableBean {
    ...
    private LFObjectiveMapLocalServiceClpInvoker _clpInvoker = new LFObjectiveMapLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFObjectiveMapLocalServiceUtil} to access the l f objective map local service.
     */
    ...
    public LFObjectiveMap addLFObjectiveMap(LFObjectiveMap lfObjectiveMap)
        throws SystemException {
        lfObjectiveMap.setNew(true);

        return lfObjectiveMapPersistence.update(lfObjectiveMap, false);
    }
     ...
     */
    public LFObjectiveMap createLFObjectiveMap(long id) {
        return lfObjectiveMapPersistence.create(id);
    }
    ...
    public LFObjectiveMap deleteLFObjectiveMap(long id)
        throws PortalException, SystemException {
        return lfObjectiveMapPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFObjectiveMap deleteLFObjectiveMap(LFObjectiveMap lfObjectiveMap)
        throws SystemException {
        return lfObjectiveMapPersistence.remove(lfObjectiveMap);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFObjectiveMap.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfObjectiveMapPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfObjectiveMapPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFObjectiveMap fetchLFObjectiveMap(long id)
        throws SystemException {
        return lfObjectiveMapPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFObjectiveMap getLFObjectiveMap(long id)
        throws PortalException, SystemException {
        return lfObjectiveMapPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfObjectiveMapPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFObjectiveMap> getLFObjectiveMaps(int start, int end)
        throws SystemException {
        return lfObjectiveMapPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFObjectiveMapsCount() throws SystemException {
        return lfObjectiveMapPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFObjectiveMap updateLFObjectiveMap(LFObjectiveMap lfObjectiveMap)
        throws SystemException {
        return updateLFObjectiveMap(lfObjectiveMap, true);
    }
    ...
    public LFObjectiveMap updateLFObjectiveMap(LFObjectiveMap lfObjectiveMap,
        ...
        return lfObjectiveMapPersistence.update(lfObjectiveMap, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFObjectiveMap",
            lfObjectiveMapLocalService);
    }
