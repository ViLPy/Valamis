...
/**
 * The base implementation of the l f activity state node local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFActivityStateNodeLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFActivityStateNodeLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFActivityStateNodeLocalService,
        IdentifiableBean {
    ...
    private LFActivityStateNodeLocalServiceClpInvoker _clpInvoker = new LFActivityStateNodeLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFActivityStateNodeLocalServiceUtil} to access the l f activity state node local service.
     */
    ...
    public LFActivityStateNode addLFActivityStateNode(
        LFActivityStateNode lfActivityStateNode) throws SystemException {
        lfActivityStateNode.setNew(true);

        return lfActivityStateNodePersistence.update(lfActivityStateNode, false);
    }
     ...
     */
    public LFActivityStateNode createLFActivityStateNode(long id) {
        return lfActivityStateNodePersistence.create(id);
    }
    ...
    public LFActivityStateNode deleteLFActivityStateNode(long id)
        throws PortalException, SystemException {
        return lfActivityStateNodePersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFActivityStateNode deleteLFActivityStateNode(
        LFActivityStateNode lfActivityStateNode) throws SystemException {
        return lfActivityStateNodePersistence.remove(lfActivityStateNode);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFActivityStateNode.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfActivityStateNodePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfActivityStateNodePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFActivityStateNode fetchLFActivityStateNode(long id)
        throws SystemException {
        return lfActivityStateNodePersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFActivityStateNode getLFActivityStateNode(long id)
        throws PortalException, SystemException {
        return lfActivityStateNodePersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfActivityStateNodePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFActivityStateNode> getLFActivityStateNodes(int start, int end)
        throws SystemException {
        return lfActivityStateNodePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFActivityStateNodesCount() throws SystemException {
        return lfActivityStateNodePersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFActivityStateNode updateLFActivityStateNode(
        LFActivityStateNode lfActivityStateNode) throws SystemException {
        return updateLFActivityStateNode(lfActivityStateNode, true);
    }
    ...
    public LFActivityStateNode updateLFActivityStateNode(
        ...
        return lfActivityStateNodePersistence.update(lfActivityStateNode, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFActivityStateNode",
            lfActivityStateNodeLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfActivityStateNodePersistence.getDataSource();
