...
/**
 * The base implementation of the l f package local service.
 *
 * <p>
...
public abstract class LFPackageLocalServiceBaseImpl extends BaseLocalServiceImpl
    ...
    public LFPackage addLFPackage(LFPackage lfPackage)
        ...
        return lfPackagePersistence.update(lfPackage, false);
    }
    ...
    public LFPackage updateLFPackage(LFPackage lfPackage)
        throws SystemException {
        return updateLFPackage(lfPackage, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFPackage updateLFPackage(LFPackage lfPackage, boolean merge)
        throws SystemException {
        lfPackage.setNew(false);

        return lfPackagePersistence.update(lfPackage, merge);
    }
