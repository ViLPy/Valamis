...
/**
 * The utility for the l f activity local service. This utility wraps {@link com.arcusys.learn.persistence.liferay.service.impl.LFActivityLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class LFActivityLocalServiceUtil {
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFActivity updateLFActivity(
        ...
        boolean merge)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateLFActivity(lfActivity, merge);
    }
