...
/**
 * The utility for the l f activity state node local service. This utility wraps {@link com.arcusys.learn.persistence.liferay.service.impl.LFActivityStateNodeLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class LFActivityStateNodeLocalServiceUtil {
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFActivityStateNode updateLFActivityStateNode(
        ...
        boolean merge)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateLFActivityStateNode(lfActivityStateNode, merge);
    }
