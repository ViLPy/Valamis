...
/**
 * The base implementation of the l f setting local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFSettingLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFSettingLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements LFSettingLocalService, IdentifiableBean {
    ...
    private LFSettingLocalServiceClpInvoker _clpInvoker = new LFSettingLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFSettingLocalServiceUtil} to access the l f setting local service.
     */
    ...
    public LFSetting addLFSetting(LFSetting lfSetting)
        throws SystemException {
        lfSetting.setNew(true);

        return lfSettingPersistence.update(lfSetting, false);
    }
     ...
     */
    public LFSetting createLFSetting(long id) {
        return lfSettingPersistence.create(id);
    }
    ...
    public LFSetting deleteLFSetting(long id)
        throws PortalException, SystemException {
        return lfSettingPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFSetting deleteLFSetting(LFSetting lfSetting)
        throws SystemException {
        return lfSettingPersistence.remove(lfSetting);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFSetting.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSettingPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return lfSettingPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSettingPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFSetting fetchLFSetting(long id) throws SystemException {
        return lfSettingPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFSetting getLFSetting(long id)
        throws PortalException, SystemException {
        return lfSettingPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfSettingPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFSetting> getLFSettings(int start, int end)
        throws SystemException {
        return lfSettingPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFSettingsCount() throws SystemException {
        return lfSettingPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFSetting updateLFSetting(LFSetting lfSetting)
        throws SystemException {
        return updateLFSetting(lfSetting, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFSetting updateLFSetting(LFSetting lfSetting, boolean merge)
        throws SystemException {
        lfSetting.setNew(false);

        return lfSettingPersistence.update(lfSetting, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFSetting",
            lfSettingLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfSettingPersistence.getDataSource();
