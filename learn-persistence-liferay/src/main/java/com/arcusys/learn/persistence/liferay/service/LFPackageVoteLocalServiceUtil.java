...
/**
 * The utility for the l f package vote local service. This utility wraps {@link com.arcusys.learn.persistence.liferay.service.impl.LFPackageVoteLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class LFPackageVoteLocalServiceUtil {
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFPackageVote updateLFPackageVote(
        ...
        boolean merge)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateLFPackageVote(lfPackageVote, merge);
    }
