...
/**
 * The base implementation of the l f social package local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFSocialPackageLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFSocialPackageLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFSocialPackageLocalService,
        IdentifiableBean {
    ...
    private LFSocialPackageLocalServiceClpInvoker _clpInvoker = new LFSocialPackageLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFSocialPackageLocalServiceUtil} to access the l f social package local service.
     */
    ...
    public LFSocialPackage addLFSocialPackage(LFSocialPackage lfSocialPackage)
        throws SystemException {
        lfSocialPackage.setNew(true);

        return lfSocialPackagePersistence.update(lfSocialPackage, false);
    }
     ...
     */
    public LFSocialPackage createLFSocialPackage(long id) {
        return lfSocialPackagePersistence.create(id);
    }
    ...
    public LFSocialPackage deleteLFSocialPackage(long id)
        throws PortalException, SystemException {
        return lfSocialPackagePersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFSocialPackage deleteLFSocialPackage(
        LFSocialPackage lfSocialPackage) throws SystemException {
        return lfSocialPackagePersistence.remove(lfSocialPackage);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFSocialPackage.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSocialPackagePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSocialPackagePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFSocialPackage fetchLFSocialPackage(long id)
        throws SystemException {
        return lfSocialPackagePersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFSocialPackage getLFSocialPackage(long id)
        throws PortalException, SystemException {
        return lfSocialPackagePersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfSocialPackagePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFSocialPackage> getLFSocialPackages(int start, int end)
        throws SystemException {
        return lfSocialPackagePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFSocialPackagesCount() throws SystemException {
        return lfSocialPackagePersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFSocialPackage updateLFSocialPackage(
        LFSocialPackage lfSocialPackage) throws SystemException {
        return updateLFSocialPackage(lfSocialPackage, true);
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    public LFSocialPackage updateLFSocialPackage(
        LFSocialPackage lfSocialPackage, boolean merge)
        throws SystemException {
        lfSocialPackage.setNew(false);

        return lfSocialPackagePersistence.update(lfSocialPackage, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFSocialPackage",
            lfSocialPackageLocalService);
    }
