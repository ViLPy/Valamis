...
/**
 * The base implementation of the l f package comment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFPackageCommentLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFPackageCommentLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFPackageCommentLocalService,
        IdentifiableBean {
    ...
    private LFPackageCommentLocalServiceClpInvoker _clpInvoker = new LFPackageCommentLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFPackageCommentLocalServiceUtil} to access the l f package comment local service.
     */
    ...
    public LFPackageComment addLFPackageComment(
        LFPackageComment lfPackageComment) throws SystemException {
        lfPackageComment.setNew(true);

        return lfPackageCommentPersistence.update(lfPackageComment, false);
    }
     ...
     */
    public LFPackageComment createLFPackageComment(long id) {
        return lfPackageCommentPersistence.create(id);
    }
    ...
    public LFPackageComment deleteLFPackageComment(long id)
        throws PortalException, SystemException {
        return lfPackageCommentPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFPackageComment deleteLFPackageComment(
        LFPackageComment lfPackageComment) throws SystemException {
        return lfPackageCommentPersistence.remove(lfPackageComment);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFPackageComment.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfPackageCommentPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfPackageCommentPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFPackageComment fetchLFPackageComment(long id)
        throws SystemException {
        return lfPackageCommentPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFPackageComment getLFPackageComment(long id)
        throws PortalException, SystemException {
        return lfPackageCommentPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfPackageCommentPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFPackageComment> getLFPackageComments(int start, int end)
        throws SystemException {
        return lfPackageCommentPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFPackageCommentsCount() throws SystemException {
        return lfPackageCommentPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFPackageComment updateLFPackageComment(
        LFPackageComment lfPackageComment) throws SystemException {
        return updateLFPackageComment(lfPackageComment, true);
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    public LFPackageComment updateLFPackageComment(
        LFPackageComment lfPackageComment, boolean merge)
        throws SystemException {
        lfPackageComment.setNew(false);

        return lfPackageCommentPersistence.update(lfPackageComment, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFPackageComment",
            lfPackageCommentLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfPackageCommentPersistence.getDataSource();
