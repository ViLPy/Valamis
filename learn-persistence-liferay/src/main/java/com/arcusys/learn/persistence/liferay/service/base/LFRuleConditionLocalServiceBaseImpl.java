...
/**
 * The base implementation of the l f rule condition local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFRuleConditionLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFRuleConditionLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFRuleConditionLocalService,
        IdentifiableBean {
    ...
    private LFRuleConditionLocalServiceClpInvoker _clpInvoker = new LFRuleConditionLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFRuleConditionLocalServiceUtil} to access the l f rule condition local service.
     */
    ...
    public LFRuleCondition addLFRuleCondition(LFRuleCondition lfRuleCondition)
        throws SystemException {
        lfRuleCondition.setNew(true);

        return lfRuleConditionPersistence.update(lfRuleCondition, false);
    }
     ...
     */
    public LFRuleCondition createLFRuleCondition(long id) {
        return lfRuleConditionPersistence.create(id);
    }
    ...
    public LFRuleCondition deleteLFRuleCondition(long id)
        throws PortalException, SystemException {
        return lfRuleConditionPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFRuleCondition deleteLFRuleCondition(
        LFRuleCondition lfRuleCondition) throws SystemException {
        return lfRuleConditionPersistence.remove(lfRuleCondition);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFRuleCondition.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfRuleConditionPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfRuleConditionPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFRuleCondition fetchLFRuleCondition(long id)
        throws SystemException {
        return lfRuleConditionPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFRuleCondition getLFRuleCondition(long id)
        throws PortalException, SystemException {
        return lfRuleConditionPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfRuleConditionPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFRuleCondition> getLFRuleConditions(int start, int end)
        throws SystemException {
        return lfRuleConditionPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFRuleConditionsCount() throws SystemException {
        return lfRuleConditionPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFRuleCondition updateLFRuleCondition(
        LFRuleCondition lfRuleCondition) throws SystemException {
        return updateLFRuleCondition(lfRuleCondition, true);
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    public LFRuleCondition updateLFRuleCondition(
        LFRuleCondition lfRuleCondition, boolean merge)
        throws SystemException {
        lfRuleCondition.setNew(false);

        return lfRuleConditionPersistence.update(lfRuleCondition, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFRuleCondition",
            lfRuleConditionLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfRuleConditionPersistence.getDataSource();
