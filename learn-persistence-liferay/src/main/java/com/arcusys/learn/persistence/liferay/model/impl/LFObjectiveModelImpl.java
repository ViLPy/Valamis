...
public class LFObjectiveModelImpl extends BaseModelImpl<LFObjective>
    ...
    */
    ...
    private LFObjective _escapedModelProxy;
    ...
    public LFObjective toEscapedModel() {
        if (_escapedModelProxy == null) {
            _escapedModelProxy = (LFObjective) ProxyUtil.newProxyInstance(_classLoader,
    ...
    public boolean equals(Object obj) {
        ...
        LFObjective lfObjective = null;

        try {
            lfObjective = (LFObjective) obj;
