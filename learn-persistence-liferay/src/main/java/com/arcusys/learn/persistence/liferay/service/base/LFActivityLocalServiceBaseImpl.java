...
/**
 * The base implementation of the l f activity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFActivityLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFActivityLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFActivityLocalService,
        IdentifiableBean {
    ...
    private LFActivityLocalServiceClpInvoker _clpInvoker = new LFActivityLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFActivityLocalServiceUtil} to access the l f activity local service.
     */
    ...
    public LFActivity addLFActivity(LFActivity lfActivity)
        throws SystemException {
        lfActivity.setNew(true);

        return lfActivityPersistence.update(lfActivity, false);
    }
     ...
     */
    public LFActivity createLFActivity(long indexNumber) {
        return lfActivityPersistence.create(indexNumber);
    }
    ...
    public LFActivity deleteLFActivity(long indexNumber)
        throws PortalException, SystemException {
        return lfActivityPersistence.remove(indexNumber);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFActivity deleteLFActivity(LFActivity lfActivity)
        throws SystemException {
        return lfActivityPersistence.remove(lfActivity);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFActivity.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfActivityPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return lfActivityPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfActivityPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFActivity fetchLFActivity(long indexNumber)
        throws SystemException {
        return lfActivityPersistence.fetchByPrimaryKey(indexNumber);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFActivity getLFActivity(long indexNumber)
        throws PortalException, SystemException {
        return lfActivityPersistence.findByPrimaryKey(indexNumber);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfActivityPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFActivity> getLFActivities(int start, int end)
        throws SystemException {
        return lfActivityPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFActivitiesCount() throws SystemException {
        return lfActivityPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFActivity updateLFActivity(LFActivity lfActivity)
        throws SystemException {
        return updateLFActivity(lfActivity, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFActivity updateLFActivity(LFActivity lfActivity, boolean merge)
        throws SystemException {
        lfActivity.setNew(false);

        return lfActivityPersistence.update(lfActivity, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFActivity",
            lfActivityLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfActivityPersistence.getDataSource();
