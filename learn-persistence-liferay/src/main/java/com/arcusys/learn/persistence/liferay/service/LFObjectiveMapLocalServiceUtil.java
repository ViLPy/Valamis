...
/**
 * The utility for the l f objective map local service. This utility wraps {@link com.arcusys.learn.persistence.liferay.service.impl.LFObjectiveMapLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class LFObjectiveMapLocalServiceUtil {
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFObjectiveMap updateLFObjectiveMap(
        ...
        boolean merge)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateLFObjectiveMap(lfObjectiveMap, merge);
    }
