...
/**
 * The utility for the l f objective state local service. This utility wraps {@link com.arcusys.learn.persistence.liferay.service.impl.LFObjectiveStateLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @generated
 */
public class LFObjectiveStateLocalServiceUtil {
    private static LFObjectiveStateLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.arcusys.learn.persistence.liferay.service.impl.LFObjectiveStateLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFObjectiveState addLFObjectiveState(
        com.arcusys.learn.persistence.liferay.model.LFObjectiveState lfObjectiveState)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().addLFObjectiveState(lfObjectiveState);
    }
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFObjectiveState createLFObjectiveState(
        long id) {
        return getService().createLFObjectiveState(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.arcusys.learn.persistence.liferay.model.LFObjectiveState deleteLFObjectiveState(
        long id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteLFObjectiveState(id);
    }
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFObjectiveState deleteLFObjectiveState(
        com.arcusys.learn.persistence.liferay.model.LFObjectiveState lfObjectiveState)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteLFObjectiveState(lfObjectiveState);
    }
    ...
    */
    ...
    public static com.arcusys.learn.persistence.liferay.model.LFObjectiveState fetchLFObjectiveState(
        long id) throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchLFObjectiveState(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.arcusys.learn.persistence.liferay.model.LFObjectiveState getLFObjectiveState(
        long id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getLFObjectiveState(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.arcusys.learn.persistence.liferay.model.LFObjectiveState> getLFObjectiveStates(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getLFObjectiveStates(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getLFObjectiveStatesCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getLFObjectiveStatesCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.arcusys.learn.persistence.liferay.model.LFObjectiveState updateLFObjectiveState(
        com.arcusys.learn.persistence.liferay.model.LFObjectiveState lfObjectiveState)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateLFObjectiveState(lfObjectiveState);
    }
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFObjectiveState updateLFObjectiveState(
        ...
        boolean merge)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateLFObjectiveState(lfObjectiveState, merge);
    }
    ...
    */
    ...
    public static com.arcusys.learn.persistence.liferay.model.LFObjectiveState createLFObjectiveState()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().createLFObjectiveState();
    }
    ...
    public static java.util.List<com.arcusys.learn.persistence.liferay.model.LFObjectiveState> findByActivityStateID(
        ...
        throws com.arcusys.learn.persistence.liferay.NoSuchLFObjectiveException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().findByActivityStateID(activityStateID, start, end);
    }
    ...
    public static LFObjectiveStateLocalService getService() {
        if (_service == null) {
            ...
            if (invokableLocalService instanceof LFObjectiveStateLocalService) {
                ...
                _service = new LFObjectiveStateLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(LFObjectiveStateLocalServiceUtil.class,
                "_service");
        }
     ...
     * @deprecated
     */
    public void setService(LFObjectiveStateLocalService service) {
    }
}
