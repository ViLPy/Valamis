...
public class LFTincanLrsStatementLocalServiceClp
    ...
    public LFTincanLrsStatementLocalServiceClp(
        ...
        _methodName9 = "fetchLFTincanLrsStatement";

        _methodParameterTypes9 = new String[] { "long" };

        _methodName10 = "getLFTincanLrsStatement";
        ...
        _methodName12 = "getLFTincanLrsStatements";

        _methodParameterTypes12 = new String[] { "int", "int" };

        _methodName13 = "getLFTincanLrsStatementsCount";

        _methodParameterTypes13 = new String[] {  };

        _methodName14 = "updateLFTincanLrsStatement";
        ...
        _methodName20 = "createLFTincanLrsStatement";

        _methodParameterTypes20 = new String[] {  };

        _methodName21 = "findByActorID";

        _methodParameterTypes21 = new String[] { "java.lang.Integer" };

        _methodName22 = "findByVerbID";

        _methodParameterTypes22 = new String[] { "java.lang.String" };

        _methodName23 = "findByObjTypeAndObjID";
    ...
    public com.arcusys.learn.persistence.liferay.model.LFTincanLrsStatement addLFTincanLrsStatement(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(lfTincanLrsStatement)
                    });
        } catch (Throwable t) {
    ...
    public java.util.List<com.arcusys.learn.persistence.liferay.model.LFTincanLrsStatement> findByActorID(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName21,
                    ...
                    new Object[] { ClpSerializer.translateInput(actorID) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.arcusys.learn.persistence.liferay.model.LFTincanLrsStatement> findByVerbID(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName22,
                    ...
                    new Object[] { ClpSerializer.translateInput(verbID) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
