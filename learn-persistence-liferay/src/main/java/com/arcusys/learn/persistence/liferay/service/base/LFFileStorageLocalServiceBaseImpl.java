...
/**
 * The base implementation of the l f file storage local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFFileStorageLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFFileStorageLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFFileStorageLocalService,
        IdentifiableBean {
    ...
    private LFFileStorageLocalServiceClpInvoker _clpInvoker = new LFFileStorageLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFFileStorageLocalServiceUtil} to access the l f file storage local service.
     */
    ...
    public LFFileStorage addLFFileStorage(LFFileStorage lfFileStorage)
        throws SystemException {
        lfFileStorage.setNew(true);

        return lfFileStoragePersistence.update(lfFileStorage, false);
    }
     ...
     */
    public LFFileStorage createLFFileStorage(long id) {
        return lfFileStoragePersistence.create(id);
    }
    ...
    public LFFileStorage deleteLFFileStorage(long id)
        throws PortalException, SystemException {
        return lfFileStoragePersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFFileStorage deleteLFFileStorage(LFFileStorage lfFileStorage)
        throws SystemException {
        return lfFileStoragePersistence.remove(lfFileStorage);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFFileStorage.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfFileStoragePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfFileStoragePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFFileStorage fetchLFFileStorage(long id) throws SystemException {
        return lfFileStoragePersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFFileStorage getLFFileStorage(long id)
        throws PortalException, SystemException {
        return lfFileStoragePersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfFileStoragePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFFileStorage> getLFFileStorages(int start, int end)
        throws SystemException {
        return lfFileStoragePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFFileStoragesCount() throws SystemException {
        return lfFileStoragePersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFFileStorage updateLFFileStorage(LFFileStorage lfFileStorage)
        throws SystemException {
        return updateLFFileStorage(lfFileStorage, true);
    }
    ...
    public LFFileStorage updateLFFileStorage(LFFileStorage lfFileStorage,
        ...
        return lfFileStoragePersistence.update(lfFileStorage, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFFileStorage",
            lfFileStorageLocalService);
    }
