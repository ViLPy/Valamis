...
/**
 * The utility for the l f role local service. This utility wraps {@link com.arcusys.learn.persistence.liferay.service.impl.LFRoleLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class LFRoleLocalServiceUtil {
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFRole updateLFRole(
        ...
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateLFRole(lfRole, merge);
    }
