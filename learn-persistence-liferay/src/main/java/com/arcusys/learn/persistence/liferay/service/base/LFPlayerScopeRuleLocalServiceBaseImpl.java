...
/**
 * The base implementation of the l f player scope rule local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFPlayerScopeRuleLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFPlayerScopeRuleLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFPlayerScopeRuleLocalService,
        IdentifiableBean {
    ...
    private LFPlayerScopeRuleLocalServiceClpInvoker _clpInvoker = new LFPlayerScopeRuleLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFPlayerScopeRuleLocalServiceUtil} to access the l f player scope rule local service.
     */
    ...
    public LFPlayerScopeRule addLFPlayerScopeRule(
        LFPlayerScopeRule lfPlayerScopeRule) throws SystemException {
        lfPlayerScopeRule.setNew(true);

        return lfPlayerScopeRulePersistence.update(lfPlayerScopeRule, false);
    }
     ...
     */
    public LFPlayerScopeRule createLFPlayerScopeRule(long id) {
        return lfPlayerScopeRulePersistence.create(id);
    }
    ...
    public LFPlayerScopeRule deleteLFPlayerScopeRule(long id)
        throws PortalException, SystemException {
        return lfPlayerScopeRulePersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFPlayerScopeRule deleteLFPlayerScopeRule(
        LFPlayerScopeRule lfPlayerScopeRule) throws SystemException {
        return lfPlayerScopeRulePersistence.remove(lfPlayerScopeRule);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFPlayerScopeRule.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfPlayerScopeRulePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfPlayerScopeRulePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFPlayerScopeRule fetchLFPlayerScopeRule(long id)
        throws SystemException {
        return lfPlayerScopeRulePersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFPlayerScopeRule getLFPlayerScopeRule(long id)
        throws PortalException, SystemException {
        return lfPlayerScopeRulePersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfPlayerScopeRulePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFPlayerScopeRule> getLFPlayerScopeRules(int start, int end)
        throws SystemException {
        return lfPlayerScopeRulePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFPlayerScopeRulesCount() throws SystemException {
        return lfPlayerScopeRulePersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFPlayerScopeRule updateLFPlayerScopeRule(
        LFPlayerScopeRule lfPlayerScopeRule) throws SystemException {
        return updateLFPlayerScopeRule(lfPlayerScopeRule, true);
    }
    ...
    public LFPlayerScopeRule updateLFPlayerScopeRule(
        ...
        return lfPlayerScopeRulePersistence.update(lfPlayerScopeRule, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFPlayerScopeRule",
            lfPlayerScopeRuleLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfPlayerScopeRulePersistence.getDataSource();
