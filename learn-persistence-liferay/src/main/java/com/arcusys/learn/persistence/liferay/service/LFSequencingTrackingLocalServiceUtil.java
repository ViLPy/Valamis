...
/**
 * The utility for the l f sequencing tracking local service. This utility wraps {@link com.arcusys.learn.persistence.liferay.service.impl.LFSequencingTrackingLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class LFSequencingTrackingLocalServiceUtil {
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFSequencingTracking updateLFSequencingTracking(
        ...
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService()
                   .updateLFSequencingTracking(lfSequencingTracking, merge);
    }
