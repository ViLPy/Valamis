...
/**
 * The base implementation of the l f quiz local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFQuizLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.arcusys.learn.persistence.liferay.service.impl.LFQuizLocalServiceImpl
 * @see com.arcusys.learn.persistence.liferay.service.LFQuizLocalServiceUtil
 * @generated
 */
public abstract class LFQuizLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements LFQuizLocalService, IdentifiableBean {
    ...
    private LFQuizLocalServiceClpInvoker _clpInvoker = new LFQuizLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFQuizLocalServiceUtil} to access the l f quiz local service.
     */
    ...
    public LFQuiz addLFQuiz(LFQuiz lfQuiz) throws SystemException {
        lfQuiz.setNew(true);

        return lfQuizPersistence.update(lfQuiz, false);
    }
     ...
     */
    public LFQuiz createLFQuiz(long id) {
        return lfQuizPersistence.create(id);
    }
    ...
    public LFQuiz deleteLFQuiz(long id) throws PortalException, SystemException {
        return lfQuizPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFQuiz deleteLFQuiz(LFQuiz lfQuiz) throws SystemException {
        return lfQuizPersistence.remove(lfQuiz);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFQuiz.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfQuizPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return lfQuizPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfQuizPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFQuiz fetchLFQuiz(long id) throws SystemException {
        return lfQuizPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFQuiz getLFQuiz(long id) throws PortalException, SystemException {
        return lfQuizPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfQuizPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFQuiz> getLFQuizs(int start, int end)
        throws SystemException {
        return lfQuizPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFQuizsCount() throws SystemException {
        return lfQuizPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFQuiz updateLFQuiz(LFQuiz lfQuiz) throws SystemException {
        return updateLFQuiz(lfQuiz, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFQuiz updateLFQuiz(LFQuiz lfQuiz, boolean merge)
        throws SystemException {
        lfQuiz.setNew(false);

        return lfQuizPersistence.update(lfQuiz, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFQuiz",
            lfQuizLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfQuizPersistence.getDataSource();
