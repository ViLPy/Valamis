...
/**
 * The base implementation of the l f attempt local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFAttemptLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFAttemptLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements LFAttemptLocalService, IdentifiableBean {
    ...
    private LFAttemptLocalServiceClpInvoker _clpInvoker = new LFAttemptLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFAttemptLocalServiceUtil} to access the l f attempt local service.
     */
    ...
    public LFAttempt addLFAttempt(LFAttempt lfAttempt)
        throws SystemException {
        lfAttempt.setNew(true);

        return lfAttemptPersistence.update(lfAttempt, false);
    }
     ...
     */
    public LFAttempt createLFAttempt(long id) {
        return lfAttemptPersistence.create(id);
    }
    ...
    public LFAttempt deleteLFAttempt(long id)
        throws PortalException, SystemException {
        return lfAttemptPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFAttempt deleteLFAttempt(LFAttempt lfAttempt)
        throws SystemException {
        return lfAttemptPersistence.remove(lfAttempt);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFAttempt.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfAttemptPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return lfAttemptPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfAttemptPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFAttempt fetchLFAttempt(long id) throws SystemException {
        return lfAttemptPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFAttempt getLFAttempt(long id)
        throws PortalException, SystemException {
        return lfAttemptPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfAttemptPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFAttempt> getLFAttempts(int start, int end)
        throws SystemException {
        return lfAttemptPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFAttemptsCount() throws SystemException {
        return lfAttemptPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFAttempt updateLFAttempt(LFAttempt lfAttempt)
        throws SystemException {
        return updateLFAttempt(lfAttempt, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFAttempt updateLFAttempt(LFAttempt lfAttempt, boolean merge)
        throws SystemException {
        lfAttempt.setNew(false);

        return lfAttemptPersistence.update(lfAttempt, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFAttempt",
            lfAttemptLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfAttemptPersistence.getDataSource();
