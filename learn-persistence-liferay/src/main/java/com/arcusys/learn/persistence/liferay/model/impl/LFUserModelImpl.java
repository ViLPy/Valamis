...
public class LFUserModelImpl extends BaseModelImpl<LFUser>
    ...
    public static final String ORDER_BY_JPQL = " ORDER BY lfUser.lfid ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Learn_LFUser.lfid ASC";
    ...
    public static long LFID_COLUMN_BITMASK = 2L;
    ...
    private static Class<?>[] _escapedModelInterfaces = new Class[] { LFUser.class };
    private long _lfid;
    private Integer _id;
    ...
    public LFUser toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (LFUser) ProxyUtil.newProxyInstance(_classLoader,
