...
public class LFAttemptLocalServiceClp implements LFAttemptLocalService {
    ...
    public LFAttemptLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName9 = "fetchLFAttempt";

        _methodParameterTypes9 = new String[] { "long" };

        _methodName10 = "getLFAttempt";
        ...
        _methodName12 = "getLFAttempts";

        _methodParameterTypes12 = new String[] { "int", "int" };

        _methodName13 = "getLFAttemptsCount";

        _methodParameterTypes13 = new String[] {  };

        _methodName14 = "updateLFAttempt";
        ...
        _methodName19 = "createLFAttempt";

        _methodParameterTypes19 = new String[] {  };

        _methodName20 = "findByUserIDPackageIDIsComplete";
    ...
    public com.arcusys.learn.persistence.liferay.model.LFAttempt addLFAttempt(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(lfAttempt) });
        } catch (Throwable t) {
        ...
        return (com.arcusys.learn.persistence.liferay.model.LFAttempt) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.arcusys.learn.persistence.liferay.model.LFAttempt> getLFAttempts(
        ...
        return (java.util.List<com.arcusys.learn.persistence.liferay.model.LFAttempt>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.arcusys.learn.persistence.liferay.model.LFAttempt updateLFAttempt(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName15,
                    ...
                    new Object[] { ClpSerializer.translateInput(lfAttempt), merge });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.arcusys.learn.persistence.liferay.model.LFAttempt> findByUserIDPackageIDIsComplete(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName20,
                    ...
                    ClpSerializer.translateInput(isComplete)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
