...
public class LFTincanLrsDocumentLocalServiceClpInvoker {
    ...
    public LFTincanLrsDocumentLocalServiceClpInvoker() {
        ...
        _methodName270 = "createLFTincanLrsDocument";

        _methodParameterTypes270 = new String[] {  };

        _methodName271 = "createLFTincanLrsDocument";
        ...
        _methodName272 = "deleteLFTincanLrsDocument";

        _methodParameterTypes272 = new String[] { "java.lang.String" };

        _methodName273 = "findByDocumentId";
