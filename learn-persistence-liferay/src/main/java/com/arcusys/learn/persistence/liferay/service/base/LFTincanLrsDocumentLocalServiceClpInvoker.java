...
public class LFTincanLrsDocumentLocalServiceClpInvoker {
    ...
    public LFTincanLrsDocumentLocalServiceClpInvoker() {
        ...
        _methodName282 = "createLFTincanLrsDocument";

        _methodParameterTypes282 = new String[] {  };

        _methodName283 = "createLFTincanLrsDocument";
        ...
        _methodName284 = "deleteLFTincanLrsDocument";

        _methodParameterTypes284 = new String[] { "java.lang.String" };

        _methodName285 = "findByDocumentId";
