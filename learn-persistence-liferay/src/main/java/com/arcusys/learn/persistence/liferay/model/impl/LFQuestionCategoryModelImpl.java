...
public class LFQuestionCategoryModelImpl extends BaseModelImpl<LFQuestionCategory>
    ...
    public static final String ORDER_BY_JPQL = " ORDER BY lfQuestionCategory.id ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Learn_LFQuestionCategory.id_ ASC";
    ...
    private LFQuestionCategory _escapedModel;
    ...
    public LFQuestionCategory toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (LFQuestionCategory) ProxyUtil.newProxyInstance(_classLoader,
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LFQuestionCategory)) {
            return false;
        }

        LFQuestionCategory lfQuestionCategory = (LFQuestionCategory) obj;
