...
/**
 * The base implementation of the l f children selection local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFChildrenSelectionLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFChildrenSelectionLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFChildrenSelectionLocalService,
        IdentifiableBean {
    ...
    private LFChildrenSelectionLocalServiceClpInvoker _clpInvoker = new LFChildrenSelectionLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFChildrenSelectionLocalServiceUtil} to access the l f children selection local service.
     */
    ...
    public LFChildrenSelection addLFChildrenSelection(
        LFChildrenSelection lfChildrenSelection) throws SystemException {
        lfChildrenSelection.setNew(true);

        return lfChildrenSelectionPersistence.update(lfChildrenSelection, false);
    }
     ...
     */
    public LFChildrenSelection createLFChildrenSelection(long id) {
        return lfChildrenSelectionPersistence.create(id);
    }
    ...
    public LFChildrenSelection deleteLFChildrenSelection(long id)
        throws PortalException, SystemException {
        return lfChildrenSelectionPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFChildrenSelection deleteLFChildrenSelection(
        LFChildrenSelection lfChildrenSelection) throws SystemException {
        return lfChildrenSelectionPersistence.remove(lfChildrenSelection);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFChildrenSelection.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfChildrenSelectionPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfChildrenSelectionPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFChildrenSelection fetchLFChildrenSelection(long id)
        throws SystemException {
        return lfChildrenSelectionPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFChildrenSelection getLFChildrenSelection(long id)
        throws PortalException, SystemException {
        return lfChildrenSelectionPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfChildrenSelectionPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFChildrenSelection> getLFChildrenSelections(int start, int end)
        throws SystemException {
        return lfChildrenSelectionPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFChildrenSelectionsCount() throws SystemException {
        return lfChildrenSelectionPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFChildrenSelection updateLFChildrenSelection(
        LFChildrenSelection lfChildrenSelection) throws SystemException {
        return updateLFChildrenSelection(lfChildrenSelection, true);
    }
    ...
    public LFChildrenSelection updateLFChildrenSelection(
        ...
        return lfChildrenSelectionPersistence.update(lfChildrenSelection, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFChildrenSelection",
            lfChildrenSelectionLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfChildrenSelectionPersistence.getDataSource();
