...
/**
 * The base implementation of the l f tincan lrs endpoint local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFTincanLrsEndpointLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFTincanLrsEndpointLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFTincanLrsEndpointLocalService,
        IdentifiableBean {
    ...
    private LFTincanLrsEndpointLocalServiceClpInvoker _clpInvoker = new LFTincanLrsEndpointLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFTincanLrsEndpointLocalServiceUtil} to access the l f tincan lrs endpoint local service.
     */
    ...
    public LFTincanLrsEndpoint addLFTincanLrsEndpoint(
        LFTincanLrsEndpoint lfTincanLrsEndpoint) throws SystemException {
        lfTincanLrsEndpoint.setNew(true);

        return lfTincanLrsEndpointPersistence.update(lfTincanLrsEndpoint, false);
    }
     ...
     */
    public LFTincanLrsEndpoint createLFTincanLrsEndpoint(long id) {
        return lfTincanLrsEndpointPersistence.create(id);
    }
    ...
    public LFTincanLrsEndpoint deleteLFTincanLrsEndpoint(long id)
        throws PortalException, SystemException {
        return lfTincanLrsEndpointPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFTincanLrsEndpoint deleteLFTincanLrsEndpoint(
        LFTincanLrsEndpoint lfTincanLrsEndpoint) throws SystemException {
        return lfTincanLrsEndpointPersistence.remove(lfTincanLrsEndpoint);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFTincanLrsEndpoint.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfTincanLrsEndpointPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfTincanLrsEndpointPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFTincanLrsEndpoint fetchLFTincanLrsEndpoint(long id)
        throws SystemException {
        return lfTincanLrsEndpointPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFTincanLrsEndpoint getLFTincanLrsEndpoint(long id)
        throws PortalException, SystemException {
        return lfTincanLrsEndpointPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfTincanLrsEndpointPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFTincanLrsEndpoint> getLFTincanLrsEndpoints(int start, int end)
        throws SystemException {
        return lfTincanLrsEndpointPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFTincanLrsEndpointsCount() throws SystemException {
        return lfTincanLrsEndpointPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFTincanLrsEndpoint updateLFTincanLrsEndpoint(
        LFTincanLrsEndpoint lfTincanLrsEndpoint) throws SystemException {
        return updateLFTincanLrsEndpoint(lfTincanLrsEndpoint, true);
    }
    ...
    public LFTincanLrsEndpoint updateLFTincanLrsEndpoint(
        ...
        return lfTincanLrsEndpointPersistence.update(lfTincanLrsEndpoint, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFTincanLrsEndpoint",
            lfTincanLrsEndpointLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfTincanLrsEndpointPersistence.getDataSource();
