...
/**
 * The base implementation of the l f quiz question category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFQuizQuestionCategoryLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFQuizQuestionCategoryLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFQuizQuestionCategoryLocalService,
        IdentifiableBean {
    ...
    private LFQuizQuestionCategoryLocalServiceClpInvoker _clpInvoker = new LFQuizQuestionCategoryLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFQuizQuestionCategoryLocalServiceUtil} to access the l f quiz question category local service.
     */
    ...
    public LFQuizQuestionCategory addLFQuizQuestionCategory(
        LFQuizQuestionCategory lfQuizQuestionCategory)
        throws SystemException {
        lfQuizQuestionCategory.setNew(true);

        return lfQuizQuestionCategoryPersistence.update(lfQuizQuestionCategory,
            false);
    }
     ...
     */
    public LFQuizQuestionCategory createLFQuizQuestionCategory(long id) {
        return lfQuizQuestionCategoryPersistence.create(id);
    }
    ...
    public LFQuizQuestionCategory deleteLFQuizQuestionCategory(long id)
        throws PortalException, SystemException {
        return lfQuizQuestionCategoryPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFQuizQuestionCategory deleteLFQuizQuestionCategory(
        LFQuizQuestionCategory lfQuizQuestionCategory)
        throws SystemException {
        return lfQuizQuestionCategoryPersistence.remove(lfQuizQuestionCategory);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFQuizQuestionCategory.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfQuizQuestionCategoryPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfQuizQuestionCategoryPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFQuizQuestionCategory fetchLFQuizQuestionCategory(long id)
        throws SystemException {
        return lfQuizQuestionCategoryPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFQuizQuestionCategory getLFQuizQuestionCategory(long id)
        throws PortalException, SystemException {
        return lfQuizQuestionCategoryPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfQuizQuestionCategoryPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFQuizQuestionCategory> getLFQuizQuestionCategories(int start,
        int end) throws SystemException {
        return lfQuizQuestionCategoryPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFQuizQuestionCategoriesCount() throws SystemException {
        return lfQuizQuestionCategoryPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFQuizQuestionCategory updateLFQuizQuestionCategory(
        LFQuizQuestionCategory lfQuizQuestionCategory)
        throws SystemException {
        return updateLFQuizQuestionCategory(lfQuizQuestionCategory, true);
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    public LFQuizQuestionCategory updateLFQuizQuestionCategory(
        LFQuizQuestionCategory lfQuizQuestionCategory, boolean merge)
        throws SystemException {
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFQuizQuestionCategory",
            lfQuizQuestionCategoryLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfQuizQuestionCategoryPersistence.getDataSource();
