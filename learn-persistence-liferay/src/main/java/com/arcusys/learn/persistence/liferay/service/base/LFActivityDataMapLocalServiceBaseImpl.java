...
/**
 * The base implementation of the l f activity data map local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFActivityDataMapLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFActivityDataMapLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFActivityDataMapLocalService,
        IdentifiableBean {
    ...
    private LFActivityDataMapLocalServiceClpInvoker _clpInvoker = new LFActivityDataMapLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFActivityDataMapLocalServiceUtil} to access the l f activity data map local service.
     */
    ...
    public LFActivityDataMap addLFActivityDataMap(
        LFActivityDataMap lfActivityDataMap) throws SystemException {
        lfActivityDataMap.setNew(true);

        return lfActivityDataMapPersistence.update(lfActivityDataMap, false);
    }
     ...
     */
    public LFActivityDataMap createLFActivityDataMap(long id) {
        return lfActivityDataMapPersistence.create(id);
    }
    ...
    public LFActivityDataMap deleteLFActivityDataMap(long id)
        throws PortalException, SystemException {
        return lfActivityDataMapPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFActivityDataMap deleteLFActivityDataMap(
        LFActivityDataMap lfActivityDataMap) throws SystemException {
        return lfActivityDataMapPersistence.remove(lfActivityDataMap);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFActivityDataMap.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfActivityDataMapPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfActivityDataMapPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFActivityDataMap fetchLFActivityDataMap(long id)
        throws SystemException {
        return lfActivityDataMapPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFActivityDataMap getLFActivityDataMap(long id)
        throws PortalException, SystemException {
        return lfActivityDataMapPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfActivityDataMapPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFActivityDataMap> getLFActivityDataMaps(int start, int end)
        throws SystemException {
        return lfActivityDataMapPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFActivityDataMapsCount() throws SystemException {
        return lfActivityDataMapPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFActivityDataMap updateLFActivityDataMap(
        LFActivityDataMap lfActivityDataMap) throws SystemException {
        return updateLFActivityDataMap(lfActivityDataMap, true);
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    public LFActivityDataMap updateLFActivityDataMap(
        LFActivityDataMap lfActivityDataMap, boolean merge)
        throws SystemException {
        lfActivityDataMap.setNew(false);

        return lfActivityDataMapPersistence.update(lfActivityDataMap, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFActivityDataMap",
            lfActivityDataMapLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfActivityDataMapPersistence.getDataSource();
