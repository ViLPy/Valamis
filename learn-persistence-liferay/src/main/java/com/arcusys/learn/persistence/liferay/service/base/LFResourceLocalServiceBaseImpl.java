...
/**
 * The base implementation of the l f resource local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFResourceLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFResourceLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFResourceLocalService,
        IdentifiableBean {
    ...
    private LFResourceLocalServiceClpInvoker _clpInvoker = new LFResourceLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFResourceLocalServiceUtil} to access the l f resource local service.
     */
    ...
    public LFResource addLFResource(LFResource lfResource)
        throws SystemException {
        lfResource.setNew(true);

        return lfResourcePersistence.update(lfResource, false);
    }
     ...
     */
    public LFResource createLFResource(long id) {
        return lfResourcePersistence.create(id);
    }
    ...
    public LFResource deleteLFResource(long id)
        throws PortalException, SystemException {
        return lfResourcePersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFResource deleteLFResource(LFResource lfResource)
        throws SystemException {
        return lfResourcePersistence.remove(lfResource);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFResource.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfResourcePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return lfResourcePersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfResourcePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFResource fetchLFResource(long id) throws SystemException {
        return lfResourcePersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFResource getLFResource(long id)
        throws PortalException, SystemException {
        return lfResourcePersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfResourcePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFResource> getLFResources(int start, int end)
        throws SystemException {
        return lfResourcePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFResourcesCount() throws SystemException {
        return lfResourcePersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFResource updateLFResource(LFResource lfResource)
        throws SystemException {
        return updateLFResource(lfResource, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFResource updateLFResource(LFResource lfResource, boolean merge)
        throws SystemException {
        lfResource.setNew(false);

        return lfResourcePersistence.update(lfResource, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFResource",
            lfResourceLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfResourcePersistence.getDataSource();
