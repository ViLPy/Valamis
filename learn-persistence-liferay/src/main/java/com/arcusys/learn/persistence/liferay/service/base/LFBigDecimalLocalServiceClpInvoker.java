...
public class LFBigDecimalLocalServiceClpInvoker {
    ...
    public LFBigDecimalLocalServiceClpInvoker() {
        ...
        _methodName1 = "createLFBigDecimal";

        _methodParameterTypes1 = new String[] { "long" };

        _methodName2 = "deleteLFBigDecimal";

        _methodParameterTypes2 = new String[] { "long" };

        _methodName3 = "deleteLFBigDecimal";
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return LFBigDecimalLocalServiceUtil.addLFBigDecimal((com.arcusys.learn.persistence.liferay.model.LFBigDecimal) arguments[0]);
        }

        if (_methodName1.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes1, parameterTypes)) {
            return LFBigDecimalLocalServiceUtil.createLFBigDecimal(((Long) arguments[0]).longValue());
        }

        if (_methodName2.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes2, parameterTypes)) {
            return LFBigDecimalLocalServiceUtil.deleteLFBigDecimal(((Long) arguments[0]).longValue());
        }

        if (_methodName3.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes3, parameterTypes)) {
            return LFBigDecimalLocalServiceUtil.deleteLFBigDecimal((com.arcusys.learn.persistence.liferay.model.LFBigDecimal) arguments[0]);
        }

        if (_methodName4.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes4, parameterTypes)) {
            return LFBigDecimalLocalServiceUtil.dynamicQuery();
        }

        if (_methodName5.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes5, parameterTypes)) {
            return LFBigDecimalLocalServiceUtil.dynamicQuery((com.liferay.portal.kernel.dao.orm.DynamicQuery) arguments[0]);
        }
