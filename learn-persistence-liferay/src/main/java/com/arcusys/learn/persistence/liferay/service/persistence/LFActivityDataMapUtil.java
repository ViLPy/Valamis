...
public class LFActivityDataMapUtil {
    ...
    public static LFActivityDataMap update(
        ...
        throws SystemException {
        return getPersistence().update(lfActivityDataMap, merge);
    }
    ...
    public static LFActivityDataMap update(
        ...
        return getPersistence().update(lfActivityDataMap, merge, serviceContext);
    }
    ...
    */
    ...
    public static com.arcusys.learn.persistence.liferay.model.LFActivityDataMap updateImpl(
        ...
        return getPersistence().updateImpl(lfActivityDataMap, merge);
    }
