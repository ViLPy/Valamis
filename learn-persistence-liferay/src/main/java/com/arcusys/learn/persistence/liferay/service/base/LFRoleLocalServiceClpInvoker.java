...
public class LFRoleLocalServiceClpInvoker {
    ...
    public LFRoleLocalServiceClpInvoker() {
        ...
        _methodName1 = "createLFRole";

        _methodParameterTypes1 = new String[] { "long" };

        _methodName2 = "deleteLFRole";

        _methodParameterTypes2 = new String[] { "long" };

        _methodName3 = "deleteLFRole";
        ...
        _methodName270 = "createLFRole";

        _methodParameterTypes270 = new String[] {  };

        _methodName271 = "findByPermission";

        _methodParameterTypes271 = new String[] { "java.lang.String" };

        _methodName272 = "findByRoleIDAndPermission";

        _methodParameterTypes272 = new String[] {
                "java.lang.Integer", "java.lang.String"
            };

        _methodName273 = "findByDefaultAndPermission";

        _methodParameterTypes273 = new String[] {
                "java.lang.String", "java.lang.Boolean"
            };

        _methodName274 = "removeByRoleIDAndPermission";
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return LFRoleLocalServiceUtil.addLFRole((com.arcusys.learn.persistence.liferay.model.LFRole) arguments[0]);
        }

        if (_methodName1.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes1, parameterTypes)) {
            return LFRoleLocalServiceUtil.createLFRole(((Long) arguments[0]).longValue());
        }

        if (_methodName2.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes2, parameterTypes)) {
            return LFRoleLocalServiceUtil.deleteLFRole(((Long) arguments[0]).longValue());
        }

        if (_methodName3.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes3, parameterTypes)) {
            return LFRoleLocalServiceUtil.deleteLFRole((com.arcusys.learn.persistence.liferay.model.LFRole) arguments[0]);
        }

        if (_methodName4.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes4, parameterTypes)) {
            return LFRoleLocalServiceUtil.dynamicQuery();
        }

        if (_methodName5.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes5, parameterTypes)) {
            return LFRoleLocalServiceUtil.dynamicQuery((com.liferay.portal.kernel.dao.orm.DynamicQuery) arguments[0]);
        }
        ...
        if (_methodName8.equals(name) &&
            ...
            return LFRoleLocalServiceUtil.dynamicQueryCount((com.liferay.portal.kernel.dao.orm.DynamicQuery) arguments[0]);
        }

        if (_methodName9.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes9, parameterTypes)) {
            return LFRoleLocalServiceUtil.fetchLFRole(((Long) arguments[0]).longValue());
        }

        if (_methodName10.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes10, parameterTypes)) {
            return LFRoleLocalServiceUtil.getLFRole(((Long) arguments[0]).longValue());
        }

        if (_methodName11.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes11, parameterTypes)) {
            return LFRoleLocalServiceUtil.getPersistedModel((java.io.Serializable) arguments[0]);
        }

        if (_methodName12.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes12, parameterTypes)) {
            return LFRoleLocalServiceUtil.getLFRoles(((Integer) arguments[0]).intValue(),
                ((Integer) arguments[1]).intValue());
        }

        if (_methodName13.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes13, parameterTypes)) {
            return LFRoleLocalServiceUtil.getLFRolesCount();
        }
