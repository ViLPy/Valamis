...
/**
 * The base implementation of the l f answer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFAnswerLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFAnswerLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements LFAnswerLocalService, IdentifiableBean {
    ...
    private LFAnswerLocalServiceClpInvoker _clpInvoker = new LFAnswerLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFAnswerLocalServiceUtil} to access the l f answer local service.
     */
    ...
    public LFAnswer addLFAnswer(LFAnswer lfAnswer) throws SystemException {
        lfAnswer.setNew(true);

        return lfAnswerPersistence.update(lfAnswer, false);
    }
     ...
     */
    public LFAnswer createLFAnswer(long id) {
        return lfAnswerPersistence.create(id);
    }
    ...
    public LFAnswer deleteLFAnswer(long id)
        throws PortalException, SystemException {
        return lfAnswerPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFAnswer deleteLFAnswer(LFAnswer lfAnswer) throws SystemException {
        return lfAnswerPersistence.remove(lfAnswer);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFAnswer.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfAnswerPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return lfAnswerPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return lfAnswerPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfAnswerPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFAnswer fetchLFAnswer(long id) throws SystemException {
        return lfAnswerPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFAnswer getLFAnswer(long id)
        throws PortalException, SystemException {
        return lfAnswerPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfAnswerPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFAnswer> getLFAnswers(int start, int end)
        throws SystemException {
        return lfAnswerPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFAnswersCount() throws SystemException {
        return lfAnswerPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFAnswer updateLFAnswer(LFAnswer lfAnswer) throws SystemException {
        return updateLFAnswer(lfAnswer, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFAnswer updateLFAnswer(LFAnswer lfAnswer, boolean merge)
        throws SystemException {
        lfAnswer.setNew(false);

        return lfAnswerPersistence.update(lfAnswer, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFAnswer",
            lfAnswerLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfAnswerPersistence.getDataSource();
