...
import com.arcusys.learn.persistence.liferay.service.LFSettingsLocalService;
...
/**
 * The base implementation of the l f settings local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFSettingsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.arcusys.learn.persistence.liferay.service.impl.LFSettingsLocalServiceImpl
 * @see com.arcusys.learn.persistence.liferay.service.LFSettingsLocalServiceUtil
 * @generated
 */
public abstract class LFSettingsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFSettingsLocalService,
        IdentifiableBean {
    ...
    @BeanReference(type = LFSettingsLocalService.class)
    protected LFSettingsLocalService lfSettingsLocalService;
    ...
    private LFSettingsLocalServiceClpInvoker _clpInvoker = new LFSettingsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFSettingsLocalServiceUtil} to access the l f settings local service.
     */
    ...
    public LFSettings addLFSettings(LFSettings lfSettings)
        throws SystemException {
        lfSettings.setNew(true);

        return lfSettingsPersistence.update(lfSettings, false);
    }
     ...
     */
    public LFSettings createLFSettings(long id) {
        return lfSettingsPersistence.create(id);
    }
    ...
    public LFSettings deleteLFSettings(long id)
        throws PortalException, SystemException {
        return lfSettingsPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFSettings deleteLFSettings(LFSettings lfSettings)
        throws SystemException {
        return lfSettingsPersistence.remove(lfSettings);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFSettings.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSettingsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return lfSettingsPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSettingsPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFSettings fetchLFSettings(long id) throws SystemException {
        return lfSettingsPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFSettings getLFSettings(long id)
        throws PortalException, SystemException {
        return lfSettingsPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfSettingsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFSettings> getLFSettingses(int start, int end)
        throws SystemException {
        return lfSettingsPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFSettingsesCount() throws SystemException {
        return lfSettingsPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFSettings updateLFSettings(LFSettings lfSettings)
        throws SystemException {
        return updateLFSettings(lfSettings, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFSettings updateLFSettings(LFSettings lfSettings, boolean merge)
        throws SystemException {
        lfSettings.setNew(false);

        return lfSettingsPersistence.update(lfSettings, merge);
    }
    ...
    /**
     * Returns the l f settings local service.
     *
     * @return the l f settings local service
     */
    public LFSettingsLocalService getLFSettingsLocalService() {
        return lfSettingsLocalService;
    }

    /**
     * Sets the l f settings local service.
     *
     * @param lfSettingsLocalService the l f settings local service
     */
    public void setLFSettingsLocalService(
        LFSettingsLocalService lfSettingsLocalService) {
        this.lfSettingsLocalService = lfSettingsLocalService;
    }

    /**
     * Returns the l f settings persistence.
     *
     * @return the l f settings persistence
     */
    public LFSettingsPersistence getLFSettingsPersistence() {
        return lfSettingsPersistence;
    }

    /**
     * Sets the l f settings persistence.
     *
     * @param lfSettingsPersistence the l f settings persistence
     */
    public void setLFSettingsPersistence(
        LFSettingsPersistence lfSettingsPersistence) {
        this.lfSettingsPersistence = lfSettingsPersistence;
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFSettings",
            lfSettingsLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfSettingsPersistence.getDataSource();
