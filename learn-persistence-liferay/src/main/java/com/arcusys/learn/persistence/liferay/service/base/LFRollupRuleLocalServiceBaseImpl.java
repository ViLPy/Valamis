...
/**
 * The base implementation of the l f rollup rule local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFRollupRuleLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFRollupRuleLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFRollupRuleLocalService,
        IdentifiableBean {
    ...
    private LFRollupRuleLocalServiceClpInvoker _clpInvoker = new LFRollupRuleLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFRollupRuleLocalServiceUtil} to access the l f rollup rule local service.
     */
    ...
    public LFRollupRule addLFRollupRule(LFRollupRule lfRollupRule)
        throws SystemException {
        lfRollupRule.setNew(true);

        return lfRollupRulePersistence.update(lfRollupRule, false);
    }
     ...
     */
    public LFRollupRule createLFRollupRule(long id) {
        return lfRollupRulePersistence.create(id);
    }
    ...
    public LFRollupRule deleteLFRollupRule(long id)
        throws PortalException, SystemException {
        return lfRollupRulePersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFRollupRule deleteLFRollupRule(LFRollupRule lfRollupRule)
        throws SystemException {
        return lfRollupRulePersistence.remove(lfRollupRule);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFRollupRule.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfRollupRulePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfRollupRulePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFRollupRule fetchLFRollupRule(long id) throws SystemException {
        return lfRollupRulePersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFRollupRule getLFRollupRule(long id)
        throws PortalException, SystemException {
        return lfRollupRulePersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfRollupRulePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFRollupRule> getLFRollupRules(int start, int end)
        throws SystemException {
        return lfRollupRulePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFRollupRulesCount() throws SystemException {
        return lfRollupRulePersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFRollupRule updateLFRollupRule(LFRollupRule lfRollupRule)
        throws SystemException {
        return updateLFRollupRule(lfRollupRule, true);
    }
    ...
    public LFRollupRule updateLFRollupRule(LFRollupRule lfRollupRule,
        ...
        return lfRollupRulePersistence.update(lfRollupRule, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFRollupRule",
            lfRollupRuleLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfRollupRulePersistence.getDataSource();
