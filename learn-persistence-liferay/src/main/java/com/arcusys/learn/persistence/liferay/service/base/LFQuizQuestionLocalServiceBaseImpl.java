...
/**
 * The base implementation of the l f quiz question local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFQuizQuestionLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFQuizQuestionLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFQuizQuestionLocalService,
        IdentifiableBean {
    ...
    private LFQuizQuestionLocalServiceClpInvoker _clpInvoker = new LFQuizQuestionLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFQuizQuestionLocalServiceUtil} to access the l f quiz question local service.
     */
    ...
    public LFQuizQuestion addLFQuizQuestion(LFQuizQuestion lfQuizQuestion)
        throws SystemException {
        lfQuizQuestion.setNew(true);

        return lfQuizQuestionPersistence.update(lfQuizQuestion, false);
    }
     ...
     */
    public LFQuizQuestion createLFQuizQuestion(long id) {
        return lfQuizQuestionPersistence.create(id);
    }
    ...
    public LFQuizQuestion deleteLFQuizQuestion(long id)
        throws PortalException, SystemException {
        return lfQuizQuestionPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFQuizQuestion deleteLFQuizQuestion(LFQuizQuestion lfQuizQuestion)
        throws SystemException {
        return lfQuizQuestionPersistence.remove(lfQuizQuestion);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFQuizQuestion.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfQuizQuestionPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfQuizQuestionPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFQuizQuestion fetchLFQuizQuestion(long id)
        throws SystemException {
        return lfQuizQuestionPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFQuizQuestion getLFQuizQuestion(long id)
        throws PortalException, SystemException {
        return lfQuizQuestionPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfQuizQuestionPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFQuizQuestion> getLFQuizQuestions(int start, int end)
        throws SystemException {
        return lfQuizQuestionPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFQuizQuestionsCount() throws SystemException {
        return lfQuizQuestionPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFQuizQuestion updateLFQuizQuestion(LFQuizQuestion lfQuizQuestion)
        throws SystemException {
        return updateLFQuizQuestion(lfQuizQuestion, true);
    }
    ...
    public LFQuizQuestion updateLFQuizQuestion(LFQuizQuestion lfQuizQuestion,
        ...
        return lfQuizQuestionPersistence.update(lfQuizQuestion, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFQuizQuestion",
            lfQuizQuestionLocalService);
    }
