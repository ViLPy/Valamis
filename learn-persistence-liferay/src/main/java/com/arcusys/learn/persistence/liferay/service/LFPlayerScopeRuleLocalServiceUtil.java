...
/**
 * The utility for the l f player scope rule local service. This utility wraps {@link com.arcusys.learn.persistence.liferay.service.impl.LFPlayerScopeRuleLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class LFPlayerScopeRuleLocalServiceUtil {
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFPlayerScopeRule updateLFPlayerScopeRule(
        ...
        boolean merge)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateLFPlayerScopeRule(lfPlayerScopeRule, merge);
    }
