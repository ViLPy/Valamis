...
/**
 * The utility for the l f attempt data local service. This utility wraps {@link com.arcusys.learn.persistence.liferay.service.impl.LFAttemptDataLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class LFAttemptDataLocalServiceUtil {
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFAttemptData updateLFAttemptData(
        ...
        boolean merge)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateLFAttemptData(lfAttemptData, merge);
    }
