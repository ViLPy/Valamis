...
/**
 * The base implementation of the l f sequencing local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFSequencingLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFSequencingLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFSequencingLocalService,
        IdentifiableBean {
    ...
    private LFSequencingLocalServiceClpInvoker _clpInvoker = new LFSequencingLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFSequencingLocalServiceUtil} to access the l f sequencing local service.
     */
    ...
    public LFSequencing addLFSequencing(LFSequencing lfSequencing)
        throws SystemException {
        lfSequencing.setNew(true);

        return lfSequencingPersistence.update(lfSequencing, false);
    }
     ...
     */
    public LFSequencing createLFSequencing(long id) {
        return lfSequencingPersistence.create(id);
    }
    ...
    public LFSequencing deleteLFSequencing(long id)
        throws PortalException, SystemException {
        return lfSequencingPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFSequencing deleteLFSequencing(LFSequencing lfSequencing)
        throws SystemException {
        return lfSequencingPersistence.remove(lfSequencing);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFSequencing.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSequencingPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSequencingPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFSequencing fetchLFSequencing(long id) throws SystemException {
        return lfSequencingPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFSequencing getLFSequencing(long id)
        throws PortalException, SystemException {
        return lfSequencingPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfSequencingPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFSequencing> getLFSequencings(int start, int end)
        throws SystemException {
        return lfSequencingPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFSequencingsCount() throws SystemException {
        return lfSequencingPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFSequencing updateLFSequencing(LFSequencing lfSequencing)
        throws SystemException {
        return updateLFSequencing(lfSequencing, true);
    }
    ...
    public LFSequencing updateLFSequencing(LFSequencing lfSequencing,
        ...
        return lfSequencingPersistence.update(lfSequencing, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFSequencing",
            lfSequencingLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.arcusys.learn.persistence.liferay.model.LFSequencing");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfSequencingPersistence.getDataSource();
