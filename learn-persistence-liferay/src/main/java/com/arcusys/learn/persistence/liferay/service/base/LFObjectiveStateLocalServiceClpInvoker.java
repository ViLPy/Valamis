...
public class LFObjectiveStateLocalServiceClpInvoker {
    ...
    public LFObjectiveStateLocalServiceClpInvoker() {
        ...
        _methodName282 = "createLFObjectiveState";

        _methodParameterTypes282 = new String[] {  };

        _methodName283 = "findByMapKeyAndActivityStateID";

        _methodParameterTypes283 = new String[] {
                "java.lang.String", "java.lang.Integer"
            };

        _methodName284 = "findByActivityStateID";
        ...
        _methodName286 = "getLFObjectiveState";
