...
public class LFObjectiveStateLocalServiceClpInvoker {
    ...
    public LFObjectiveStateLocalServiceClpInvoker() {
        ...
        _methodName218 = "createLFObjectiveState";

        _methodParameterTypes218 = new String[] {  };

        _methodName219 = "findByMapKeyAndActivityStateID";

        _methodParameterTypes219 = new String[] {
                "java.lang.String", "java.lang.Integer"
            };

        _methodName220 = "findByActivityStateID";
        ...
        _methodName222 = "getLFObjectiveState";
