...
public class LFObjectiveStateLocalServiceClpInvoker {
    ...
    public LFObjectiveStateLocalServiceClpInvoker() {
        ...
        _methodName270 = "createLFObjectiveState";

        _methodParameterTypes270 = new String[] {  };

        _methodName271 = "findByMapKeyAndActivityStateID";

        _methodParameterTypes271 = new String[] {
                "java.lang.String", "java.lang.Integer"
            };

        _methodName272 = "findByActivityStateID";
        ...
        _methodName274 = "getLFObjectiveState";
