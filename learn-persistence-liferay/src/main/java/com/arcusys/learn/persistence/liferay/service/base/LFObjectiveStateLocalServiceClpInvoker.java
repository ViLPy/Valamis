...
public class LFObjectiveStateLocalServiceClpInvoker {
    ...
    public LFObjectiveStateLocalServiceClpInvoker() {
        ...
        _methodName170 = "createLFObjectiveState";

        _methodParameterTypes170 = new String[] {  };

        _methodName171 = "findByMapKeyAndActivityStateID";

        _methodParameterTypes171 = new String[] {
                "java.lang.String", "java.lang.Integer"
            };

        _methodName172 = "findByActivityStateID";
        ...
        _methodName174 = "getLFObjectiveState";
