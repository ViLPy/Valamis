...
public class LFObjectiveStateLocalServiceClpInvoker {
    ...
    public LFObjectiveStateLocalServiceClpInvoker() {
        ...
        _methodName198 = "createLFObjectiveState";

        _methodParameterTypes198 = new String[] {  };

        _methodName199 = "findByMapKeyAndActivityStateID";

        _methodParameterTypes199 = new String[] {
                "java.lang.String", "java.lang.Integer"
            };

        _methodName200 = "findByActivityStateID";
        ...
        _methodName202 = "getLFObjectiveState";
