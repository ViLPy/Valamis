...
/**
 * The base implementation of the l f certificate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFCertificateLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFCertificateLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFCertificateLocalService,
        IdentifiableBean {
    ...
    private LFCertificateLocalServiceClpInvoker _clpInvoker = new LFCertificateLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFCertificateLocalServiceUtil} to access the l f certificate local service.
     */
    ...
    public LFCertificate addLFCertificate(LFCertificate lfCertificate)
        throws SystemException {
        lfCertificate.setNew(true);

        return lfCertificatePersistence.update(lfCertificate, false);
    }
     ...
     */
    public LFCertificate createLFCertificate(long id) {
        return lfCertificatePersistence.create(id);
    }
    ...
    public LFCertificate deleteLFCertificate(long id)
        throws PortalException, SystemException {
        return lfCertificatePersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFCertificate deleteLFCertificate(LFCertificate lfCertificate)
        throws SystemException {
        return lfCertificatePersistence.remove(lfCertificate);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFCertificate.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfCertificatePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfCertificatePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFCertificate fetchLFCertificate(long id) throws SystemException {
        return lfCertificatePersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFCertificate getLFCertificate(long id)
        throws PortalException, SystemException {
        return lfCertificatePersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfCertificatePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFCertificate> getLFCertificates(int start, int end)
        throws SystemException {
        return lfCertificatePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFCertificatesCount() throws SystemException {
        return lfCertificatePersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFCertificate updateLFCertificate(LFCertificate lfCertificate)
        throws SystemException {
        return updateLFCertificate(lfCertificate, true);
    }
    ...
    public LFCertificate updateLFCertificate(LFCertificate lfCertificate,
        ...
        return lfCertificatePersistence.update(lfCertificate, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFCertificate",
            lfCertificateLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfCertificatePersistence.getDataSource();
