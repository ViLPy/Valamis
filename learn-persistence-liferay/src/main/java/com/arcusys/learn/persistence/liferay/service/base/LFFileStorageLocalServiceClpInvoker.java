...
public class LFFileStorageLocalServiceClpInvoker {
    ...
    public LFFileStorageLocalServiceClpInvoker() {
        ...
        _methodName282 = "createLFFileStorage";

        _methodParameterTypes282 = new String[] {  };

        _methodName283 = "findByFilename";

        _methodParameterTypes283 = new String[] { "java.lang.String" };

        _methodName284 = "findByFilename";

        _methodParameterTypes284 = new String[] { "java.lang.String", "int", "int" };

        _methodName285 = "removeByFilename";

        _methodParameterTypes285 = new String[] { "java.lang.String" };

        _methodName286 = "findByDirectory";

        _methodParameterTypes286 = new String[] { "java.lang.String" };

        _methodName287 = "removeByDirectory";
        ...
        _methodName289 = "getLFFileStorage";
