...
/**
 * The base implementation of the l f social package tag local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFSocialPackageTagLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFSocialPackageTagLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFSocialPackageTagLocalService,
        IdentifiableBean {
    ...
    private LFSocialPackageTagLocalServiceClpInvoker _clpInvoker = new LFSocialPackageTagLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFSocialPackageTagLocalServiceUtil} to access the l f social package tag local service.
     */
    ...
    public LFSocialPackageTag addLFSocialPackageTag(
        LFSocialPackageTag lfSocialPackageTag) throws SystemException {
        lfSocialPackageTag.setNew(true);

        return lfSocialPackageTagPersistence.update(lfSocialPackageTag, false);
    }
     ...
     */
    public LFSocialPackageTag createLFSocialPackageTag(long id) {
        return lfSocialPackageTagPersistence.create(id);
    }
    ...
    public LFSocialPackageTag deleteLFSocialPackageTag(long id)
        throws PortalException, SystemException {
        return lfSocialPackageTagPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFSocialPackageTag deleteLFSocialPackageTag(
        LFSocialPackageTag lfSocialPackageTag) throws SystemException {
        return lfSocialPackageTagPersistence.remove(lfSocialPackageTag);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFSocialPackageTag.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfSocialPackageTagPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSocialPackageTagPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFSocialPackageTag fetchLFSocialPackageTag(long id)
        throws SystemException {
        return lfSocialPackageTagPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFSocialPackageTag getLFSocialPackageTag(long id)
        throws PortalException, SystemException {
        return lfSocialPackageTagPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfSocialPackageTagPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFSocialPackageTag> getLFSocialPackageTags(int start, int end)
        throws SystemException {
        return lfSocialPackageTagPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFSocialPackageTagsCount() throws SystemException {
        return lfSocialPackageTagPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFSocialPackageTag updateLFSocialPackageTag(
        LFSocialPackageTag lfSocialPackageTag) throws SystemException {
        return updateLFSocialPackageTag(lfSocialPackageTag, true);
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    public LFSocialPackageTag updateLFSocialPackageTag(
        LFSocialPackageTag lfSocialPackageTag, boolean merge)
        throws SystemException {
        lfSocialPackageTag.setNew(false);

        return lfSocialPackageTagPersistence.update(lfSocialPackageTag, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFSocialPackageTag",
            lfSocialPackageTagLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfSocialPackageTagPersistence.getDataSource();
