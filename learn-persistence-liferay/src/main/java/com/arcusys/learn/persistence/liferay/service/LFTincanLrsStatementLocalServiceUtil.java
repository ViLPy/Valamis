...
/**
 * The utility for the l f tincan lrs statement local service. This utility wraps {@link com.arcusys.learn.persistence.liferay.service.impl.LFTincanLrsStatementLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class LFTincanLrsStatementLocalServiceUtil {
    ...
    */
    public static com.arcusys.learn.persistence.liferay.model.LFTincanLrsStatement updateLFTincanLrsStatement(
        ...
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService()
                   .updateLFTincanLrsStatement(lfTincanLrsStatement, merge);
    }
