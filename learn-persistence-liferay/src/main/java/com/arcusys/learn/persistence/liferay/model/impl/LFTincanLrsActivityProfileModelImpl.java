...
public class LFTincanLrsActivityProfileModelImpl extends BaseModelImpl<LFTincanLrsActivityProfile>
    ...
    public static final String ORDER_BY_JPQL = " ORDER BY lfTincanLrsActivityProfile.id ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Learn_LFTincanLrsActivityProfile.id_ ASC";
    ...
    private LFTincanLrsActivityProfile _escapedModel;
    ...
    public LFTincanLrsActivityProfile toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (LFTincanLrsActivityProfile) ProxyUtil.newProxyInstance(_classLoader,
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LFTincanLrsActivityProfile)) {
            return false;
        }

        LFTincanLrsActivityProfile lfTincanLrsActivityProfile = (LFTincanLrsActivityProfile) obj;
