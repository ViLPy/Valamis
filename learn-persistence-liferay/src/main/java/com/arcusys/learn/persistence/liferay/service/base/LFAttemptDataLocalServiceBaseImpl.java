...
/**
 * The base implementation of the l f attempt data local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFAttemptDataLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFAttemptDataLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFAttemptDataLocalService,
        IdentifiableBean {
    ...
    private LFAttemptDataLocalServiceClpInvoker _clpInvoker = new LFAttemptDataLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFAttemptDataLocalServiceUtil} to access the l f attempt data local service.
     */
    ...
    public LFAttemptData addLFAttemptData(LFAttemptData lfAttemptData)
        throws SystemException {
        lfAttemptData.setNew(true);

        return lfAttemptDataPersistence.update(lfAttemptData, false);
    }
     ...
     */
    public LFAttemptData createLFAttemptData(long id) {
        return lfAttemptDataPersistence.create(id);
    }
    ...
    public LFAttemptData deleteLFAttemptData(long id)
        throws PortalException, SystemException {
        return lfAttemptDataPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFAttemptData deleteLFAttemptData(LFAttemptData lfAttemptData)
        throws SystemException {
        return lfAttemptDataPersistence.remove(lfAttemptData);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFAttemptData.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfAttemptDataPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfAttemptDataPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFAttemptData fetchLFAttemptData(long id) throws SystemException {
        return lfAttemptDataPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFAttemptData getLFAttemptData(long id)
        throws PortalException, SystemException {
        return lfAttemptDataPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfAttemptDataPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFAttemptData> getLFAttemptDatas(int start, int end)
        throws SystemException {
        return lfAttemptDataPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFAttemptDatasCount() throws SystemException {
        return lfAttemptDataPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFAttemptData updateLFAttemptData(LFAttemptData lfAttemptData)
        throws SystemException {
        return updateLFAttemptData(lfAttemptData, true);
    }
    ...
    public LFAttemptData updateLFAttemptData(LFAttemptData lfAttemptData,
        ...
        return lfAttemptDataPersistence.update(lfAttemptData, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFAttemptData",
            lfAttemptDataLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfAttemptDataPersistence.getDataSource();
