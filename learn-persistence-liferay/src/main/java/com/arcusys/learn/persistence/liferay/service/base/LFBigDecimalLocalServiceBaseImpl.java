...
/**
 * The base implementation of the l f big decimal local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFBigDecimalLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.arcusys.learn.persistence.liferay.service.impl.LFBigDecimalLocalServiceImpl
 * @see com.arcusys.learn.persistence.liferay.service.LFBigDecimalLocalServiceUtil
 * @generated
 */
public abstract class LFBigDecimalLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFBigDecimalLocalService,
        IdentifiableBean {
    ...
    private LFBigDecimalLocalServiceClpInvoker _clpInvoker = new LFBigDecimalLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFBigDecimalLocalServiceUtil} to access the l f big decimal local service.
     */

    /**
     * Adds the l f big decimal to the database. Also notifies the appropriate model listeners.
     *
    ...
    public LFBigDecimal addLFBigDecimal(LFBigDecimal lfBigDecimal)
        throws SystemException {
        lfBigDecimal.setNew(true);

        return lfBigDecimalPersistence.update(lfBigDecimal, false);
    }
     ...
     */
    public LFBigDecimal createLFBigDecimal(long id) {
        return lfBigDecimalPersistence.create(id);
    }

    /**
     * Deletes the l f big decimal with the primary key from the database. Also notifies the appropriate model listeners.
     *
    ...
    public LFBigDecimal deleteLFBigDecimal(long id)
        throws PortalException, SystemException {
        return lfBigDecimalPersistence.remove(id);
    }

    /**
     * Deletes the l f big decimal from the database. Also notifies the appropriate model listeners.
     *
     * @param lfBigDecimal the l f big decimal
     * @return the l f big decimal that was removed
     * @throws SystemException if a system exception occurred
     */
    @Indexable(type = IndexableType.DELETE)
    public LFBigDecimal deleteLFBigDecimal(LFBigDecimal lfBigDecimal)
        throws SystemException {
        return lfBigDecimalPersistence.remove(lfBigDecimal);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFBigDecimal.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfBigDecimalPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfBigDecimalPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFBigDecimal fetchLFBigDecimal(long id) throws SystemException {
        return lfBigDecimalPersistence.fetchByPrimaryKey(id);
    }

    /**
     * Returns the l f big decimal with the primary key.
     *
     * @param id the primary key of the l f big decimal
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFBigDecimal getLFBigDecimal(long id)
        throws PortalException, SystemException {
        return lfBigDecimalPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfBigDecimalPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFBigDecimal> getLFBigDecimals(int start, int end)
        throws SystemException {
        return lfBigDecimalPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFBigDecimalsCount() throws SystemException {
        return lfBigDecimalPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFBigDecimal updateLFBigDecimal(LFBigDecimal lfBigDecimal)
        throws SystemException {
        return updateLFBigDecimal(lfBigDecimal, true);
    }
    ...
    public LFBigDecimal updateLFBigDecimal(LFBigDecimal lfBigDecimal,
        ...
        return lfBigDecimalPersistence.update(lfBigDecimal, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFBigDecimal",
            lfBigDecimalLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfBigDecimalPersistence.getDataSource();
