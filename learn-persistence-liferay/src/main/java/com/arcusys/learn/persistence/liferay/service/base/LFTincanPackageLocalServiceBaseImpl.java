...
/**
 * The base implementation of the l f tincan package local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFTincanPackageLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFTincanPackageLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFTincanPackageLocalService,
        IdentifiableBean {
    ...
    private LFTincanPackageLocalServiceClpInvoker _clpInvoker = new LFTincanPackageLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFTincanPackageLocalServiceUtil} to access the l f tincan package local service.
     */
    ...
    public LFTincanPackage addLFTincanPackage(LFTincanPackage lfTincanPackage)
        throws SystemException {
        lfTincanPackage.setNew(true);

        return lfTincanPackagePersistence.update(lfTincanPackage, false);
    }
     ...
     */
    public LFTincanPackage createLFTincanPackage(long id) {
        return lfTincanPackagePersistence.create(id);
    }
    ...
    public LFTincanPackage deleteLFTincanPackage(long id)
        throws PortalException, SystemException {
        return lfTincanPackagePersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFTincanPackage deleteLFTincanPackage(
        LFTincanPackage lfTincanPackage) throws SystemException {
        return lfTincanPackagePersistence.remove(lfTincanPackage);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFTincanPackage.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfTincanPackagePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfTincanPackagePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFTincanPackage fetchLFTincanPackage(long id)
        throws SystemException {
        return lfTincanPackagePersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFTincanPackage getLFTincanPackage(long id)
        throws PortalException, SystemException {
        return lfTincanPackagePersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfTincanPackagePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFTincanPackage> getLFTincanPackages(int start, int end)
        throws SystemException {
        return lfTincanPackagePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFTincanPackagesCount() throws SystemException {
        return lfTincanPackagePersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFTincanPackage updateLFTincanPackage(
        LFTincanPackage lfTincanPackage) throws SystemException {
        return updateLFTincanPackage(lfTincanPackage, true);
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    public LFTincanPackage updateLFTincanPackage(
        LFTincanPackage lfTincanPackage, boolean merge)
        throws SystemException {
        lfTincanPackage.setNew(false);

        return lfTincanPackagePersistence.update(lfTincanPackage, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFTincanPackage",
            lfTincanPackageLocalService);
    }
