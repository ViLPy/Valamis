...
/**
 * The base implementation of the l f activity state tree local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFActivityStateTreeLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFActivityStateTreeLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFActivityStateTreeLocalService,
        IdentifiableBean {
    ...
    private LFActivityStateTreeLocalServiceClpInvoker _clpInvoker = new LFActivityStateTreeLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFActivityStateTreeLocalServiceUtil} to access the l f activity state tree local service.
     */
    ...
    public LFActivityStateTree addLFActivityStateTree(
        LFActivityStateTree lfActivityStateTree) throws SystemException {
        lfActivityStateTree.setNew(true);

        return lfActivityStateTreePersistence.update(lfActivityStateTree, false);
    }
     ...
     */
    public LFActivityStateTree createLFActivityStateTree(long id) {
        return lfActivityStateTreePersistence.create(id);
    }
    ...
    public LFActivityStateTree deleteLFActivityStateTree(long id)
        throws PortalException, SystemException {
        return lfActivityStateTreePersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFActivityStateTree deleteLFActivityStateTree(
        LFActivityStateTree lfActivityStateTree) throws SystemException {
        return lfActivityStateTreePersistence.remove(lfActivityStateTree);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFActivityStateTree.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfActivityStateTreePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfActivityStateTreePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFActivityStateTree fetchLFActivityStateTree(long id)
        throws SystemException {
        return lfActivityStateTreePersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFActivityStateTree getLFActivityStateTree(long id)
        throws PortalException, SystemException {
        return lfActivityStateTreePersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfActivityStateTreePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFActivityStateTree> getLFActivityStateTrees(int start, int end)
        throws SystemException {
        return lfActivityStateTreePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFActivityStateTreesCount() throws SystemException {
        return lfActivityStateTreePersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFActivityStateTree updateLFActivityStateTree(
        LFActivityStateTree lfActivityStateTree) throws SystemException {
        return updateLFActivityStateTree(lfActivityStateTree, true);
    }
    ...
    public LFActivityStateTree updateLFActivityStateTree(
        ...
        return lfActivityStateTreePersistence.update(lfActivityStateTree, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFActivityStateTree",
            lfActivityStateTreeLocalService);
    }
