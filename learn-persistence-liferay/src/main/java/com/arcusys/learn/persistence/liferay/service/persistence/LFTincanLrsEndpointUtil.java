...
public class LFTincanLrsEndpointUtil {
    ...
    public static LFTincanLrsEndpoint update(
        ...
        return getPersistence().update(lfTincanLrsEndpoint);
    }
     ...
     */
    public static LFTincanLrsEndpoint update(
        LFTincanLrsEndpoint lfTincanLrsEndpoint, ServiceContext serviceContext)
        throws SystemException {
        return getPersistence().update(lfTincanLrsEndpoint, serviceContext);
    }
    ...
    */
    ...
    public static com.arcusys.learn.persistence.liferay.model.LFTincanLrsEndpoint updateImpl(
        ...
        return getPersistence().updateImpl(lfTincanLrsEndpoint);
    }
