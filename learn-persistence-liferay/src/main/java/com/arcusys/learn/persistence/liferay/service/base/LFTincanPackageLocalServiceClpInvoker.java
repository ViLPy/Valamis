...
public class LFTincanPackageLocalServiceClpInvoker {
    ...
    public LFTincanPackageLocalServiceClpInvoker() {
        ...
        _methodName282 = "createLFTincanPackage";

        _methodParameterTypes282 = new String[] {  };

        _methodName283 = "findByRefID";

        _methodParameterTypes283 = new String[] { "java.lang.Long" };

        _methodName284 = "findByPackageID";

        _methodParameterTypes284 = new String[] { "java.lang.Long[][]" };

        _methodName285 = "findAll";

        _methodParameterTypes285 = new String[] {  };

        _methodName286 = "findByInstance";
        ...
        _methodName289 = "getLFTincanPackage";
