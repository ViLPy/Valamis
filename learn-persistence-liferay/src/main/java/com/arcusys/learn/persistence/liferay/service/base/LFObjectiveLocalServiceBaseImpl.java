...
/**
 * The base implementation of the l f objective local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFObjectiveLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFObjectiveLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFObjectiveLocalService,
        IdentifiableBean {
    ...
    private LFObjectiveLocalServiceClpInvoker _clpInvoker = new LFObjectiveLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFObjectiveLocalServiceUtil} to access the l f objective local service.
     */
    ...
    public LFObjective addLFObjective(LFObjective lfObjective)
        throws SystemException {
        lfObjective.setNew(true);

        return lfObjectivePersistence.update(lfObjective, false);
    }
     ...
     */
    public LFObjective createLFObjective(long lfId) {
        return lfObjectivePersistence.create(lfId);
    }
    ...
    public LFObjective deleteLFObjective(long lfId)
        throws PortalException, SystemException {
        return lfObjectivePersistence.remove(lfId);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFObjective deleteLFObjective(LFObjective lfObjective)
        throws SystemException {
        return lfObjectivePersistence.remove(lfObjective);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFObjective.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfObjectivePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return lfObjectivePersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfObjectivePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFObjective fetchLFObjective(long lfId) throws SystemException {
        return lfObjectivePersistence.fetchByPrimaryKey(lfId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFObjective getLFObjective(long lfId)
        throws PortalException, SystemException {
        return lfObjectivePersistence.findByPrimaryKey(lfId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfObjectivePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFObjective> getLFObjectives(int start, int end)
        throws SystemException {
        return lfObjectivePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFObjectivesCount() throws SystemException {
        return lfObjectivePersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFObjective updateLFObjective(LFObjective lfObjective)
        throws SystemException {
        return updateLFObjective(lfObjective, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFObjective updateLFObjective(LFObjective lfObjective, boolean merge)
        throws SystemException {
        lfObjective.setNew(false);

        return lfObjectivePersistence.update(lfObjective, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFObjective",
            lfObjectiveLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfObjectivePersistence.getDataSource();
