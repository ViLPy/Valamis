...
/**
 * The base implementation of the l f user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFUserLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFUserLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements LFUserLocalService, IdentifiableBean {
    ...
    private LFUserLocalServiceClpInvoker _clpInvoker = new LFUserLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFUserLocalServiceUtil} to access the l f user local service.
     */
    ...
    public LFUser addLFUser(LFUser lfUser) throws SystemException {
        lfUser.setNew(true);

        return lfUserPersistence.update(lfUser, false);
    }
     ...
     */
    public LFUser createLFUser(long lfid) {
        return lfUserPersistence.create(lfid);
    }
    ...
    public LFUser deleteLFUser(long lfid)
        throws PortalException, SystemException {
        return lfUserPersistence.remove(lfid);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFUser deleteLFUser(LFUser lfUser) throws SystemException {
        return lfUserPersistence.remove(lfUser);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFUser.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfUserPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return lfUserPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfUserPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFUser fetchLFUser(long lfid) throws SystemException {
        return lfUserPersistence.fetchByPrimaryKey(lfid);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFUser getLFUser(long lfid) throws PortalException, SystemException {
        return lfUserPersistence.findByPrimaryKey(lfid);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfUserPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFUser> getLFUsers(int start, int end)
        throws SystemException {
        return lfUserPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFUsersCount() throws SystemException {
        return lfUserPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFUser updateLFUser(LFUser lfUser) throws SystemException {
        return updateLFUser(lfUser, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFUser updateLFUser(LFUser lfUser, boolean merge)
        throws SystemException {
        lfUser.setNew(false);

        return lfUserPersistence.update(lfUser, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFUser",
            lfUserLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfUserPersistence.getDataSource();
