...
public class LFChildrenSelectionModelImpl extends BaseModelImpl<LFChildrenSelection>
    ...
    public static final String ORDER_BY_JPQL = " ORDER BY lfChildrenSelection.id ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Learn_LFChildrenSelection.id_ ASC";
    ...
    private LFChildrenSelection _escapedModel;
    ...
    public LFChildrenSelection toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (LFChildrenSelection) ProxyUtil.newProxyInstance(_classLoader,
