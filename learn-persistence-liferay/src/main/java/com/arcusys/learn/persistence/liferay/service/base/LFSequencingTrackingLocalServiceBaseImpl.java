...
/**
 * The base implementation of the l f sequencing tracking local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFSequencingTrackingLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFSequencingTrackingLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFSequencingTrackingLocalService,
        IdentifiableBean {
    ...
    private LFSequencingTrackingLocalServiceClpInvoker _clpInvoker = new LFSequencingTrackingLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFSequencingTrackingLocalServiceUtil} to access the l f sequencing tracking local service.
     */
    ...
    public LFSequencingTracking addLFSequencingTracking(
        LFSequencingTracking lfSequencingTracking) throws SystemException {
        lfSequencingTracking.setNew(true);

        return lfSequencingTrackingPersistence.update(lfSequencingTracking,
            false);
    }
     ...
     */
    public LFSequencingTracking createLFSequencingTracking(long id) {
        return lfSequencingTrackingPersistence.create(id);
    }
    ...
    public LFSequencingTracking deleteLFSequencingTracking(long id)
        throws PortalException, SystemException {
        return lfSequencingTrackingPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFSequencingTracking deleteLFSequencingTracking(
        LFSequencingTracking lfSequencingTracking) throws SystemException {
        return lfSequencingTrackingPersistence.remove(lfSequencingTracking);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFSequencingTracking.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfSequencingTrackingPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSequencingTrackingPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFSequencingTracking fetchLFSequencingTracking(long id)
        throws SystemException {
        return lfSequencingTrackingPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFSequencingTracking getLFSequencingTracking(long id)
        throws PortalException, SystemException {
        return lfSequencingTrackingPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfSequencingTrackingPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFSequencingTracking> getLFSequencingTrackings(int start,
        int end) throws SystemException {
        return lfSequencingTrackingPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFSequencingTrackingsCount() throws SystemException {
        return lfSequencingTrackingPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFSequencingTracking updateLFSequencingTracking(
        LFSequencingTracking lfSequencingTracking) throws SystemException {
        return updateLFSequencingTracking(lfSequencingTracking, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFSequencingTracking",
            lfSequencingTrackingLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfSequencingTrackingPersistence.getDataSource();
