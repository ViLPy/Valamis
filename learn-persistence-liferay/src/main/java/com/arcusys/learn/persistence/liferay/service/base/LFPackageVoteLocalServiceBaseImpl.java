...
/**
 * The base implementation of the l f package vote local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFPackageVoteLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFPackageVoteLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFPackageVoteLocalService,
        IdentifiableBean {
    ...
    private LFPackageVoteLocalServiceClpInvoker _clpInvoker = new LFPackageVoteLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFPackageVoteLocalServiceUtil} to access the l f package vote local service.
     */
    ...
    public LFPackageVote addLFPackageVote(LFPackageVote lfPackageVote)
        throws SystemException {
        lfPackageVote.setNew(true);

        return lfPackageVotePersistence.update(lfPackageVote, false);
    }
     ...
     */
    public LFPackageVote createLFPackageVote(long id) {
        return lfPackageVotePersistence.create(id);
    }
    ...
    public LFPackageVote deleteLFPackageVote(long id)
        throws PortalException, SystemException {
        return lfPackageVotePersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFPackageVote deleteLFPackageVote(LFPackageVote lfPackageVote)
        throws SystemException {
        return lfPackageVotePersistence.remove(lfPackageVote);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFPackageVote.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfPackageVotePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfPackageVotePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFPackageVote fetchLFPackageVote(long id) throws SystemException {
        return lfPackageVotePersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFPackageVote getLFPackageVote(long id)
        throws PortalException, SystemException {
        return lfPackageVotePersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfPackageVotePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFPackageVote> getLFPackageVotes(int start, int end)
        throws SystemException {
        return lfPackageVotePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFPackageVotesCount() throws SystemException {
        return lfPackageVotePersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFPackageVote updateLFPackageVote(LFPackageVote lfPackageVote)
        throws SystemException {
        return updateLFPackageVote(lfPackageVote, true);
    }
    ...
    public LFPackageVote updateLFPackageVote(LFPackageVote lfPackageVote,
        ...
        return lfPackageVotePersistence.update(lfPackageVote, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFPackageVote",
            lfPackageVoteLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfPackageVotePersistence.getDataSource();
