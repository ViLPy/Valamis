...
/**
 * The base implementation of the l f sequencing permissions local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFSequencingPermissionsLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFSequencingPermissionsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFSequencingPermissionsLocalService,
        IdentifiableBean {
    ...
    private LFSequencingPermissionsLocalServiceClpInvoker _clpInvoker = new LFSequencingPermissionsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFSequencingPermissionsLocalServiceUtil} to access the l f sequencing permissions local service.
     */
    ...
    public LFSequencingPermissions addLFSequencingPermissions(
        LFSequencingPermissions lfSequencingPermissions)
        throws SystemException {
        lfSequencingPermissions.setNew(true);

        return lfSequencingPermissionsPersistence.update(lfSequencingPermissions,
            false);
    }
     ...
     */
    public LFSequencingPermissions createLFSequencingPermissions(long id) {
        return lfSequencingPermissionsPersistence.create(id);
    }
    ...
    public LFSequencingPermissions deleteLFSequencingPermissions(long id)
        throws PortalException, SystemException {
        return lfSequencingPermissionsPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFSequencingPermissions deleteLFSequencingPermissions(
        LFSequencingPermissions lfSequencingPermissions)
        throws SystemException {
        return lfSequencingPermissionsPersistence.remove(lfSequencingPermissions);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFSequencingPermissions.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSequencingPermissionsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfSequencingPermissionsPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFSequencingPermissions fetchLFSequencingPermissions(long id)
        throws SystemException {
        return lfSequencingPermissionsPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFSequencingPermissions getLFSequencingPermissions(long id)
        throws PortalException, SystemException {
        return lfSequencingPermissionsPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfSequencingPermissionsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFSequencingPermissions> getLFSequencingPermissionses(
        int start, int end) throws SystemException {
        return lfSequencingPermissionsPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFSequencingPermissionsesCount() throws SystemException {
        return lfSequencingPermissionsPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFSequencingPermissions updateLFSequencingPermissions(
        LFSequencingPermissions lfSequencingPermissions)
        throws SystemException {
        return updateLFSequencingPermissions(lfSequencingPermissions, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFSequencingPermissions",
            lfSequencingPermissionsLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfSequencingPermissionsPersistence.getDataSource();
