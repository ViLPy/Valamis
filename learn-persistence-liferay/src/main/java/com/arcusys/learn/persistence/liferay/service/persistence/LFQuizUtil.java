...
public class LFQuizUtil {
     ...
     */
    public static LFQuiz update(LFQuiz lfQuiz, boolean merge)
        throws SystemException {
        return getPersistence().update(lfQuiz, merge);
    }
    ...
    public static LFQuiz update(LFQuiz lfQuiz, boolean merge,
        ...
        return getPersistence().update(lfQuiz, merge, serviceContext);
    }
    ...
    */
    ...
    public static com.arcusys.learn.persistence.liferay.model.LFQuiz updateImpl(
        ...
        return getPersistence().updateImpl(lfQuiz, merge);
    }
