...
/**
 * The base implementation of the l f certificate user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFCertificateUserLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFCertificateUserLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFCertificateUserLocalService,
        IdentifiableBean {
    ...
    private LFCertificateUserLocalServiceClpInvoker _clpInvoker = new LFCertificateUserLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFCertificateUserLocalServiceUtil} to access the l f certificate user local service.
     */
    ...
    public LFCertificateUser addLFCertificateUser(
        LFCertificateUser lfCertificateUser) throws SystemException {
        lfCertificateUser.setNew(true);

        return lfCertificateUserPersistence.update(lfCertificateUser, false);
    }
    ...
    public LFCertificateUser deleteLFCertificateUser(
        LFCertificateUser lfCertificateUser) throws SystemException {
        return lfCertificateUserPersistence.remove(lfCertificateUser);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFCertificateUser.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfCertificateUserPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfCertificateUserPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfCertificateUserPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFCertificateUser> getLFCertificateUsers(int start, int end)
        throws SystemException {
        return lfCertificateUserPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFCertificateUsersCount() throws SystemException {
        return lfCertificateUserPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFCertificateUser updateLFCertificateUser(
        LFCertificateUser lfCertificateUser) throws SystemException {
        return updateLFCertificateUser(lfCertificateUser, true);
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    public LFCertificateUser updateLFCertificateUser(
        LFCertificateUser lfCertificateUser, boolean merge)
        throws SystemException {
        lfCertificateUser.setNew(false);

        return lfCertificateUserPersistence.update(lfCertificateUser, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFCertificateUser",
            lfCertificateUserLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfCertificateUserPersistence.getDataSource();
