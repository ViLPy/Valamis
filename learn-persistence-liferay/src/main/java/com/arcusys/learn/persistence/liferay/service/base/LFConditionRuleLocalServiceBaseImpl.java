...
/**
 * The base implementation of the l f condition rule local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFConditionRuleLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFConditionRuleLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFConditionRuleLocalService,
        IdentifiableBean {
    ...
    private LFConditionRuleLocalServiceClpInvoker _clpInvoker = new LFConditionRuleLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFConditionRuleLocalServiceUtil} to access the l f condition rule local service.
     */
    ...
    public LFConditionRule addLFConditionRule(LFConditionRule lfConditionRule)
        throws SystemException {
        lfConditionRule.setNew(true);

        return lfConditionRulePersistence.update(lfConditionRule, false);
    }
     ...
     */
    public LFConditionRule createLFConditionRule(long id) {
        return lfConditionRulePersistence.create(id);
    }
    ...
    public LFConditionRule deleteLFConditionRule(long id)
        throws PortalException, SystemException {
        return lfConditionRulePersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFConditionRule deleteLFConditionRule(
        LFConditionRule lfConditionRule) throws SystemException {
        return lfConditionRulePersistence.remove(lfConditionRule);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFConditionRule.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfConditionRulePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfConditionRulePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFConditionRule fetchLFConditionRule(long id)
        throws SystemException {
        return lfConditionRulePersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFConditionRule getLFConditionRule(long id)
        throws PortalException, SystemException {
        return lfConditionRulePersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfConditionRulePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFConditionRule> getLFConditionRules(int start, int end)
        throws SystemException {
        return lfConditionRulePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFConditionRulesCount() throws SystemException {
        return lfConditionRulePersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFConditionRule updateLFConditionRule(
        LFConditionRule lfConditionRule) throws SystemException {
        return updateLFConditionRule(lfConditionRule, true);
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    public LFConditionRule updateLFConditionRule(
        LFConditionRule lfConditionRule, boolean merge)
        throws SystemException {
        lfConditionRule.setNew(false);

        return lfConditionRulePersistence.update(lfConditionRule, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFConditionRule",
            lfConditionRuleLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfConditionRulePersistence.getDataSource();
