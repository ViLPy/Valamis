...
/**
 * The base implementation of the l f config local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFConfigLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LFConfigLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements LFConfigLocalService, IdentifiableBean {
    ...
    private LFConfigLocalServiceClpInvoker _clpInvoker = new LFConfigLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFConfigLocalServiceUtil} to access the l f config local service.
     */
    ...
    public LFConfig addLFConfig(LFConfig lfConfig) throws SystemException {
        lfConfig.setNew(true);

        return lfConfigPersistence.update(lfConfig, false);
    }
     ...
     */
    public LFConfig createLFConfig(long id) {
        return lfConfigPersistence.create(id);
    }
    ...
    public LFConfig deleteLFConfig(long id)
        throws PortalException, SystemException {
        return lfConfigPersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFConfig deleteLFConfig(LFConfig lfConfig) throws SystemException {
        return lfConfigPersistence.remove(lfConfig);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFConfig.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfConfigPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return lfConfigPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return lfConfigPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfConfigPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFConfig fetchLFConfig(long id) throws SystemException {
        return lfConfigPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFConfig getLFConfig(long id)
        throws PortalException, SystemException {
        return lfConfigPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfConfigPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFConfig> getLFConfigs(int start, int end)
        throws SystemException {
        return lfConfigPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFConfigsCount() throws SystemException {
        return lfConfigPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFConfig updateLFConfig(LFConfig lfConfig) throws SystemException {
        return updateLFConfig(lfConfig, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFConfig updateLFConfig(LFConfig lfConfig, boolean merge)
        throws SystemException {
        lfConfig.setNew(false);

        return lfConfigPersistence.update(lfConfig, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFConfig",
            lfConfigLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfConfigPersistence.getDataSource();
