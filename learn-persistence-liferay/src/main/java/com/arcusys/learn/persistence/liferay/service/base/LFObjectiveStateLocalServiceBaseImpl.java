...
/**
 * The base implementation of the l f objective state local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.arcusys.learn.persistence.liferay.service.impl.LFObjectiveStateLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.arcusys.learn.persistence.liferay.service.impl.LFObjectiveStateLocalServiceImpl
 * @see com.arcusys.learn.persistence.liferay.service.LFObjectiveStateLocalServiceUtil
 * @generated
 */
public abstract class LFObjectiveStateLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LFObjectiveStateLocalService,
        IdentifiableBean {
    ...
    private LFObjectiveStateLocalServiceClpInvoker _clpInvoker = new LFObjectiveStateLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.arcusys.learn.persistence.liferay.service.LFObjectiveStateLocalServiceUtil} to access the l f objective state local service.
     */
    ...
    public LFObjectiveState addLFObjectiveState(
        LFObjectiveState lfObjectiveState) throws SystemException {
        lfObjectiveState.setNew(true);

        return lfObjectiveStatePersistence.update(lfObjectiveState, false);
    }
     ...
     */
    public LFObjectiveState createLFObjectiveState(long id) {
        return lfObjectiveStatePersistence.create(id);
    }
    ...
    public LFObjectiveState deleteLFObjectiveState(long id)
        throws PortalException, SystemException {
        return lfObjectiveStatePersistence.remove(id);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public LFObjectiveState deleteLFObjectiveState(
        LFObjectiveState lfObjectiveState) throws SystemException {
        return lfObjectiveStatePersistence.remove(lfObjectiveState);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(LFObjectiveState.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return lfObjectiveStatePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return lfObjectiveStatePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public LFObjectiveState fetchLFObjectiveState(long id)
        throws SystemException {
        return lfObjectiveStatePersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public LFObjectiveState getLFObjectiveState(long id)
        throws PortalException, SystemException {
        return lfObjectiveStatePersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return lfObjectiveStatePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<LFObjectiveState> getLFObjectiveStates(int start, int end)
        throws SystemException {
        return lfObjectiveStatePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getLFObjectiveStatesCount() throws SystemException {
        return lfObjectiveStatePersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public LFObjectiveState updateLFObjectiveState(
        LFObjectiveState lfObjectiveState) throws SystemException {
        return updateLFObjectiveState(lfObjectiveState, true);
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    public LFObjectiveState updateLFObjectiveState(
        LFObjectiveState lfObjectiveState, boolean merge)
        throws SystemException {
        lfObjectiveState.setNew(false);

        return lfObjectiveStatePersistence.update(lfObjectiveState, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.arcusys.learn.persistence.liferay.model.LFObjectiveState",
            lfObjectiveStateLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = lfObjectiveStatePersistence.getDataSource();
