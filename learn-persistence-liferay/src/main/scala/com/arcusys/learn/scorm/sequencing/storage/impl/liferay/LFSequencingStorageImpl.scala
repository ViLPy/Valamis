...
trait LFSequencingStorageImpl extends KeyedEntityStorage[Sequencing] {
  ...
  private def extract(lfentity: LFSequencing): Option[Sequencing] = {
    ...
    if (lfentity == null) None
      ...
      val mapper = new SequencingFieldsMapper {
        ...
        def onlyCurrentAttemptObjectiveProgressForChildren = lfentity.getOnlyCurrentAttemptAttemptProgressForChildren
        def onlyCurrentAttemptAttemptProgressForChildren = lfentity.getOnlyCurrentAttemptObjectiveProgressForChildren
  ...
  def createAndGetID(entity: Sequencing, parameters: (String, Any)*) = {
    ...
    newEntity.setOnlyCurrentAttemptAttemptProgressForChildren(entity.onlyCurrentAttemptAttemptProgressForChildren)
    newEntity.setOnlyCurrentAttemptObjectiveProgressForChildren(entity.onlyCurrentAttemptObjectiveProgressForChildren)
