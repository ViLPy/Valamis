...
trait LFPackageScopeRuleStorageImpl extends EntityStorage[PackageScopeRule] {
  ...
  def getOne(parameters: (String, Any)*) = {
    val lfRule = parameters match {
      case Seq(("packageID", packageID: Int)) =>
        LFPackageScopeRuleLocalServiceUtil.findByPackageID(packageID)
  ...
  def delete(parameters: (String, Any)*) {
    LFPackageScopeRuleLocalServiceUtil.removeByPackageID(LiferayCommon.getParameter("packageID", parameters: _*).get)
  }
