...
import com.arcusys.valamis.lesson.scorm.model.manifest.{ Activity, ObjectiveMap, PostConditionAction }
import com.arcusys.valamis.lesson.scorm.model.sequencing.{ SequencingRequestType, SequencingRulesResponse, TerminationRequestType }
