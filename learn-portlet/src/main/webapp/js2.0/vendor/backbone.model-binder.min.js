...
(function (e) {
    ...
    e.extend(n.ModelBinder.prototype, {bind: function (e, n, r, i) {
        ...
        this._options = e.extend({boundAttribute: "name"}, n.ModelBinder.options, t);
        ...
        for (e = 0; e < n.length; e++) {
            ...
            if (!this._attributeBindings[i]) {
                s = {attributeName: i};
                s.elementBindings = [
                    {attributeBinding: s, boundEls: [r]}
                ];
                this._attributeBindings[i] = s
            } else {
                this._attributeBindings[i].elementBindings.push({attributeBinding: this._attributeBindings[i], boundEls: [r]})
            }
        }
    ...
    }, _setElValue: function (t, n) {
        if (t.attr("type")) {
            switch (t.attr("type")) {
                case"radio":
                    if (t.val() === n) {
                        t.prop("checked") || e.defer(function () {
                            t.trigger("change")
                        });
                        t.prop("checked", true)
                    } else {
                    ...
                    break;
                case"checkbox":
                    t.prop("checked") === !!n || e.defer(function () {
                        t.trigger("change")
                    });
                    t.prop("checked", !!n);
                    break;
    ...
    e.extend(n.ModelBinder.CollectionConverter.prototype, {convert: function (e, t) {
