...
var Marionette = function (a, b, c) {
    ...
    return f.extend = b.Model.extend, f.getOption = function (a, b) {
    ...
    }, triggerMethod: f.triggerMethod, getTemplate: function () {
        ...
        this.listenTo(a, "all", function () {
            var e = d(arguments), g = e[0], h = this.getItemEvents();
    ...
    }, c.extend(f.Module.prototype, b.Events, {addInitializer: function (a) {
