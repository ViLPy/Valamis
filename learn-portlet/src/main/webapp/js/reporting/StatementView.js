var StatementView = Backbone.Marionette.ItemView.extend({
    template: '#latestStatementViewTemplate',
    templateHelpers: {
        tincanVerb: function () {
...
var StatementsListView = Backbone.Marionette.CollectionView.extend({
    itemView: StatementView,
    tagName: 'tbody',
