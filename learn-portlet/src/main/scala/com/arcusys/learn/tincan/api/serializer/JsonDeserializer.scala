...
object JsonDeserializer {
  ...
  class StatementObjectSerializer(formatType: SerializeFormat = SerializeFormat()) extends CustomSerializer[StatementObject](implicit format => ( {
    ...
    //case statementRef: StatementReference => render(Extraction.decompose(statementRef)(DefaultFormats))
  ...
  class StatementSerializer(formatType: SerializeFormat = SerializeFormat()) extends CustomSerializer[Statement](format => ( {
    ...
    case statement: Statement => {
      implicit val jsonFormats: Formats = DefaultFormats + new ActorSerializer(formatType) + new StatementObjectSerializer(formatType) + new InteractionTypeSerializer + new UUIDSerializer
