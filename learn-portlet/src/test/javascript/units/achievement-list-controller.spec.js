...
describe("Achievement list controller", function () {
    ...
    it("should be initialized", inject(function ($controller) {
        ...
        httpBackend
            .whenGET('test/services/achievement?action=all&companyID=1&count=10&page=1&sortAZ=true')
    ...
    it("should delete achievement", inject(function ($controller) {
        ...
        httpBackend
            .whenPOST('test/services/achievement/4')
            .respond();
    ...
    it("should sort achievements", inject(function ($controller) {
        ...
        httpBackend
            .whenGET('test/services/achievement?action=all&companyID=1&count=10&page=1&sortAZ=false')
    ...
    it("should filtered achievements", inject(function ($controller) {
        ...
        httpBackend
            .whenGET('test/services/achievement?action=all&companyID=1&count=10&filter=Achievement+2&page=1&sortAZ=true')
            .respond({
    ...
    it("should check is show pager", inject(function ($controller) {
        ...
        httpBackend
            .whenGET('test/services/achievement?action=all&companyID=1&count=9&page=1&sortAZ=true')
