...
describe("Edit achievement controller", function () {
    ...
    it("should turn off edit title mode and save changes", inject(function ($controller) {
        httpBackend
            .whenGET('test/services/requiredActivity/')
            .respond();

        httpBackend
            .whenPOST('test/services/achievement/update/1')
            .respond();
    ...
    it("should remove activity", inject(function ($controller) {
        ...
        httpBackend
            .whenPOST('test/services/requiredActivity/delete/1')
            .respond();
    ...
    it("should change required activities count", inject(function ($controller) {
        ...
        httpBackend
            .whenPOST('test/services/requiredActivity/update/1')
            .respond();
