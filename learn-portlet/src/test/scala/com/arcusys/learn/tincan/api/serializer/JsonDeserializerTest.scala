...
//    assertEquals("http://tincanapi.com/GolfExample_TCAPI", statement.context.get.contextActivities.get.grouping.head.id)
//
...
//
//  @Test
//  def StatementWithResult() {
//    val rawJson = """{"actor":{"objectType":"Agent","mbox":"mailto:test@liferay.com","name":"Joe Bloggs"},"verb":{"id":"http://adlnet.gov/expapi/verbs/failed","display":{"en-US":"failed"}},"result":{"success":false,"duration":"PT5S","score":{"scaled":"0","raw":"0","min":"0","max":"40"},"completion":true},"context":{"registration":"35805306-3c2a-433a-8d7f-fff6da5798f9"},"object":{"id":"http://localhost:8080/learn-portlet/SCORMData/data/401/SCORM2004Cp6SWFSample.htm","objectType":"Activity","definition":{"type":"http://adlnet.gov/expapi/activities/course","name":{"en-US":"Course Object title"},"description":{"en-US":"Course Object title"}}}}"""
//    val statement = JsonDeserializer.deserializeStatement(rawJson)
//
//    assertEquals(statement.obj.objectType, "Activity")
//    assert(statement.result.isDefined)
//    assert(statement.result.get.duration.getOrElse("") == "PT5S")
//    assert(statement.result.get.score.isDefined)
//    assert(statement.result.get.score.get.scaled == BigDecimal(0))
//    assert(statement.result.get.score.get.max.getOrElse(BigDecimal(0)) == BigDecimal(40))
//
//  }
//
//}
