...
class RegistrationControllerTest extends ScalatraFlatSpec with MockFactory with ProxyMockFactory with MockInjectableFactory {
  ...
  bindingModule.modifyBindings(module => {
    ...
    addServlet(new RegistrationController(module), "/*")
  })
